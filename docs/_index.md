...
Starting with version 2.0.0, the MongoDB Atlas Provider Versioning Policy ensures that minor and patch versions do not include breaking changes.
### Pulumi Version

We recommend using the latest HashiCorp Pulumi Core Version. See the HashiCorp Pulumi Version Compatibility Matrix below for supported versions.
