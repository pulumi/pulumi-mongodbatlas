...
public final class GetBackupCompliancePolicyOnDemandPolicyItemArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetBackupCompliancePolicyOnDemandPolicyItemArgs Empty = new GetBackupCompliancePolicyOnDemandPolicyItemArgs();
    ...
    private GetBackupCompliancePolicyOnDemandPolicyItemArgs() {}

    private GetBackupCompliancePolicyOnDemandPolicyItemArgs(GetBackupCompliancePolicyOnDemandPolicyItemArgs $) {
    ...
    public static Builder builder(GetBackupCompliancePolicyOnDemandPolicyItemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBackupCompliancePolicyOnDemandPolicyItemArgs();
        }

        public Builder(GetBackupCompliancePolicyOnDemandPolicyItemArgs defaults) {
            $ = new GetBackupCompliancePolicyOnDemandPolicyItemArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetBackupCompliancePolicyOnDemandPolicyItemArgs build() {
            if ($.frequencyInterval == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyOnDemandPolicyItemArgs", "frequencyInterval");
            }
            if ($.frequencyType == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyOnDemandPolicyItemArgs", "frequencyType");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyOnDemandPolicyItemArgs", "id");
            }
            if ($.retentionUnit == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyOnDemandPolicyItemArgs", "retentionUnit");
            }
            if ($.retentionValue == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyOnDemandPolicyItemArgs", "retentionValue");
            }
            return $;
        }
    }
