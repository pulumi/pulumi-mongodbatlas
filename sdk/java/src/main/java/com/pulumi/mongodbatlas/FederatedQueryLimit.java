...
public class FederatedQueryLimit extends com.pulumi.resources.CustomResource {
     ...
     */
    public FederatedQueryLimit(java.lang.String name) {
     ...
     */
    public FederatedQueryLimit(java.lang.String name, FederatedQueryLimitArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedQueryLimit(java.lang.String name, FederatedQueryLimitArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("mongodbatlas:index/federatedQueryLimit:FederatedQueryLimit", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedQueryLimit(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedQueryLimitState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("mongodbatlas:index/federatedQueryLimit:FederatedQueryLimit", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedQueryLimit get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedQueryLimitState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
