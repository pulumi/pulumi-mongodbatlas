...
public final class GetBackupCompliancePolicyPolicyItemDaily extends com.pulumi.resources.InvokeArgs {

    public static final GetBackupCompliancePolicyPolicyItemDaily Empty = new GetBackupCompliancePolicyPolicyItemDaily();
    ...
    private GetBackupCompliancePolicyPolicyItemDaily(GetBackupCompliancePolicyPolicyItemDaily $) {
    ...
    public static Builder builder(GetBackupCompliancePolicyPolicyItemDaily defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBackupCompliancePolicyPolicyItemDaily();
        }

        public Builder(GetBackupCompliancePolicyPolicyItemDaily defaults) {
            $ = new GetBackupCompliancePolicyPolicyItemDaily(Objects.requireNonNull(defaults));
        }
        ...
        public GetBackupCompliancePolicyPolicyItemDaily build() {
            if ($.frequencyInterval == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemDaily", "frequencyInterval");
            }
            if ($.frequencyType == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemDaily", "frequencyType");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemDaily", "id");
            }
            if ($.retentionUnit == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemDaily", "retentionUnit");
            }
            if ($.retentionValue == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemDaily", "retentionValue");
            }
            return $;
        }
    }
