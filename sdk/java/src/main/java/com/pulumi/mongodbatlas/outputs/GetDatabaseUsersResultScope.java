...
public final class GetDatabaseUsersResultScope {
    ...
    public static Builder builder(GetDatabaseUsersResultScope defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetDatabaseUsersResultScope defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetDatabaseUsersResultScope", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDatabaseUsersResultScope", "type");
            }
            this.type = type;
            return this;
        }
