...
public final class GetStreamInstancesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetStreamInstancesArgs Empty = new GetStreamInstancesArgs();
    ...
    private GetStreamInstancesArgs() {}

    private GetStreamInstancesArgs(GetStreamInstancesArgs $) {
    ...
    public static Builder builder(GetStreamInstancesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStreamInstancesArgs();
        }

        public Builder(GetStreamInstancesArgs defaults) {
            $ = new GetStreamInstancesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetStreamInstancesArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("GetStreamInstancesArgs", "projectId");
            }
            return $;
        }
    }
