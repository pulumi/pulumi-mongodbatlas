...
public final class GetFederatedDatabaseInstanceCloudProviderConfigAwArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedDatabaseInstanceCloudProviderConfigAwArgs Empty = new GetFederatedDatabaseInstanceCloudProviderConfigAwArgs();
    ...
    private GetFederatedDatabaseInstanceCloudProviderConfigAwArgs() {}

    private GetFederatedDatabaseInstanceCloudProviderConfigAwArgs(GetFederatedDatabaseInstanceCloudProviderConfigAwArgs $) {
    ...
    public static Builder builder(GetFederatedDatabaseInstanceCloudProviderConfigAwArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedDatabaseInstanceCloudProviderConfigAwArgs();
        }

        public Builder(GetFederatedDatabaseInstanceCloudProviderConfigAwArgs defaults) {
            $ = new GetFederatedDatabaseInstanceCloudProviderConfigAwArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedDatabaseInstanceCloudProviderConfigAwArgs build() {
            if ($.externalId == null) {
                throw new MissingRequiredPropertyException("GetFederatedDatabaseInstanceCloudProviderConfigAwArgs", "externalId");
            }
            if ($.iamAssumedRoleArn == null) {
                throw new MissingRequiredPropertyException("GetFederatedDatabaseInstanceCloudProviderConfigAwArgs", "iamAssumedRoleArn");
            }
            if ($.iamUserArn == null) {
                throw new MissingRequiredPropertyException("GetFederatedDatabaseInstanceCloudProviderConfigAwArgs", "iamUserArn");
            }
            if ($.roleId == null) {
                throw new MissingRequiredPropertyException("GetFederatedDatabaseInstanceCloudProviderConfigAwArgs", "roleId");
            }
            return $;
        }
    }
