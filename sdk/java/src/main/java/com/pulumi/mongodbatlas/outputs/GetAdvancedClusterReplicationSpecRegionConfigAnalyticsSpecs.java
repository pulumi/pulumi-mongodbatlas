...
public final class GetAdvancedClusterReplicationSpecRegionConfigAnalyticsSpecs {
    ...
    public static final class Builder {
        ...
        public Builder diskSizeGb(Double diskSizeGb) {
            if (diskSizeGb == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigAnalyticsSpecs", "diskSizeGb");
            }
        ...
        public Builder diskThroughput(Integer diskThroughput) {
            if (diskThroughput == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigAnalyticsSpecs", "diskThroughput");
            }
        ...
        public Builder ebsVolumeType(String ebsVolumeType) {
            if (ebsVolumeType == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigAnalyticsSpecs", "ebsVolumeType");
            }
        ...
        public Builder nodeCount(Integer nodeCount) {
            if (nodeCount == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigAnalyticsSpecs", "nodeCount");
            }
            this.nodeCount = nodeCount;
            return this;
        }
        public GetAdvancedClusterReplicationSpecRegionConfigAnalyticsSpecs build() {
            final var _resultValue = new GetAdvancedClusterReplicationSpecRegionConfigAnalyticsSpecs();
