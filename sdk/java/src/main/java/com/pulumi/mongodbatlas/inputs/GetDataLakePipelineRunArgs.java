    ...
    public static final class Builder {
        ...
        public GetDataLakePipelineRunArgs build() {
            if ($.pipelineName == null) {
                throw new MissingRequiredPropertyException("GetDataLakePipelineRunArgs", "pipelineName");
            }
            if ($.pipelineRunId == null) {
                throw new MissingRequiredPropertyException("GetDataLakePipelineRunArgs", "pipelineRunId");
            }
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("GetDataLakePipelineRunArgs", "projectId");
            }
            return $;
        }
    }
