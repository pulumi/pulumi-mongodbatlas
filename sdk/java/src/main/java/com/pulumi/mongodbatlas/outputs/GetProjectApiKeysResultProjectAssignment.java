...
public final class GetProjectApiKeysResultProjectAssignment {
    ...
    public static final class Builder {
        ...
        public Builder projectId(String projectId) {
            if (projectId == null) {
              throw new MissingRequiredPropertyException("GetProjectApiKeysResultProjectAssignment", "projectId");
            }
        ...
        public Builder roleNames(List<String> roleNames) {
            if (roleNames == null) {
              throw new MissingRequiredPropertyException("GetProjectApiKeysResultProjectAssignment", "roleNames");
            }
