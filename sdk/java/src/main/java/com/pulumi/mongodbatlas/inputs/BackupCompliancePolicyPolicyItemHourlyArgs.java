...
public final class BackupCompliancePolicyPolicyItemHourlyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BackupCompliancePolicyPolicyItemHourlyArgs() {}

    private BackupCompliancePolicyPolicyItemHourlyArgs(BackupCompliancePolicyPolicyItemHourlyArgs $) {
    ...
    public static Builder builder(BackupCompliancePolicyPolicyItemHourlyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BackupCompliancePolicyPolicyItemHourlyArgs();
        }

        public Builder(BackupCompliancePolicyPolicyItemHourlyArgs defaults) {
            $ = new BackupCompliancePolicyPolicyItemHourlyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BackupCompliancePolicyPolicyItemHourlyArgs build() {
            if ($.frequencyInterval == null) {
                throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemHourlyArgs", "frequencyInterval");
            }
            if ($.retentionUnit == null) {
                throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemHourlyArgs", "retentionUnit");
            }
            if ($.retentionValue == null) {
                throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemHourlyArgs", "retentionValue");
            }
            return $;
        }
    }
