...
public class NetworkContainer extends com.pulumi.resources.CustomResource {
     ...
     */
    public NetworkContainer(java.lang.String name) {
     ...
     */
    public NetworkContainer(java.lang.String name, NetworkContainerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NetworkContainer(java.lang.String name, NetworkContainerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("mongodbatlas:index/networkContainer:NetworkContainer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NetworkContainer(java.lang.String name, Output<java.lang.String> id, @Nullable NetworkContainerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("mongodbatlas:index/networkContainer:NetworkContainer", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static NetworkContainer get(java.lang.String name, Output<java.lang.String> id, @Nullable NetworkContainerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
