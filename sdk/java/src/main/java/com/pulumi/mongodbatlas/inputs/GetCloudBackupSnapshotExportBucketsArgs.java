...
public final class GetCloudBackupSnapshotExportBucketsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudBackupSnapshotExportBucketsArgs Empty = new GetCloudBackupSnapshotExportBucketsArgs();
    ...
    private GetCloudBackupSnapshotExportBucketsArgs() {}

    private GetCloudBackupSnapshotExportBucketsArgs(GetCloudBackupSnapshotExportBucketsArgs $) {
    ...
    public static Builder builder(GetCloudBackupSnapshotExportBucketsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudBackupSnapshotExportBucketsArgs();
        }

        public Builder(GetCloudBackupSnapshotExportBucketsArgs defaults) {
            $ = new GetCloudBackupSnapshotExportBucketsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCloudBackupSnapshotExportBucketsArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("GetCloudBackupSnapshotExportBucketsArgs", "projectId");
            }
            return $;
        }
    }
