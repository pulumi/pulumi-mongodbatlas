...
@CustomType
public final class GetCloudBackupSchedulePolicyItemDaily {
    /**
    ...
    private GetCloudBackupSchedulePolicyItemDaily() {}
    /**
     * @return Desired frequency of the new backup policy item specified by `frequencyType` (yearly in this case). The supported values for yearly policies are
     * 
     */
    ...
    public static Builder builder(GetCloudBackupSchedulePolicyItemDaily defaults) {
    ...
    public static final class Builder {
        ...
        private Integer retentionValue;
        public Builder() {}
        public Builder(GetCloudBackupSchedulePolicyItemDaily defaults) {
        ...
        public Builder frequencyInterval(Integer frequencyInterval) {
            if (frequencyInterval == null) {
              throw new MissingRequiredPropertyException("GetCloudBackupSchedulePolicyItemDaily", "frequencyInterval");
            }
        ...
        public Builder frequencyType(String frequencyType) {
            if (frequencyType == null) {
              throw new MissingRequiredPropertyException("GetCloudBackupSchedulePolicyItemDaily", "frequencyType");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCloudBackupSchedulePolicyItemDaily", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder retentionUnit(String retentionUnit) {
            if (retentionUnit == null) {
              throw new MissingRequiredPropertyException("GetCloudBackupSchedulePolicyItemDaily", "retentionUnit");
            }
        ...
        public Builder retentionValue(Integer retentionValue) {
            if (retentionValue == null) {
              throw new MissingRequiredPropertyException("GetCloudBackupSchedulePolicyItemDaily", "retentionValue");
            }
            this.retentionValue = retentionValue;
            return this;
        }
        public GetCloudBackupSchedulePolicyItemDaily build() {
            final var _resultValue = new GetCloudBackupSchedulePolicyItemDaily();
