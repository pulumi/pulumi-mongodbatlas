...
public final class GetStreamConnectionNetworkingAccess {
    ...
    public static Builder builder(GetStreamConnectionNetworkingAccess defaults) {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetStreamConnectionNetworkingAccess", "type");
            }
            this.type = type;
            return this;
        }
