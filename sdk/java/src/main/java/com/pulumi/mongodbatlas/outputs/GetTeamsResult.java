...
public final class GetTeamsResult {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetTeamsResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder orgId(String orgId) {
            if (orgId == null) {
              throw new MissingRequiredPropertyException("GetTeamsResult", "orgId");
            }
            this.orgId = orgId;
            return this;
        }
        ...
        public Builder teamId(String teamId) {
            if (teamId == null) {
              throw new MissingRequiredPropertyException("GetTeamsResult", "teamId");
            }
            this.teamId = teamId;
            return this;
        }
        ...
        public Builder usernames(List<String> usernames) {
            if (usernames == null) {
              throw new MissingRequiredPropertyException("GetTeamsResult", "usernames");
            }
