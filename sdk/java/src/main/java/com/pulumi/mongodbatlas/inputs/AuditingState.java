...
public final class AuditingState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The unique ID for the project to configure auditing, also known as `groupId` in the official documentation. **Note: When changing this value to a different projectId it will delete the current audit settings for the original project that was assigned to.**
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param projectId The unique ID for the project to configure auditing, also known as `groupId` in the official documentation. **Note: When changing this value to a different projectId it will delete the current audit settings for the original project that was assigned to.**
         * 
         * @return builder
         * 
         */
