...
@CustomType
public final class GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs {
    /**
    ...
    private GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs() {}
    /**
     * @return Target IOPS (Input/Output Operations Per Second) desired for storage attached to this hardware. See the resource documentation for `electableSpecs` for additional `diskIops` configuration details.
     * 
     */
    ...
    public static Builder builder(GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs defaults) {
    ...
    public static final class Builder {
        ...
        private Integer nodeCount;
        public Builder() {}
        public Builder(GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs defaults) {
        ...
        public Builder diskIops(Integer diskIops) {
            if (diskIops == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs", "diskIops");
            }
        ...
        public Builder diskSizeGb(Double diskSizeGb) {
            if (diskSizeGb == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs", "diskSizeGb");
            }
        ...
        public Builder diskThroughput(Integer diskThroughput) {
            if (diskThroughput == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs", "diskThroughput");
            }
        ...
        public Builder ebsVolumeType(String ebsVolumeType) {
            if (ebsVolumeType == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs", "ebsVolumeType");
            }
        ...
        public Builder instanceSize(String instanceSize) {
            if (instanceSize == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs", "instanceSize");
            }
        ...
        public Builder nodeCount(Integer nodeCount) {
            if (nodeCount == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs", "nodeCount");
            }
            this.nodeCount = nodeCount;
            return this;
        }
        public GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs build() {
            final var _resultValue = new GetAdvancedClusterReplicationSpecRegionConfigEffectiveAnalyticsSpecs();
