    ...
    public static final class Builder {
        ...
        public GetDatabaseUserArgs build() {
            if ($.authDatabaseName == null) {
                throw new MissingRequiredPropertyException("GetDatabaseUserArgs", "authDatabaseName");
            }
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("GetDatabaseUserArgs", "projectId");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("GetDatabaseUserArgs", "username");
            }
            return $;
        }
    }
