...
public final class TeamsState extends com.pulumi.resources.ResourceArgs {

    public static final TeamsState Empty = new TeamsState();
    ...
    public static Builder builder(TeamsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(TeamsState defaults) {
            $ = new TeamsState(Objects.requireNonNull(defaults));
        }
