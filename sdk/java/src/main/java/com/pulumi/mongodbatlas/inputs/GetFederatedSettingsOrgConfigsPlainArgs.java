...
public final class GetFederatedSettingsOrgConfigsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedSettingsOrgConfigsPlainArgs Empty = new GetFederatedSettingsOrgConfigsPlainArgs();
    ...
    private GetFederatedSettingsOrgConfigsPlainArgs() {}

    private GetFederatedSettingsOrgConfigsPlainArgs(GetFederatedSettingsOrgConfigsPlainArgs $) {
    ...
    public static Builder builder(GetFederatedSettingsOrgConfigsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedSettingsOrgConfigsPlainArgs();
        }

        public Builder(GetFederatedSettingsOrgConfigsPlainArgs defaults) {
            $ = new GetFederatedSettingsOrgConfigsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedSettingsOrgConfigsPlainArgs build() {
            if ($.federationSettingsId == null) {
                throw new MissingRequiredPropertyException("GetFederatedSettingsOrgConfigsPlainArgs", "federationSettingsId");
            }
            return $;
        }
    }
