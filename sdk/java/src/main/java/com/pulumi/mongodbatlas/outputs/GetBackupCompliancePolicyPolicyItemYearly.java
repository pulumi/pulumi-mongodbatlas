...
@CustomType
public final class GetBackupCompliancePolicyPolicyItemYearly {
    /**
    ...
    private GetBackupCompliancePolicyPolicyItemYearly() {}
    /**
     * @return Desired frequency of the new backup policy item specified by `frequency_type` (yearly in this case). The supported values for yearly policies are
     * 
     */
    ...
    public static Builder builder(GetBackupCompliancePolicyPolicyItemYearly defaults) {
    ...
    public static final class Builder {
        ...
        private Integer retentionValue;
        public Builder() {}
        public Builder(GetBackupCompliancePolicyPolicyItemYearly defaults) {
        ...
        public Builder frequencyInterval(Integer frequencyInterval) {
            if (frequencyInterval == null) {
              throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemYearly", "frequencyInterval");
            }
        ...
        public Builder frequencyType(String frequencyType) {
            if (frequencyType == null) {
              throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemYearly", "frequencyType");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemYearly", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder retentionUnit(String retentionUnit) {
            if (retentionUnit == null) {
              throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemYearly", "retentionUnit");
            }
        ...
        public Builder retentionValue(Integer retentionValue) {
            if (retentionValue == null) {
              throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemYearly", "retentionValue");
            }
            this.retentionValue = retentionValue;
            return this;
        }
        public GetBackupCompliancePolicyPolicyItemYearly build() {
            final var _resultValue = new GetBackupCompliancePolicyPolicyItemYearly();
