...
public final class GetBackupCompliancePolicyPolicyItemDailyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetBackupCompliancePolicyPolicyItemDailyArgs Empty = new GetBackupCompliancePolicyPolicyItemDailyArgs();
    ...
    private GetBackupCompliancePolicyPolicyItemDailyArgs() {}

    private GetBackupCompliancePolicyPolicyItemDailyArgs(GetBackupCompliancePolicyPolicyItemDailyArgs $) {
    ...
    public static Builder builder(GetBackupCompliancePolicyPolicyItemDailyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBackupCompliancePolicyPolicyItemDailyArgs();
        }

        public Builder(GetBackupCompliancePolicyPolicyItemDailyArgs defaults) {
            $ = new GetBackupCompliancePolicyPolicyItemDailyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetBackupCompliancePolicyPolicyItemDailyArgs build() {
            if ($.frequencyInterval == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemDailyArgs", "frequencyInterval");
            }
            if ($.frequencyType == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemDailyArgs", "frequencyType");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemDailyArgs", "id");
            }
            if ($.retentionUnit == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemDailyArgs", "retentionUnit");
            }
            if ($.retentionValue == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemDailyArgs", "retentionValue");
            }
            return $;
        }
    }
