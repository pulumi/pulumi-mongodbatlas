...
@CustomType
public final class BackupCompliancePolicyPolicyItemDaily {
    /**
    ...
    private BackupCompliancePolicyPolicyItemDaily() {}
    /**
     * @return Desired frequency of the new backup policy item specified by `frequency_type` (monthly in this case). The supported values for weekly policies are
     * 
     */
    ...
    public static Builder builder(BackupCompliancePolicyPolicyItemDaily defaults) {
    ...
    public static final class Builder {
        ...
        private Integer retentionValue;
        public Builder() {}
        public Builder(BackupCompliancePolicyPolicyItemDaily defaults) {
        ...
        public Builder frequencyInterval(Integer frequencyInterval) {
            if (frequencyInterval == null) {
              throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemDaily", "frequencyInterval");
            }
        ...
        public Builder retentionUnit(String retentionUnit) {
            if (retentionUnit == null) {
              throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemDaily", "retentionUnit");
            }
        ...
        public Builder retentionValue(Integer retentionValue) {
            if (retentionValue == null) {
              throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemDaily", "retentionValue");
            }
            this.retentionValue = retentionValue;
            return this;
        }
        public BackupCompliancePolicyPolicyItemDaily build() {
            final var _resultValue = new BackupCompliancePolicyPolicyItemDaily();
