...
public final class GetDataLakePipelinesResultTransformation {
    ...
    public static final class Builder {
        ...
        public Builder field(String field) {
            if (field == null) {
              throw new MissingRequiredPropertyException("GetDataLakePipelinesResultTransformation", "field");
            }
            this.field = field;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDataLakePipelinesResultTransformation", "type");
            }
            this.type = type;
            return this;
        }
