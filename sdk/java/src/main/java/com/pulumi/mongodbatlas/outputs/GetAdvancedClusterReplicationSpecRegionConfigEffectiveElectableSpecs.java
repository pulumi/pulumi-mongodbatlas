...
@CustomType
public final class GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs {
    /**
    ...
    private GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs() {}
    /**
     * @return Target IOPS (Input/Output Operations Per Second) desired for storage attached to this hardware. See the resource documentation for `electableSpecs` for additional `diskIops` configuration details.
     * 
     */
    ...
    public static Builder builder(GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs defaults) {
    ...
    public static final class Builder {
        ...
        private Integer nodeCount;
        public Builder() {}
        public Builder(GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs defaults) {
        ...
        public Builder diskIops(Integer diskIops) {
            if (diskIops == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs", "diskIops");
            }
        ...
        public Builder diskSizeGb(Double diskSizeGb) {
            if (diskSizeGb == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs", "diskSizeGb");
            }
        ...
        public Builder diskThroughput(Integer diskThroughput) {
            if (diskThroughput == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs", "diskThroughput");
            }
        ...
        public Builder ebsVolumeType(String ebsVolumeType) {
            if (ebsVolumeType == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs", "ebsVolumeType");
            }
        ...
        public Builder instanceSize(String instanceSize) {
            if (instanceSize == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs", "instanceSize");
            }
        ...
        public Builder nodeCount(Integer nodeCount) {
            if (nodeCount == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs", "nodeCount");
            }
            this.nodeCount = nodeCount;
            return this;
        }
        public GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs build() {
            final var _resultValue = new GetAdvancedClusterReplicationSpecRegionConfigEffectiveElectableSpecs();
