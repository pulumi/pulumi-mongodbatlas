    ...
    public static final class Builder {
        ...
        public Builder integrationId(String integrationId) {
            if (integrationId == null) {
              throw new MissingRequiredPropertyException("GetAlertConfigurationsResultNotification", "integrationId");
            }
        ...
        public GetAlertConfigurationsResultNotification build() {
            final var _resultValue = new GetAlertConfigurationsResultNotification();
