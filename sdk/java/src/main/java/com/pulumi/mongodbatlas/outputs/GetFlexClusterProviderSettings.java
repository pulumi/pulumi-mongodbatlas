...
@CustomType
public final class GetFlexClusterProviderSettings {
    /**
    ...
    private GetFlexClusterProviderSettings() {}
    /**
     * @return Cloud service provider on which MongoDB Cloud provisioned the flex cluster.
     * 
     */
    ...
    public static Builder builder(GetFlexClusterProviderSettings defaults) {
    ...
    public static final class Builder {
        ...
        private String regionName;
        public Builder() {}
        public Builder(GetFlexClusterProviderSettings defaults) {
        ...
        public Builder backingProviderName(String backingProviderName) {
            if (backingProviderName == null) {
              throw new MissingRequiredPropertyException("GetFlexClusterProviderSettings", "backingProviderName");
            }
        ...
        public Builder diskSizeGb(Double diskSizeGb) {
            if (diskSizeGb == null) {
              throw new MissingRequiredPropertyException("GetFlexClusterProviderSettings", "diskSizeGb");
            }
        ...
        public Builder providerName(String providerName) {
            if (providerName == null) {
              throw new MissingRequiredPropertyException("GetFlexClusterProviderSettings", "providerName");
            }
        ...
        public Builder regionName(String regionName) {
            if (regionName == null) {
              throw new MissingRequiredPropertyException("GetFlexClusterProviderSettings", "regionName");
            }
            this.regionName = regionName;
            return this;
        }
        public GetFlexClusterProviderSettings build() {
            final var _resultValue = new GetFlexClusterProviderSettings();
