...
public final class GetClusterTag {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetClusterTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetClusterTag", "value");
            }
            this.value = value;
            return this;
        }
        public GetClusterTag build() {
            final var _resultValue = new GetClusterTag();
