...
public final class GetProjectsResultUser {
    ...
    public static Builder builder(GetProjectsResultUser defaults) {
    ...
    public static final class Builder {
        ...
        private String username;
        public Builder() {}
        public Builder(GetProjectsResultUser defaults) {
        ...
        public Builder country(String country) {
            if (country == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "country");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "createdAt");
            }
        ...
        public Builder firstName(String firstName) {
            if (firstName == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "firstName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder invitationCreatedAt(String invitationCreatedAt) {
            if (invitationCreatedAt == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "invitationCreatedAt");
            }
        ...
        public Builder invitationExpiresAt(String invitationExpiresAt) {
            if (invitationExpiresAt == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "invitationExpiresAt");
            }
        ...
        public Builder inviterUsername(String inviterUsername) {
            if (inviterUsername == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "inviterUsername");
            }
        ...
        public Builder lastAuth(String lastAuth) {
            if (lastAuth == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "lastAuth");
            }
        ...
        public Builder lastName(String lastName) {
            if (lastName == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "lastName");
            }
        ...
        public Builder mobileNumber(String mobileNumber) {
            if (mobileNumber == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "mobileNumber");
            }
        ...
        public Builder orgMembershipStatus(String orgMembershipStatus) {
            if (orgMembershipStatus == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "orgMembershipStatus");
            }
        ...
        public Builder roles(List<String> roles) {
            if (roles == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "roles");
            }
            this.roles = roles;
            return this;
        }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetProjectsResultUser", "username");
            }
            this.username = username;
            return this;
        }
        public GetProjectsResultUser build() {
            final var _resultValue = new GetProjectsResultUser();
