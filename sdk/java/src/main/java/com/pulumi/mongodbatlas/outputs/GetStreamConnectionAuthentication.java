...
public final class GetStreamConnectionAuthentication {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetStreamConnectionAuthentication", "clientId");
            }
        ...
        public Builder clientSecret(String clientSecret) {
            if (clientSecret == null) {
              throw new MissingRequiredPropertyException("GetStreamConnectionAuthentication", "clientSecret");
            }
        ...
        public Builder method(String method) {
            if (method == null) {
              throw new MissingRequiredPropertyException("GetStreamConnectionAuthentication", "method");
            }
            this.method = method;
            return this;
        }
        ...
        public Builder saslOauthbearerExtensions(String saslOauthbearerExtensions) {
            if (saslOauthbearerExtensions == null) {
              throw new MissingRequiredPropertyException("GetStreamConnectionAuthentication", "saslOauthbearerExtensions");
            }
        ...
        public Builder scope(String scope) {
            if (scope == null) {
              throw new MissingRequiredPropertyException("GetStreamConnectionAuthentication", "scope");
            }
            this.scope = scope;
            return this;
        }
        ...
        public Builder tokenEndpointUrl(String tokenEndpointUrl) {
            if (tokenEndpointUrl == null) {
              throw new MissingRequiredPropertyException("GetStreamConnectionAuthentication", "tokenEndpointUrl");
            }
