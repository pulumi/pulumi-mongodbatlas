...
import com.pulumi.mongodbatlas.outputs.GetOrganizationUserRole;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetOrganizationUser {
    /**
     ...
     * 
     */
    private List<GetOrganizationUserRole> roles;
    /**
     ...
     * 
     */
    public List<GetOrganizationUserRole> roles() {
        return this.roles;
    }
    /**
     * @return List of unique 24-hexadecimal digit strings that identifies the teams to which this MongoDB Cloud user belongs.
    ...
    public static Builder builder(GetOrganizationUser defaults) {
    ...
    public static final class Builder {
        ...
        private String username;
        public Builder() {}
        public Builder(GetOrganizationUser defaults) {
        ...
        public Builder country(String country) {
            if (country == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "country");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "createdAt");
            }
        ...
        public Builder firstName(String firstName) {
            if (firstName == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "firstName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder invitationCreatedAt(String invitationCreatedAt) {
            if (invitationCreatedAt == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "invitationCreatedAt");
            }
        ...
        public Builder invitationExpiresAt(String invitationExpiresAt) {
            if (invitationExpiresAt == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "invitationExpiresAt");
            }
        ...
        public Builder inviterUsername(String inviterUsername) {
            if (inviterUsername == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "inviterUsername");
            }
        ...
        public Builder lastAuth(String lastAuth) {
            if (lastAuth == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "lastAuth");
            }
        ...
        public Builder lastName(String lastName) {
            if (lastName == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "lastName");
            }
        ...
        public Builder mobileNumber(String mobileNumber) {
            if (mobileNumber == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "mobileNumber");
            }
        ...
        public Builder orgMembershipStatus(String orgMembershipStatus) {
            if (orgMembershipStatus == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "orgMembershipStatus");
            }
            this.orgMembershipStatus = orgMembershipStatus;
            return this;
        }
        @CustomType.Setter
        public Builder roles(List<GetOrganizationUserRole> roles) {
            if (roles == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "roles");
            }
            this.roles = roles;
            return this;
        }
        public Builder roles(GetOrganizationUserRole... roles) {
            return roles(List.of(roles));
        }
        @CustomType.Setter
        public Builder teamIds(List<String> teamIds) {
            if (teamIds == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "teamIds");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetOrganizationUser", "username");
            }
            this.username = username;
            return this;
        }
        public GetOrganizationUser build() {
            final var _resultValue = new GetOrganizationUser();
