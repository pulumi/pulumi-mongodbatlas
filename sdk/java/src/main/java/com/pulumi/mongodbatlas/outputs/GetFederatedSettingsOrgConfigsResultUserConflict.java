...
@CustomType
public final class GetFederatedSettingsOrgConfigsResultUserConflict {
    /**
    ...
    private GetFederatedSettingsOrgConfigsResultUserConflict() {}
    /**
     * @return Email address of the the user that conflicts with selected domains.
     * 
     */
    ...
    public static Builder builder(GetFederatedSettingsOrgConfigsResultUserConflict defaults) {
    ...
    public static final class Builder {
        ...
        private String userId;
        public Builder() {}
        public Builder(GetFederatedSettingsOrgConfigsResultUserConflict defaults) {
