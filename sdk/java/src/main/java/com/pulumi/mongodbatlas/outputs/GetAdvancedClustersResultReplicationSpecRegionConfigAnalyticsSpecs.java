...
public final class GetAdvancedClustersResultReplicationSpecRegionConfigAnalyticsSpecs {
    ...
    public static final class Builder {
        ...
        public Builder diskSizeGb(Double diskSizeGb) {
            if (diskSizeGb == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClustersResultReplicationSpecRegionConfigAnalyticsSpecs", "diskSizeGb");
            }
        ...
        public Builder diskThroughput(Integer diskThroughput) {
            if (diskThroughput == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClustersResultReplicationSpecRegionConfigAnalyticsSpecs", "diskThroughput");
            }
        ...
        public Builder ebsVolumeType(String ebsVolumeType) {
            if (ebsVolumeType == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClustersResultReplicationSpecRegionConfigAnalyticsSpecs", "ebsVolumeType");
            }
