...
public final class GetBackupCompliancePolicyPolicyItemWeeklyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetBackupCompliancePolicyPolicyItemWeeklyArgs Empty = new GetBackupCompliancePolicyPolicyItemWeeklyArgs();
    ...
    private GetBackupCompliancePolicyPolicyItemWeeklyArgs() {}

    private GetBackupCompliancePolicyPolicyItemWeeklyArgs(GetBackupCompliancePolicyPolicyItemWeeklyArgs $) {
    ...
    public static Builder builder(GetBackupCompliancePolicyPolicyItemWeeklyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBackupCompliancePolicyPolicyItemWeeklyArgs();
        }

        public Builder(GetBackupCompliancePolicyPolicyItemWeeklyArgs defaults) {
            $ = new GetBackupCompliancePolicyPolicyItemWeeklyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetBackupCompliancePolicyPolicyItemWeeklyArgs build() {
            if ($.frequencyInterval == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemWeeklyArgs", "frequencyInterval");
            }
            if ($.frequencyType == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemWeeklyArgs", "frequencyType");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemWeeklyArgs", "id");
            }
            if ($.retentionUnit == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemWeeklyArgs", "retentionUnit");
            }
            if ($.retentionValue == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemWeeklyArgs", "retentionValue");
            }
            return $;
        }
    }
