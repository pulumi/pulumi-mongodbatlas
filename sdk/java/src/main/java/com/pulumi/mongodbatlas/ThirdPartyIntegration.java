 ...
 * ## Import
 * 
 * Third-Party Integration Settings can be imported using project ID and the integration type, in the format `projectId`-`type`, e.g.
 * 
 * ```sh
...
public class ThirdPartyIntegration extends com.pulumi.resources.CustomResource {
     ...
     */
    public ThirdPartyIntegration(java.lang.String name) {
     ...
     */
    public ThirdPartyIntegration(java.lang.String name, ThirdPartyIntegrationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ThirdPartyIntegration(java.lang.String name, ThirdPartyIntegrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("mongodbatlas:index/thirdPartyIntegration:ThirdPartyIntegration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ThirdPartyIntegration(java.lang.String name, Output<java.lang.String> id, @Nullable ThirdPartyIntegrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("mongodbatlas:index/thirdPartyIntegration:ThirdPartyIntegration", name, state, makeResourceOptions(options, id), false);
    }

    private static ThirdPartyIntegrationArgs makeArgs(ThirdPartyIntegrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ThirdPartyIntegrationArgs.Empty : args;
    }
     ...
     */
    public static ThirdPartyIntegration get(java.lang.String name, Output<java.lang.String> id, @Nullable ThirdPartyIntegrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
