    ...
    public static final class Builder {
        ...
        public CloudBackupSchedulePolicyItemMonthlyArgs build() {
            if ($.frequencyInterval == null) {
                throw new MissingRequiredPropertyException("CloudBackupSchedulePolicyItemMonthlyArgs", "frequencyInterval");
            }
            if ($.retentionUnit == null) {
                throw new MissingRequiredPropertyException("CloudBackupSchedulePolicyItemMonthlyArgs", "retentionUnit");
            }
            if ($.retentionValue == null) {
                throw new MissingRequiredPropertyException("CloudBackupSchedulePolicyItemMonthlyArgs", "retentionValue");
            }
            return $;
        }
    }
