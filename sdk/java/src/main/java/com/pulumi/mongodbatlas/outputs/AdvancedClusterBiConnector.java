...
@CustomType
public final class AdvancedClusterBiConnector {
    /**
    ...
    private AdvancedClusterBiConnector() {}
    /**
     * @return Specifies whether or not BI Connector for Atlas is enabled on the cluster.l
     * *
     * - Set to `true` to enable BI Connector for Atlas.
    ...
    public static Builder builder(AdvancedClusterBiConnector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String readPreference;
        public Builder() {}
        public Builder(AdvancedClusterBiConnector defaults) {
        ...
        public AdvancedClusterBiConnector build() {
            final var o = new AdvancedClusterBiConnector();
            o.enabled = enabled;
