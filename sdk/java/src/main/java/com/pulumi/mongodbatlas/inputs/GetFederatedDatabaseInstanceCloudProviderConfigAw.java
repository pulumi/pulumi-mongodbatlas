...
public final class GetFederatedDatabaseInstanceCloudProviderConfigAw extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedDatabaseInstanceCloudProviderConfigAw Empty = new GetFederatedDatabaseInstanceCloudProviderConfigAw();
    ...
    private GetFederatedDatabaseInstanceCloudProviderConfigAw() {}

    private GetFederatedDatabaseInstanceCloudProviderConfigAw(GetFederatedDatabaseInstanceCloudProviderConfigAw $) {
    ...
    public static Builder builder(GetFederatedDatabaseInstanceCloudProviderConfigAw defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedDatabaseInstanceCloudProviderConfigAw();
        }

        public Builder(GetFederatedDatabaseInstanceCloudProviderConfigAw defaults) {
            $ = new GetFederatedDatabaseInstanceCloudProviderConfigAw(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedDatabaseInstanceCloudProviderConfigAw build() {
            if ($.externalId == null) {
                throw new MissingRequiredPropertyException("GetFederatedDatabaseInstanceCloudProviderConfigAw", "externalId");
            }
            if ($.iamAssumedRoleArn == null) {
                throw new MissingRequiredPropertyException("GetFederatedDatabaseInstanceCloudProviderConfigAw", "iamAssumedRoleArn");
            }
            if ($.iamUserArn == null) {
                throw new MissingRequiredPropertyException("GetFederatedDatabaseInstanceCloudProviderConfigAw", "iamUserArn");
            }
            if ($.roleId == null) {
                throw new MissingRequiredPropertyException("GetFederatedDatabaseInstanceCloudProviderConfigAw", "roleId");
            }
            return $;
        }
    }
