...
public final class GetBackupCompliancePolicyPolicyItemMonthlyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetBackupCompliancePolicyPolicyItemMonthlyArgs Empty = new GetBackupCompliancePolicyPolicyItemMonthlyArgs();
    ...
    private GetBackupCompliancePolicyPolicyItemMonthlyArgs(GetBackupCompliancePolicyPolicyItemMonthlyArgs $) {
    ...
    public static Builder builder(GetBackupCompliancePolicyPolicyItemMonthlyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBackupCompliancePolicyPolicyItemMonthlyArgs();
        }

        public Builder(GetBackupCompliancePolicyPolicyItemMonthlyArgs defaults) {
            $ = new GetBackupCompliancePolicyPolicyItemMonthlyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetBackupCompliancePolicyPolicyItemMonthlyArgs build() {
            if ($.frequencyInterval == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemMonthlyArgs", "frequencyInterval");
            }
            if ($.frequencyType == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemMonthlyArgs", "frequencyType");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemMonthlyArgs", "id");
            }
            if ($.retentionUnit == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemMonthlyArgs", "retentionUnit");
            }
            if ($.retentionValue == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemMonthlyArgs", "retentionValue");
            }
            return $;
        }
    }
