...
@CustomType
public final class BackupCompliancePolicyPolicyItemYearly {
    /**
    ...
    public static Builder builder(BackupCompliancePolicyPolicyItemYearly defaults) {
    ...
    public static final class Builder {
        ...
        private Integer retentionValue;
        public Builder() {}
        public Builder(BackupCompliancePolicyPolicyItemYearly defaults) {
        ...
        public Builder frequencyInterval(Integer frequencyInterval) {
            if (frequencyInterval == null) {
              throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemYearly", "frequencyInterval");
            }
        ...
        public Builder retentionUnit(String retentionUnit) {
            if (retentionUnit == null) {
              throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemYearly", "retentionUnit");
            }
        ...
        public Builder retentionValue(Integer retentionValue) {
            if (retentionValue == null) {
              throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemYearly", "retentionValue");
            }
            this.retentionValue = retentionValue;
            return this;
        }
        public BackupCompliancePolicyPolicyItemYearly build() {
            final var _resultValue = new BackupCompliancePolicyPolicyItemYearly();
