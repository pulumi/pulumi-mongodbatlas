...
public final class GetDataLakePipelinesResultSinkPartitionField {
    ...
    public static final class Builder {
        ...
        public Builder fieldName(String fieldName) {
            if (fieldName == null) {
              throw new MissingRequiredPropertyException("GetDataLakePipelinesResultSinkPartitionField", "fieldName");
            }
        ...
        public Builder order(Integer order) {
            if (order == null) {
              throw new MissingRequiredPropertyException("GetDataLakePipelinesResultSinkPartitionField", "order");
            }
            this.order = order;
            return this;
        }
        public GetDataLakePipelinesResultSinkPartitionField build() {
            final var _resultValue = new GetDataLakePipelinesResultSinkPartitionField();
