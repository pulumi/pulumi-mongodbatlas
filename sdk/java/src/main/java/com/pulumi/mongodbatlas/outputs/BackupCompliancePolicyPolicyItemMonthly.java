...
@CustomType
public final class BackupCompliancePolicyPolicyItemMonthly {
    /**
    ...
    public static Builder builder(BackupCompliancePolicyPolicyItemMonthly defaults) {
    ...
    public static final class Builder {
        ...
        private Integer retentionValue;
        public Builder() {}
        public Builder(BackupCompliancePolicyPolicyItemMonthly defaults) {
        ...
        public Builder frequencyInterval(Integer frequencyInterval) {
            if (frequencyInterval == null) {
              throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemMonthly", "frequencyInterval");
            }
        ...
        public Builder retentionUnit(String retentionUnit) {
            if (retentionUnit == null) {
              throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemMonthly", "retentionUnit");
            }
        ...
        public Builder retentionValue(Integer retentionValue) {
            if (retentionValue == null) {
              throw new MissingRequiredPropertyException("BackupCompliancePolicyPolicyItemMonthly", "retentionValue");
            }
            this.retentionValue = retentionValue;
            return this;
        }
        public BackupCompliancePolicyPolicyItemMonthly build() {
            final var _resultValue = new BackupCompliancePolicyPolicyItemMonthly();
