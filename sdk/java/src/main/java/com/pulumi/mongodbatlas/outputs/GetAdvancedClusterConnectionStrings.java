...
import com.pulumi.mongodbatlas.outputs.GetAdvancedClusterConnectionStringsPrivateEndpoint;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetAdvancedClusterConnectionStrings {
    /**
     ...
     * 
     */
    private List<GetAdvancedClusterConnectionStringsPrivateEndpoint> privateEndpoints;
    /**
    ...
    private GetAdvancedClusterConnectionStrings() {}
    /**
     * @return [Network-peering-endpoint-aware](https://docs.atlas.mongodb.com/security-vpc-peering/#vpc-peering) mongodb://connection strings for each interface VPC endpoint you configured to connect to this cluster. Returned only if you created a network peering connection to this cluster.
     * 
     */
     ...
     * 
     */
    public List<GetAdvancedClusterConnectionStringsPrivateEndpoint> privateEndpoints() {
    ...
    public static Builder builder(GetAdvancedClusterConnectionStrings defaults) {
    ...
    public static final class Builder {
        ...
        private String standardSrv;
        public Builder() {}
        public Builder(GetAdvancedClusterConnectionStrings defaults) {
        ...
        public Builder private_(String private_) {
            if (private_ == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterConnectionStrings", "private_");
            }
            this.private_ = private_;
            return this;
        }
        @CustomType.Setter
        public Builder privateEndpoints(List<GetAdvancedClusterConnectionStringsPrivateEndpoint> privateEndpoints) {
            if (privateEndpoints == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterConnectionStrings", "privateEndpoints");
            }
            this.privateEndpoints = privateEndpoints;
            return this;
        }
        public Builder privateEndpoints(GetAdvancedClusterConnectionStringsPrivateEndpoint... privateEndpoints) {
            return privateEndpoints(List.of(privateEndpoints));
        }
        @CustomType.Setter
        public Builder privateSrv(String privateSrv) {
            if (privateSrv == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterConnectionStrings", "privateSrv");
            }
        ...
        public Builder standard(String standard) {
            if (standard == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterConnectionStrings", "standard");
            }
        ...
        public Builder standardSrv(String standardSrv) {
            if (standardSrv == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterConnectionStrings", "standardSrv");
            }
            this.standardSrv = standardSrv;
            return this;
        }
        public GetAdvancedClusterConnectionStrings build() {
            final var _resultValue = new GetAdvancedClusterConnectionStrings();
