...
import com.pulumi.mongodbatlas.outputs.GetTeamUserRole;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetTeamUser {
    /**
    ...
    /**
     * @return String enum that indicates whether the MongoDB Cloud user has a pending invitation to join the organization or are already active in the organization.
     * 
     */
     ...
     * 
     */
    private List<GetTeamUserRole> roles;
    /**
     ...
     * 
     */
    public List<GetTeamUserRole> roles() {
        return this.roles;
    }
    /**
     * @return List of unique 24-hexadecimal digit strings that identifies the teams to which this MongoDB Cloud user belongs.
    ...
    public static Builder builder(GetTeamUser defaults) {
    ...
    public static final class Builder {
        ...
        private String username;
        public Builder() {}
        public Builder(GetTeamUser defaults) {
        ...
        public Builder country(String country) {
            if (country == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "country");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "createdAt");
            }
        ...
        public Builder firstName(String firstName) {
            if (firstName == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "firstName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder invitationCreatedAt(String invitationCreatedAt) {
            if (invitationCreatedAt == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "invitationCreatedAt");
            }
        ...
        public Builder invitationExpiresAt(String invitationExpiresAt) {
            if (invitationExpiresAt == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "invitationExpiresAt");
            }
        ...
        public Builder inviterUsername(String inviterUsername) {
            if (inviterUsername == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "inviterUsername");
            }
        ...
        public Builder lastAuth(String lastAuth) {
            if (lastAuth == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "lastAuth");
            }
        ...
        public Builder lastName(String lastName) {
            if (lastName == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "lastName");
            }
        ...
        public Builder mobileNumber(String mobileNumber) {
            if (mobileNumber == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "mobileNumber");
            }
        ...
        public Builder orgMembershipStatus(String orgMembershipStatus) {
            if (orgMembershipStatus == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "orgMembershipStatus");
            }
            this.orgMembershipStatus = orgMembershipStatus;
            return this;
        }
        @CustomType.Setter
        public Builder roles(List<GetTeamUserRole> roles) {
            if (roles == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "roles");
            }
            this.roles = roles;
            return this;
        }
        public Builder roles(GetTeamUserRole... roles) {
            return roles(List.of(roles));
        }
        @CustomType.Setter
        public Builder teamIds(List<String> teamIds) {
            if (teamIds == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "teamIds");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetTeamUser", "username");
            }
            this.username = username;
            return this;
        }
        public GetTeamUser build() {
            final var _resultValue = new GetTeamUser();
