    ...
    public static final class Builder {
        ...
        public Builder computeEnabled(Boolean computeEnabled) {
            if (computeEnabled == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigAutoScaling", "computeEnabled");
            }
        ...
        public Builder computeMaxInstanceSize(String computeMaxInstanceSize) {
            if (computeMaxInstanceSize == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigAutoScaling", "computeMaxInstanceSize");
            }
        ...
        public Builder computeMinInstanceSize(String computeMinInstanceSize) {
            if (computeMinInstanceSize == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigAutoScaling", "computeMinInstanceSize");
            }
        ...
        public Builder computeScaleDownEnabled(Boolean computeScaleDownEnabled) {
            if (computeScaleDownEnabled == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigAutoScaling", "computeScaleDownEnabled");
            }
        ...
        public Builder diskGbEnabled(Boolean diskGbEnabled) {
            if (diskGbEnabled == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigAutoScaling", "diskGbEnabled");
            }
