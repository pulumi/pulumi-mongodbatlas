...
public final class ClusterPinnedFcvArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterPinnedFcvArgs Empty = new ClusterPinnedFcvArgs();
    ...
    private ClusterPinnedFcvArgs() {}

    private ClusterPinnedFcvArgs(ClusterPinnedFcvArgs $) {
    ...
    public static Builder builder(ClusterPinnedFcvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterPinnedFcvArgs();
        }

        public Builder(ClusterPinnedFcvArgs defaults) {
            $ = new ClusterPinnedFcvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterPinnedFcvArgs build() {
            if ($.expirationDate == null) {
                throw new MissingRequiredPropertyException("ClusterPinnedFcvArgs", "expirationDate");
            }
            return $;
        }
    }
