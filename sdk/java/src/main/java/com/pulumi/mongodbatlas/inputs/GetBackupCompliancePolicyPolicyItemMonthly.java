...
public final class GetBackupCompliancePolicyPolicyItemMonthly extends com.pulumi.resources.InvokeArgs {

    public static final GetBackupCompliancePolicyPolicyItemMonthly Empty = new GetBackupCompliancePolicyPolicyItemMonthly();
    ...
    private GetBackupCompliancePolicyPolicyItemMonthly() {}

    private GetBackupCompliancePolicyPolicyItemMonthly(GetBackupCompliancePolicyPolicyItemMonthly $) {
    ...
    public static Builder builder(GetBackupCompliancePolicyPolicyItemMonthly defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBackupCompliancePolicyPolicyItemMonthly();
        }

        public Builder(GetBackupCompliancePolicyPolicyItemMonthly defaults) {
            $ = new GetBackupCompliancePolicyPolicyItemMonthly(Objects.requireNonNull(defaults));
        }
        ...
        public GetBackupCompliancePolicyPolicyItemMonthly build() {
            if ($.frequencyInterval == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemMonthly", "frequencyInterval");
            }
            if ($.frequencyType == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemMonthly", "frequencyType");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemMonthly", "id");
            }
            if ($.retentionUnit == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemMonthly", "retentionUnit");
            }
            if ($.retentionValue == null) {
                throw new MissingRequiredPropertyException("GetBackupCompliancePolicyPolicyItemMonthly", "retentionValue");
            }
            return $;
        }
    }
