...
import com.pulumi.mongodbatlas.inputs.AdvancedClusterConnectionStringsPrivateEndpointArgs;
...
public final class AdvancedClusterConnectionStringsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AdvancedClusterConnectionStringsArgs Empty = new AdvancedClusterConnectionStringsArgs();
    ...
    private @Nullable Output<List<AdvancedClusterConnectionStringsPrivateEndpointArgs>> privateEndpoints;
     ...
     * 
     */
    public Optional<Output<List<AdvancedClusterConnectionStringsPrivateEndpointArgs>>> privateEndpoints() {
    ...
    private AdvancedClusterConnectionStringsArgs() {}

    private AdvancedClusterConnectionStringsArgs(AdvancedClusterConnectionStringsArgs $) {
    ...
    public static Builder builder(AdvancedClusterConnectionStringsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AdvancedClusterConnectionStringsArgs();
        }

        public Builder(AdvancedClusterConnectionStringsArgs defaults) {
            $ = new AdvancedClusterConnectionStringsArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param private_ [Network-peering-endpoint-aware](https://www.mongodb.com/docs/atlas/security-vpc-peering/#vpc-peering) mongodb://connection strings for each interface VPC endpoint you configured to connect to this cluster. Returned only if you created a network peering connection to this cluster.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder privateEndpoints(@Nullable Output<List<AdvancedClusterConnectionStringsPrivateEndpointArgs>> privateEndpoints) {
         ...
         * 
         */
        public Builder privateEndpoints(List<AdvancedClusterConnectionStringsPrivateEndpointArgs> privateEndpoints) {
         ...
         * 
         */
        public Builder privateEndpoints(AdvancedClusterConnectionStringsPrivateEndpointArgs... privateEndpoints) {
            return privateEndpoints(List.of(privateEndpoints));
        }

        /**
         * @param privateSrv [Network-peering-endpoint-aware](https://www.mongodb.com/docs/atlas/security-vpc-peering/#vpc-peering) mongodb+srv://connection strings for each interface VPC endpoint you configured to connect to this cluster. Returned only if you created a network peering connection to this cluster.
         * 
         * @return builder
         * 
         */
        ...
        public AdvancedClusterConnectionStringsArgs build() {
            return $;
        }
    }
