    ...
    public static final class Builder {
        ...
        public Builder frequencyInterval(Integer frequencyInterval) {
            if (frequencyInterval == null) {
              throw new MissingRequiredPropertyException("GetCloudBackupSchedulePolicyItemWeekly", "frequencyInterval");
            }
        ...
        public Builder frequencyType(String frequencyType) {
            if (frequencyType == null) {
              throw new MissingRequiredPropertyException("GetCloudBackupSchedulePolicyItemWeekly", "frequencyType");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCloudBackupSchedulePolicyItemWeekly", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder retentionUnit(String retentionUnit) {
            if (retentionUnit == null) {
              throw new MissingRequiredPropertyException("GetCloudBackupSchedulePolicyItemWeekly", "retentionUnit");
            }
        ...
        public Builder retentionValue(Integer retentionValue) {
            if (retentionValue == null) {
              throw new MissingRequiredPropertyException("GetCloudBackupSchedulePolicyItemWeekly", "retentionValue");
            }
            this.retentionValue = retentionValue;
            return this;
        }
        public GetCloudBackupSchedulePolicyItemWeekly build() {
            final var _resultValue = new GetCloudBackupSchedulePolicyItemWeekly();
