...
public final class CloudProviderSnapshotRestoreJobDeliveryTypeConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudProviderSnapshotRestoreJobDeliveryTypeConfigArgs Empty = new CloudProviderSnapshotRestoreJobDeliveryTypeConfigArgs();
    ...
    /**
     * @return Name of the target Atlas cluster to which the restore job restores the snapshot. Only required if deliveryType is automated.
     * 
     */
    ...
    /**
     * @return Unique ID of the target Atlas project for the specified targetClusterName. Only required if deliveryType is automated.
     * 
     */
    ...
    private CloudProviderSnapshotRestoreJobDeliveryTypeConfigArgs() {}

    private CloudProviderSnapshotRestoreJobDeliveryTypeConfigArgs(CloudProviderSnapshotRestoreJobDeliveryTypeConfigArgs $) {
    ...
    public static Builder builder(CloudProviderSnapshotRestoreJobDeliveryTypeConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudProviderSnapshotRestoreJobDeliveryTypeConfigArgs();
        }

        public Builder(CloudProviderSnapshotRestoreJobDeliveryTypeConfigArgs defaults) {
            $ = new CloudProviderSnapshotRestoreJobDeliveryTypeConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param targetClusterName Name of the target Atlas cluster to which the restore job restores the snapshot. Only required if deliveryType is automated.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param targetProjectId Unique ID of the target Atlas project for the specified targetClusterName. Only required if deliveryType is automated.
         * 
         * @return builder
         * 
         */
        ...
        public CloudProviderSnapshotRestoreJobDeliveryTypeConfigArgs build() {
            return $;
        }
    }
