...
public final class CloudBackupSchedulePolicyItemYearlyArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudBackupSchedulePolicyItemYearlyArgs Empty = new CloudBackupSchedulePolicyItemYearlyArgs();
    ...
    private CloudBackupSchedulePolicyItemYearlyArgs() {}

    private CloudBackupSchedulePolicyItemYearlyArgs(CloudBackupSchedulePolicyItemYearlyArgs $) {
    ...
    public static Builder builder(CloudBackupSchedulePolicyItemYearlyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudBackupSchedulePolicyItemYearlyArgs();
        }

        public Builder(CloudBackupSchedulePolicyItemYearlyArgs defaults) {
            $ = new CloudBackupSchedulePolicyItemYearlyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CloudBackupSchedulePolicyItemYearlyArgs build() {
            if ($.frequencyInterval == null) {
                throw new MissingRequiredPropertyException("CloudBackupSchedulePolicyItemYearlyArgs", "frequencyInterval");
            }
            if ($.retentionUnit == null) {
                throw new MissingRequiredPropertyException("CloudBackupSchedulePolicyItemYearlyArgs", "retentionUnit");
            }
            if ($.retentionValue == null) {
                throw new MissingRequiredPropertyException("CloudBackupSchedulePolicyItemYearlyArgs", "retentionValue");
            }
            return $;
        }
    }
