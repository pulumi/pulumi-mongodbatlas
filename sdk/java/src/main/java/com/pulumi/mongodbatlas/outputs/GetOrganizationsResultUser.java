...
import com.pulumi.mongodbatlas.outputs.GetOrganizationsResultUserRole;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetOrganizationsResultUser {
    /**
    ...
    private GetOrganizationsResultUser() {}
    /**
     * @return Two-character alphabetical string that identifies the MongoDB Cloud user&#39;s geographic location. This parameter uses the ISO 3166-1a2 code format.
     * 
     */
    ...
    public static Builder builder(GetOrganizationsResultUser defaults) {
    ...
    public static final class Builder {
        ...
        private String username;
        public Builder() {}
        public Builder(GetOrganizationsResultUser defaults) {
        ...
        public Builder country(String country) {
            if (country == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "country");
            }
        ...
        public Builder createdAt(String createdAt) {
            if (createdAt == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "createdAt");
            }
        ...
        public Builder firstName(String firstName) {
            if (firstName == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "firstName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder invitationCreatedAt(String invitationCreatedAt) {
            if (invitationCreatedAt == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "invitationCreatedAt");
            }
        ...
        public Builder invitationExpiresAt(String invitationExpiresAt) {
            if (invitationExpiresAt == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "invitationExpiresAt");
            }
        ...
        public Builder inviterUsername(String inviterUsername) {
            if (inviterUsername == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "inviterUsername");
            }
        ...
        public Builder lastAuth(String lastAuth) {
            if (lastAuth == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "lastAuth");
            }
        ...
        public Builder lastName(String lastName) {
            if (lastName == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "lastName");
            }
        ...
        public Builder mobileNumber(String mobileNumber) {
            if (mobileNumber == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "mobileNumber");
            }
        ...
        public Builder orgMembershipStatus(String orgMembershipStatus) {
            if (orgMembershipStatus == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "orgMembershipStatus");
            }
            this.orgMembershipStatus = orgMembershipStatus;
            return this;
        }
        @CustomType.Setter
        public Builder roles(List<GetOrganizationsResultUserRole> roles) {
            if (roles == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "roles");
            }
            this.roles = roles;
            return this;
        }
        public Builder roles(GetOrganizationsResultUserRole... roles) {
            return roles(List.of(roles));
        }
        @CustomType.Setter
        public Builder teamIds(List<String> teamIds) {
            if (teamIds == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "teamIds");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetOrganizationsResultUser", "username");
            }
            this.username = username;
            return this;
        }
        public GetOrganizationsResultUser build() {
            final var _resultValue = new GetOrganizationsResultUser();
