...
@CustomType
public final class GetProjectApiKey {
    ...
    public static Builder builder(GetProjectApiKey defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> roleNames;
        public Builder() {}
        public Builder(GetProjectApiKey defaults) {
        ...
        public GetProjectApiKey build() {
            final var o = new GetProjectApiKey();
            o.apiKeyId = apiKeyId;
