...
@CustomType
public final class GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs {
    /**
    ...
    private GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs() {}
    /**
     * @return Target IOPS (Input/Output Operations Per Second) desired for storage attached to this hardware. See the resource documentation for `electableSpecs` for additional `diskIops` configuration details.
     * 
     */
    ...
    public static Builder builder(GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs defaults) {
    ...
    public static final class Builder {
        ...
        private Integer nodeCount;
        public Builder() {}
        public Builder(GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs defaults) {
        ...
        public Builder diskIops(Integer diskIops) {
            if (diskIops == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs", "diskIops");
            }
        ...
        public Builder diskSizeGb(Double diskSizeGb) {
            if (diskSizeGb == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs", "diskSizeGb");
            }
        ...
        public Builder diskThroughput(Integer diskThroughput) {
            if (diskThroughput == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs", "diskThroughput");
            }
        ...
        public Builder ebsVolumeType(String ebsVolumeType) {
            if (ebsVolumeType == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs", "ebsVolumeType");
            }
        ...
        public Builder instanceSize(String instanceSize) {
            if (instanceSize == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs", "instanceSize");
            }
        ...
        public Builder nodeCount(Integer nodeCount) {
            if (nodeCount == null) {
              throw new MissingRequiredPropertyException("GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs", "nodeCount");
            }
            this.nodeCount = nodeCount;
            return this;
        }
        public GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs build() {
            final var _resultValue = new GetAdvancedClusterReplicationSpecRegionConfigEffectiveReadOnlySpecs();
