...
def get_data_lake_pipeline_run(pipeline_name: Optional[_builtins.str] = None,
...
def get_data_lake_pipeline_run_output(pipeline_name: Optional[pulumi.Input[_builtins.str]] = None,
