...
def get_api_key_project_assignment(api_key_id: Optional[builtins.str] = None,
...
def get_api_key_project_assignment_output(api_key_id: Optional[pulumi.Input[builtins.str]] = None,
