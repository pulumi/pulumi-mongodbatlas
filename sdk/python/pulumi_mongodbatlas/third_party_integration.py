...
class ThirdPartyIntegrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_id: The unique ID for the project to get all Third-Party service integrations
        :param pulumi.Input[builtins.str] type: Third-Party Integration Settings type 
               * PAGER_DUTY
               * DATADOG
               * OPS_GENIE
               * VICTOR_OPS
    ...
    def service_discovery(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ThirdPartyIntegration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ThirdPartyIntegration':
        """
    ...
    @property
    @pulumi.getter(name="microsoftTeamsWebhookUrl")
    def microsoft_teams_webhook_url(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "microsoft_teams_webhook_url")
    ...
    @property
    @pulumi.getter(name="serviceDiscovery")
    def service_discovery(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "service_discovery")
