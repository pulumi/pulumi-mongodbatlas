...
class PushBasedLogExportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket_name: The name of the bucket to which the agent sends the logs to.
        :param pulumi.Input[builtins.str] iam_role_id: ID of the AWS IAM role that is used to write to the S3 bucket.
        ...
        :param pulumi.Input[builtins.str] prefix_path: S3 directory in which vector writes in order to store the logs. An empty string denotes the root directory.
        """
...
class _PushBasedLogExportState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket_name: The name of the bucket to which the agent sends the logs to.
        :param pulumi.Input[builtins.str] create_date: Date and time that this feature was enabled on.
        :param pulumi.Input[builtins.str] iam_role_id: ID of the AWS IAM role that is used to write to the S3 bucket.
        :param pulumi.Input[builtins.str] prefix_path: S3 directory in which vector writes in order to store the logs. An empty string denotes the root directory.
        :param pulumi.Input[builtins.str] project_id: Unique 24-hexadecimal digit string that identifies your project. Use the /groups endpoint to retrieve all projects to which the authenticated user has access.
        :param pulumi.Input[builtins.str] state: Describes whether or not the feature is enabled and what status it is in.
        """
...
class PushBasedLogExport(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="prefixPath")
    def prefix_path(self) -> pulumi.Output[builtins.str]:
        """
        S3 directory in which vector writes in order to store the logs. An empty string denotes the root directory.
        """
        return pulumi.get(self, "prefix_path")
