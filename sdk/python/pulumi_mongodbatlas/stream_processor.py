...
class StreamProcessorArgs:
    def __init__(__self__, *,
                 ...
                 processor_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] instance_name: Human-readable label that identifies the stream instance.
        :param pulumi.Input[builtins.str] pipeline: Stream aggregation pipeline you want to apply to your streaming data. [MongoDB Atlas Docs](https://www.mongodb.com/docs/atlas/atlas-stream-processing/stream-aggregation/#std-label-stream-aggregation) contain more information. Using jsonencode is recommended when setting this attribute. For more details see the [Aggregation Pipelines Documentation](https://www.mongodb.com/docs/atlas/atlas-stream-processing/stream-aggregation/)
        :param pulumi.Input[builtins.str] processor_name: Human-readable label that identifies the stream processor.
        ...
        :param pulumi.Input[builtins.str] state: The state of the stream processor. Commonly occurring states are 'CREATED', 'STARTED', 'STOPPED' and 'FAILED'. Used to
    ...
    def processor_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def processor_name(self, value: pulumi.Input[builtins.str]):
...
class _StreamProcessorState:
    def __init__(__self__, *,
                 ...
                 processor_name: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 stats: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] state: The state of the stream processor. Commonly occurring states are 'CREATED', 'STARTED', 'STOPPED' and 'FAILED'. Used to
               ...
               specifying the state, it will default to the Previous state. **NOTE** When a Stream Processor is updated without
               specifying the state, it is stopped and then restored to previous state upon update completion.
        :param pulumi.Input[builtins.str] stats: The stats associated with the stream processor. Refer to the [MongoDB Atlas
    ...
    @property
    @pulumi.getter(name="processorName")
    def processor_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Human-readable label that identifies the stream processor.
        """
        return pulumi.get(self, "processor_name")
    ...
    @processor_name.setter
    def processor_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "processor_name", value)
    ...
    @property
    @pulumi.getter
    def stats(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @stats.setter
    def stats(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StreamProcessor(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            stats: Optional[pulumi.Input[builtins.str]] = None) -> 'StreamProcessor':
        """
    ...
    @property
    @pulumi.getter(name="processorName")
    def processor_name(self) -> pulumi.Output[builtins.str]:
        """
        Human-readable label that identifies the stream processor.
        """
        return pulumi.get(self, "processor_name")
    ...
    @property
    @pulumi.getter
    def stats(self) -> pulumi.Output[builtins.str]:
        """
        The stats associated with the stream processor. Refer to the [MongoDB Atlas
        Docs](https://www.mongodb.com/docs/atlas/atlas-stream-processing/manage-stream-processor/#view-statistics-of-a-stream-processor)
        for more information.
