...
class ProjectInvitationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_id: Unique 24-hexadecimal digit string that identifies the project to which you want to invite a user.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: List of Atlas roles to assign to the invited user. If the user accepts the invitation, Atlas assigns these roles to them. Refer to the [MongoDB Documentation](https://www.mongodb.com/docs/atlas/reference/user-roles/#project-roles) for information on valid roles.
        :param pulumi.Input[builtins.str] username: Email address to which Atlas sent the invitation. The user uses this email address as their Atlas username if they accept this invitation.
        """
...
class _ProjectInvitationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] inviter_username: Atlas user who invited `username` to the project.
        :param pulumi.Input[builtins.str] project_id: Unique 24-hexadecimal digit string that identifies the project to which you want to invite a user.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: List of Atlas roles to assign to the invited user. If the user accepts the invitation, Atlas assigns these roles to them. Refer to the [MongoDB Documentation](https://www.mongodb.com/docs/atlas/reference/user-roles/#project-roles) for information on valid roles.
        :param pulumi.Input[builtins.str] username: Email address to which Atlas sent the invitation. The user uses this email address as their Atlas username if they accept this invitation.
        """
...
class ProjectInvitation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectInvitation':
        """
