...
class DataLakePipelineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the Atlas Data Lake Pipeline.
...
class _DataLakePipelineState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] created_date: Timestamp that indicates when the Data Lake Pipeline was created.
        ...
        :param pulumi.Input[_builtins.str] last_updated_date: Timestamp that indicates the last time that the Data Lake Pipeline was updated.
        :param pulumi.Input[_builtins.str] name: Name of the Atlas Data Lake Pipeline.
        :param pulumi.Input[_builtins.str] project_id: The unique ID for the project to create a data lake pipeline.
        ...
        :param pulumi.Input[_builtins.str] state: State of this Data Lake Pipeline.
        :param pulumi.Input[Sequence[pulumi.Input['DataLakePipelineTransformationArgs']]] transformations: Fields to be excluded for this Data Lake Pipeline.
               * `transformations.#.field` - Key in the document.
               * `transformations.#.type` - Type of transformation applied during the export of the namespace in a Data Lake Pipeline.
        """
