...
def get_api_keys(items_per_page: Optional[builtins.int] = None,
    ...
    :param builtins.str org_id: Unique identifier for the organization whose API keys you want to retrieve.
...
def get_api_keys_output(items_per_page: Optional[pulumi.Input[Optional[builtins.int]]] = None,
