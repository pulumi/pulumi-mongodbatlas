...
def get_federated_query_limits(project_id: Optional[builtins.str] = None,
...
def get_federated_query_limits_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
