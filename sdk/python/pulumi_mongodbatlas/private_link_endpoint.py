...
class PrivateLinkEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_id: Required 	Unique identifier for the project.
        :param pulumi.Input[builtins.str] provider_name: Name of the cloud provider for which you want to create the private endpoint service. Atlas accepts `AWS`, `AZURE` or `GCP`.
        :param pulumi.Input[builtins.str] region: Cloud provider region in which you want to create the private endpoint connection.
...
class _PrivateLinkEndpointState:
    def __init__(__self__, *,
                 endpoint_group_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 endpoint_service_name: Optional[pulumi.Input[builtins.str]] = None,
                 error_message: Optional[pulumi.Input[builtins.str]] = None,
                 interface_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 private_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 private_link_id: Optional[pulumi.Input[builtins.str]] = None,
                 private_link_service_name: Optional[pulumi.Input[builtins.str]] = None,
                 private_link_service_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 service_attachment_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering PrivateLinkEndpoint resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] endpoint_group_names: GCP network endpoint groups corresponding to the Private Service Connect endpoint service.
        :param pulumi.Input[builtins.str] endpoint_service_name: Name of the PrivateLink endpoint service in AWS. Returns null while the endpoint service is being created.
        :param pulumi.Input[builtins.str] error_message: Error message pertaining to the AWS PrivateLink connection. Returns null if there are no errors.
               AWS:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] interface_endpoints: Unique identifiers of the interface endpoints in your VPC that you added to the AWS PrivateLink connection.
               AZURE:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_endpoints: All private endpoints that you have added to this Azure Private Link Service.
        :param pulumi.Input[builtins.str] private_link_id: Unique identifier of the AWS PrivateLink connection.
        :param pulumi.Input[builtins.str] private_link_service_name: Name of the Azure Private Link Service that Atlas manages.
               GCP:
        :param pulumi.Input[builtins.str] project_id: Required 	Unique identifier for the project.
        :param pulumi.Input[builtins.str] provider_name: Name of the cloud provider for which you want to create the private endpoint service. Atlas accepts `AWS`, `AZURE` or `GCP`.
        :param pulumi.Input[builtins.str] region: Cloud provider region in which you want to create the private endpoint connection.
               Accepted values are: [AWS regions](https://docs.atlas.mongodb.com/reference/amazon-aws/#amazon-aws), [AZURE regions](https://docs.atlas.mongodb.com/reference/microsoft-azure/#microsoft-azure) and [GCP regions](https://docs.atlas.mongodb.com/reference/google-gcp/#std-label-google-gcp)
        :param pulumi.Input[builtins.str] region_name: GCP region for the Private Service Connect endpoint service.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_attachment_names: Unique alphanumeric and special character strings that identify the service attachments associated with the GCP Private Service Connect endpoint service. Returns an empty list while Atlas creates the service attachments.
        :param pulumi.Input[builtins.str] status: Status of the AWS PrivateLink connection or Status of the Azure Private Link Service. Atlas returns one of the following values:
               AWS:
    ...
    def endpoint_group_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def endpoint_group_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def interface_endpoints(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def interface_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "interface_endpoints", value)

    @property
    @pulumi.getter(name="privateEndpoints")
    def private_endpoints(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def private_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def private_link_service_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_link_service_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "private_link_service_name", value)

    @property
    @pulumi.getter(name="privateLinkServiceResourceId")
    def private_link_service_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "private_link_service_resource_id")

    @private_link_service_resource_id.setter
    def private_link_service_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def service_attachment_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def service_attachment_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class PrivateLinkEndpoint(pulumi.CustomResource):
    ...
    pulumi_type = "mongodbatlas:index/privateLinkEndpoint:PrivateLinkEndpoint"
    ...
    def get(resource_name: str,
            ...
            region_name: Optional[pulumi.Input[builtins.str]] = None,
            service_attachment_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateLinkEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="endpointGroupNames")
    def endpoint_group_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        GCP network endpoint groups corresponding to the Private Service Connect endpoint service.
        """
        return pulumi.get(self, "endpoint_group_names")
    ...
    @property
    @pulumi.getter(name="interfaceEndpoints")
    def interface_endpoints(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Unique identifiers of the interface endpoints in your VPC that you added to the AWS PrivateLink connection.
        AZURE:
        """
    ...
    @property
    @pulumi.getter(name="privateEndpoints")
    def private_endpoints(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        All private endpoints that you have added to this Azure Private Link Service.
        """
        return pulumi.get(self, "private_endpoints")
    ...
    @property
    @pulumi.getter(name="privateLinkId")
    def private_link_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier of the AWS PrivateLink connection.
        """
        return pulumi.get(self, "private_link_id")
    ...
    @property
    @pulumi.getter(name="privateLinkServiceName")
    def private_link_service_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the Azure Private Link Service that Atlas manages.
        GCP:
        """
    ...
    @property
    @pulumi.getter(name="privateLinkServiceResourceId")
    def private_link_service_resource_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "private_link_service_resource_id")
    ...
    @property
    @pulumi.getter(name="serviceAttachmentNames")
    def service_attachment_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Unique alphanumeric and special character strings that identify the service attachments associated with the GCP Private Service Connect endpoint service. Returns an empty list while Atlas creates the service attachments.
        """
        return pulumi.get(self, "service_attachment_names")
