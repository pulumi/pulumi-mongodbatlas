...
class AuditingArgs:
    def __init__(__self__, *,
                 ...
                 audit_authorization_success: Optional[pulumi.Input[builtins.bool]] = None,
                 audit_filter: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Auditing resource.
        :param pulumi.Input[builtins.str] project_id: The unique ID for the project to configure auditing. **Note: When changing this value to a different project_id it will delete the current audit settings for the original project that was assigned to.**
        :param pulumi.Input[builtins.bool] audit_authorization_success: Indicates whether the auditing system captures successful authentication attempts for audit filters using the "atype" : "authCheck" auditing event. For more information, see [auditAuthorizationSuccess](https://docs.mongodb.com/manual/reference/parameters/#param.auditAuthorizationSuccess).  **Warning! Enabling Audit authorization successes can severely impact cluster performance. Enable this option with caution.**
        :param pulumi.Input[builtins.str] audit_filter: JSON-formatted audit filter. For complete documentation on custom auditing filters, see [Configure Audit Filters](https://docs.mongodb.com/manual/tutorial/configure-audit-filters/).
        :param pulumi.Input[builtins.bool] enabled: Denotes whether or not the project associated with the {project_id} has database auditing enabled.  Defaults to false.
    ...
    def audit_authorization_success(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether the auditing system captures successful authentication attempts for audit filters using the "atype" : "authCheck" auditing event. For more information, see [auditAuthorizationSuccess](https://docs.mongodb.com/manual/reference/parameters/#param.auditAuthorizationSuccess).  **Warning! Enabling Audit authorization successes can severely impact cluster performance. Enable this option with caution.**
        """
    ...
    def audit_authorization_success(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "audit_authorization_success", value)

    @property
    @pulumi.getter(name="auditFilter")
    def audit_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @audit_filter.setter
    def audit_filter(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AuditingState:
    def __init__(__self__, *,
                 audit_authorization_success: Optional[pulumi.Input[builtins.bool]] = None,
                 audit_filter: Optional[pulumi.Input[builtins.str]] = None,
                 configuration_type: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] audit_authorization_success: Indicates whether the auditing system captures successful authentication attempts for audit filters using the "atype" : "authCheck" auditing event. For more information, see [auditAuthorizationSuccess](https://docs.mongodb.com/manual/reference/parameters/#param.auditAuthorizationSuccess).  **Warning! Enabling Audit authorization successes can severely impact cluster performance. Enable this option with caution.**
        :param pulumi.Input[builtins.str] audit_filter: JSON-formatted audit filter. For complete documentation on custom auditing filters, see [Configure Audit Filters](https://docs.mongodb.com/manual/tutorial/configure-audit-filters/).
        :param pulumi.Input[builtins.str] configuration_type: Denotes the configuration method for the audit filter. Possible values are: 
    ...
    def configuration_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def configuration_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Auditing(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            configuration_type: Optional[pulumi.Input[builtins.str]] = None,
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Auditing':
        """
    ...
    @property
    @pulumi.getter(name="auditAuthorizationSuccess")
    def audit_authorization_success(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the auditing system captures successful authentication attempts for audit filters using the "atype" : "authCheck" auditing event. For more information, see [auditAuthorizationSuccess](https://docs.mongodb.com/manual/reference/parameters/#param.auditAuthorizationSuccess).  **Warning! Enabling Audit authorization successes can severely impact cluster performance. Enable this option with caution.**
        """
        return pulumi.get(self, "audit_authorization_success")
    ...
    @property
    @pulumi.getter(name="auditFilter")
    def audit_filter(self) -> pulumi.Output[builtins.str]:
        """
        JSON-formatted audit filter. For complete documentation on custom auditing filters, see [Configure Audit Filters](https://docs.mongodb.com/manual/tutorial/configure-audit-filters/).
        """
        return pulumi.get(self, "audit_filter")
