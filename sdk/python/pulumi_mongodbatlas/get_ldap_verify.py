...
def get_ldap_verify(project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: Unique identifier for the Atlas project associated with the verification request.
    :param builtins.str request_id: Unique identifier of a request to verify an LDAP configuration.
    """
    __args__ = dict()
...
def get_ldap_verify_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
