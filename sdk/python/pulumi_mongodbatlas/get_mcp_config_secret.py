...
__all__ = [
    'GetMcpConfigSecretResult',
    'AwaitableGetMcpConfigSecretResult',
    'get_mcp_config_secret',
    'get_mcp_config_secret_output',
]

@pulumi.output_type
class GetMcpConfigSecretResult:
    """
    A collection of values returned by getMcpConfigSecret.
    """
    def __init__(__self__, created_at=None, expires_at=None, last_used_at=None, masked_secret_value=None, mcp_config_id=None, org_id=None, secret_id=None):
...
class AwaitableGetMcpConfigSecretResult(GetMcpConfigSecretResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMcpConfigSecretResult(
...
def get_mcp_config_secret(mcp_config_id: Optional[_builtins.str] = None,
                          org_id: Optional[_builtins.str] = None,
                          secret_id: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMcpConfigSecretResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('mongodbatlas:index/getMcpConfigSecret:getMcpConfigSecret', __args__, opts=opts, typ=GetMcpConfigSecretResult).value

    return AwaitableGetMcpConfigSecretResult(
...
def get_mcp_config_secret_output(mcp_config_id: pulumi.Input[Optional[_builtins.str]] = None,
                                 org_id: pulumi.Input[Optional[_builtins.str]] = None,
                                 secret_id: pulumi.Input[Optional[_builtins.str]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetMcpConfigSecretResult]:
    """
    `McpConfigSecret` describes an ingress secret for an Organization Remote MCP Configuration. Secret values are never returned. Only masked metadata is available.
    ...
    __ret__ = pulumi.runtime.invoke_output('mongodbatlas:index/getMcpConfigSecret:getMcpConfigSecret', __args__, opts=opts, typ=GetMcpConfigSecretResult)
    return __ret__.apply(lambda __response__: GetMcpConfigSecretResult(
