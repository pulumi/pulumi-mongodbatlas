...
__all__ = [
    ...
    'AwaitableGetStreamWorkspacesResult',
    'get_stream_workspaces',
    'get_stream_workspaces_output',
]

@pulumi.output_type
class GetStreamWorkspacesResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetStreamWorkspacesResultResult']:
        """
...
class AwaitableGetStreamWorkspacesResult(GetStreamWorkspacesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetStreamWorkspacesResult(
            id=self.id,
...
def get_stream_workspaces(items_per_page: Optional[_builtins.int] = None,
                          page_num: Optional[_builtins.int] = None,
                          project_id: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStreamWorkspacesResult:
    """
    `get_stream_workspaces` describes the stream workspaces defined in a project.

    > **NOTE:** Use this data source for new configurations instead of `get_stream_instances`.
    ...
    If you're migrating from the deprecated `get_stream_instances` data source, see the Migration Guide: Stream Instance to Stream Workspace for step-by-step instructions and examples.
    ...
    __ret__ = pulumi.runtime.invoke('mongodbatlas:index/getStreamWorkspaces:getStreamWorkspaces', __args__, opts=opts, typ=GetStreamWorkspacesResult).value

    return AwaitableGetStreamWorkspacesResult(
...
def get_stream_workspaces_output(items_per_page: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                 page_num: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                 project_id: Optional[pulumi.Input[_builtins.str]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetStreamWorkspacesResult]:
    """
    `get_stream_workspaces` describes the stream workspaces defined in a project.
    ...
    __ret__ = pulumi.runtime.invoke_output('mongodbatlas:index/getStreamWorkspaces:getStreamWorkspaces', __args__, opts=opts, typ=GetStreamWorkspacesResult)
    return __ret__.apply(lambda __response__: GetStreamWorkspacesResult(
