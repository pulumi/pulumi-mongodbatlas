...
def get_shared_tier_restore_job(cluster_name: Optional[builtins.str] = None,
...
def get_shared_tier_restore_job_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
