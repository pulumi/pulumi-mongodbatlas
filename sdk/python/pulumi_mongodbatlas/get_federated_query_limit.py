...
class GetFederatedQueryLimitResult:
    ...
    def current_usage(self) -> builtins.int:
        """
    ...
    def default_limit(self) -> builtins.int:
        """
    ...
    def maximum_limit(self) -> builtins.int:
...
def get_federated_query_limit(limit_name: Optional[builtins.str] = None,
    ...
    :param builtins.str limit_name: String enum that indicates whether the identity provider is active or not. Accepted values are:
    ...
    :param builtins.str tenant_name: Name of the Atlas Federated Database Instance.
    """
    __args__ = dict()
...
def get_federated_query_limit_output(limit_name: Optional[pulumi.Input[builtins.str]] = None,
