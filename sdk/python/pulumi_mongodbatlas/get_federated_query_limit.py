...
def get_federated_query_limit(limit_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str limit_name: String enum that indicates whether the identity provider is active or not. Accepted values are:
