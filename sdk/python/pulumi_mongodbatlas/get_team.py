...
def get_team(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The team name.
           
           > **IMPORTANT:** Either `team_id` or `name` must be configured.
    :param builtins.str org_id: The unique identifier for the organization you want to associate the team with.
    :param builtins.str team_id: The unique identifier for the team.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_team_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
