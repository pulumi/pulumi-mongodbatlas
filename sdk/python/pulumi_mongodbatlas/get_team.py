...
def get_team(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The team name.
           
           > **IMPORTANT:** Either `team_id` or `name` must be configured.
    :param _builtins.str org_id: The unique identifier for the organization you want to associate the team with.
    :param _builtins.str team_id: The unique identifier for the team.
    """
    __args__ = dict()
    __args__['name'] = name
