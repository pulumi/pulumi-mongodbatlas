...
def get_cloud_backup_snapshot_restore_jobs(cluster_name: Optional[str] = None,
    ...
    """
    _get_cloud_backup_snapshot_restore_jobs_ provides a Cloud Backup Snapshot Restore Jobs datasource. Gets all the cloud backup snapshot restore jobs for the specified cluster.
...
def get_cloud_backup_snapshot_restore_jobs_output(cluster_name: Optional[pulumi.Input[str]] = None,
                                                  ...
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCloudBackupSnapshotRestoreJobsResult]:
    """
    _get_cloud_backup_snapshot_restore_jobs_ provides a Cloud Backup Snapshot Restore Jobs datasource. Gets all the cloud backup snapshot restore jobs for the specified cluster.
