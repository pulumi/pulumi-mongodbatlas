...
def get_cloud_backup_snapshot_restore_jobs(cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_name: The name of the Atlas cluster for which you want to retrieve restore jobs.
...
def get_cloud_backup_snapshot_restore_jobs_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
