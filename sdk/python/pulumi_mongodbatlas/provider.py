...
class Provider(pulumi.ProviderResource):
    def __init__(__self__, resource_name, opts=None, private_key=None, public_key=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            if private_key is None:
                private_key = utilities.get_env('MONGODB_ATLAS_PRIVATE_KEY')
            __props__['private_key'] = private_key
            if public_key is None:
                public_key = utilities.get_env('MONGODB_ATLAS_PUBLIC_KEY')
