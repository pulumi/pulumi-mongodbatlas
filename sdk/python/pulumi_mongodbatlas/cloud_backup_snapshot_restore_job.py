...
class CloudBackupSnapshotRestoreJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CloudBackupSnapshotRestoreJobDeliveryTypeConfigArgs'] delivery_type_config: Type of restore job to create. Possible values are: **download** or **automated**, only one must be set it in ``true``.
        """
...
class CloudBackupSnapshotRestoreJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * **pointInTime:**  Atlas performs a Continuous Cloud Backup restore.
        ...
        :param pulumi.Input[str] cluster_name: The name of the Atlas cluster whose snapshot you want to restore.
        :param pulumi.Input[pulumi.InputType['CloudBackupSnapshotRestoreJobDeliveryTypeConfigArgs']] delivery_type_config: Type of restore job to create. Possible values are: **download** or **automated**, only one must be set it in ``true``.
        :param pulumi.Input[str] project_id: The unique identifier of the project for the Atlas cluster whose snapshot you want to restore.
        :param pulumi.Input[str] snapshot_id: Unique identifier of the snapshot to restore.
        """
        ...
