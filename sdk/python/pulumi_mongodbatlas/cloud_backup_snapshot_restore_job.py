...
class CloudBackupSnapshotRestoreJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_name: The name of the Atlas cluster whose snapshot you want to restore.
        :param pulumi.Input[builtins.str] project_id: The unique identifier of the project for the Atlas cluster whose snapshot you want to restore.
        ...
        :param pulumi.Input[builtins.str] snapshot_id: Optional setting for **pointInTime** configuration. Unique identifier of the snapshot to restore.
        """
...
class _CloudBackupSnapshotRestoreJobState:
    def __init__(__self__, *,
                 cancelled: Optional[pulumi.Input[builtins.bool]] = None,
                 cluster_name: Optional[pulumi.Input[builtins.str]] = None,
                 delivery_type_config: Optional[pulumi.Input['CloudBackupSnapshotRestoreJobDeliveryTypeConfigArgs']] = None,
                 delivery_urls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 expired: Optional[pulumi.Input[builtins.bool]] = None,
                 expires_at: Optional[pulumi.Input[builtins.str]] = None,
                 failed: Optional[pulumi.Input[builtins.bool]] = None,
                 finished_at: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 snapshot_id: Optional[pulumi.Input[builtins.str]] = None,
                 snapshot_restore_job_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] cancelled: Indicates whether the restore job was canceled.
        :param pulumi.Input[builtins.str] cluster_name: The name of the Atlas cluster whose snapshot you want to restore.
        :param pulumi.Input['CloudBackupSnapshotRestoreJobDeliveryTypeConfigArgs'] delivery_type_config: Type of restore job to create. Possible configurations are: **download**, **automated**, or **pointInTime** only one must be set it in ``true``.
               * `delivery_type_config.automated` - Set to `true` to use the automated configuration.
               * `delivery_type_config.download` - Set to `true` to use the download configuration.
               ...
               * `delivery_type_config.oplog_inc` - Optional setting for **pointInTime** configuration. Oplog operation number from which to you want to restore this snapshot. This is the second part of an Oplog timestamp. Used in conjunction with `oplog_ts`.
               * `delivery_type_config.point_in_time_utc_seconds` - Optional setting for **pointInTime** configuration. Timestamp in the number of seconds that have elapsed since the UNIX epoch from which you want to restore this snapshot. Used instead of oplog settings.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] delivery_urls: One or more URLs for the compressed snapshot files for manual download. Only visible if deliveryType is download.
        :param pulumi.Input[builtins.bool] expired: Indicates whether the restore job expired.
        :param pulumi.Input[builtins.str] expires_at: UTC ISO 8601 formatted point in time when the restore job expires.
        :param pulumi.Input[builtins.bool] failed: Indicates whether the restore job failed.
        :param pulumi.Input[builtins.str] finished_at: UTC ISO 8601 formatted point in time when the restore job completed.
        :param pulumi.Input[builtins.str] project_id: The unique identifier of the project for the Atlas cluster whose snapshot you want to restore.
        :param pulumi.Input[builtins.str] snapshot_id: Optional setting for **pointInTime** configuration. Unique identifier of the snapshot to restore.
        :param pulumi.Input[builtins.str] snapshot_restore_job_id: The unique identifier of the restore job.
        :param pulumi.Input[builtins.str] timestamp: Timestamp in ISO 8601 date and time format in UTC when the snapshot associated to snapshotId was taken.
    ...
    @property
    @pulumi.getter
    def cancelled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @cancelled.setter
    def cancelled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def delivery_urls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def delivery_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter
    def failed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @failed.setter
    def failed(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def snapshot_restore_job_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def snapshot_restore_job_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CloudBackupSnapshotRestoreJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snapshot_id: Optional[pulumi.Input[builtins.str]] = None,
            snapshot_restore_job_id: Optional[pulumi.Input[builtins.str]] = None,
            timestamp: Optional[pulumi.Input[builtins.str]] = None) -> 'CloudBackupSnapshotRestoreJob':
        """
    ...
    @property
    @pulumi.getter
    def cancelled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the restore job was canceled.
        """
        return pulumi.get(self, "cancelled")
    ...
    @property
    @pulumi.getter(name="deliveryUrls")
    def delivery_urls(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        One or more URLs for the compressed snapshot files for manual download. Only visible if deliveryType is download.
        """
        return pulumi.get(self, "delivery_urls")
    ...
    @property
    @pulumi.getter
    def failed(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the restore job failed.
        """
        return pulumi.get(self, "failed")
    ...
    @property
    @pulumi.getter(name="snapshotRestoreJobId")
    def snapshot_restore_job_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier of the restore job.
        """
        return pulumi.get(self, "snapshot_restore_job_id")
    ...
    @property
    @pulumi.getter
    def timestamp(self) -> pulumi.Output[builtins.str]:
        """
        Timestamp in ISO 8601 date and time format in UTC when the snapshot associated to snapshotId was taken.
        * `oplogTs` - Timestamp in the number of seconds that have elapsed since the UNIX epoch from which to you want to restore this snapshot.
        Three conditions apply to this parameter:
