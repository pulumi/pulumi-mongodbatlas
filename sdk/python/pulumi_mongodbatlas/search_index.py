...
class SearchIndexArgs:
    def __init__(__self__, *,
                 ...
                 analyzers: Optional[pulumi.Input[builtins.str]] = None,
                 fields: Optional[pulumi.Input[builtins.str]] = None,
                 mappings_dynamic: Optional[pulumi.Input[builtins.bool]] = None,
                 mappings_fields: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 search_analyzer: Optional[pulumi.Input[builtins.str]] = None,
                 stored_source: Optional[pulumi.Input[builtins.str]] = None,
                 synonyms: Optional[pulumi.Input[Sequence[pulumi.Input['SearchIndexSynonymArgs']]]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 wait_for_index_build_completion: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SearchIndex resource.
        :param pulumi.Input[builtins.str] cluster_name: The name of the cluster where you want to create the search index within.
        :param pulumi.Input[builtins.str] collection_name: Name of the collection the index is on. **NOTE:** The collection must exist before creating the index.
        :param pulumi.Input[builtins.str] database: Name of the database the collection is in.
        :param pulumi.Input[builtins.str] project_id: The ID of the organization or project you want to create the search index within.
        ...
        :param pulumi.Input[builtins.str] analyzers: [Custom analyzers](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/custom/#std-label-custom-analyzers) to use in this index. This is an array of JSON objects.
               ```
               analyzers = <<-EOF
               [{
        ...
        :param pulumi.Input[builtins.str] type: Type of index: `search` or `vectorSearch`. Default type is `search`.
        """
    ...
    def collection_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def collection_name(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def analyzers(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @analyzers.setter
    def analyzers(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def mappings_dynamic(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def mappings_dynamic(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mappings_dynamic", value)

    @property
    @pulumi.getter(name="mappingsFields")
    def mappings_fields(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mappings_fields(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def search_analyzer(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def search_analyzer(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "search_analyzer", value)

    @property
    @pulumi.getter(name="storedSource")
    def stored_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def stored_source(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def wait_for_index_build_completion(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "wait_for_index_build_completion")

    @wait_for_index_build_completion.setter
    def wait_for_index_build_completion(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SearchIndexState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database: Name of the database the collection is in.
        :param pulumi.Input[builtins.str] fields: Array of [Fields](https://www.mongodb.com/docs/atlas/atlas-search/field-types/knn-vector/#std-label-fts-data-types-knn-vector) to configure this `vectorSearch` index. It is mandatory for vector searches and it must contain at least one `vector` type field. This field needs to be a JSON string in order to be decoded correctly.
        :param pulumi.Input[builtins.str] index_id: The unique identifier of the Atlas Search index.
        :param pulumi.Input[builtins.bool] mappings_dynamic: Indicates whether the search index uses dynamic or static mapping. For dynamic mapping, set the value to `true`. For static mapping, specify the fields to index using `mappings_fields`
        :param pulumi.Input[builtins.str] mappings_fields: attribute is required in search indexes when `mappings_dynamic` is false. This field needs to be a JSON string in order to be decoded correctly.
        :param pulumi.Input[builtins.str] name: The name of the search index you want to create.
        :param pulumi.Input[builtins.str] project_id: The ID of the organization or project you want to create the search index within.
        :param pulumi.Input[builtins.str] search_analyzer: [Analyzer](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/#std-label-analyzers-ref) to use when searching the index. Defaults to [lucene.standard](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/standard/#std-label-ref-standard-analyzer)
        :param pulumi.Input[builtins.str] status: Current status of the index.
        :param pulumi.Input[builtins.str] stored_source: String that can be "true" (store all fields), "false" (default, don't store any field), or a JSON string that contains the list of fields to store (include) or not store (exclude) on Atlas Search. To learn more, see [Stored Source Fields](https://www.mongodb.com/docs/atlas/atlas-search/stored-source-definition/).
        :param pulumi.Input[Sequence[pulumi.Input['SearchIndexSynonymArgs']]] synonyms: Synonyms mapping definition to use in this index.
        :param pulumi.Input[builtins.str] type: Type of index: `search` or `vectorSearch`. Default type is `search`.
        """
...
class SearchIndex(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            synonyms: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SearchIndexSynonymArgs', 'SearchIndexSynonymArgsDict']]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            wait_for_index_build_completion: Optional[pulumi.Input[builtins.bool]] = None) -> 'SearchIndex':
        """
    ...
    @property
    @pulumi.getter
    def analyzer(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        [Analyzer](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/#std-label-analyzers-ref) to use when creating the index. Defaults to [lucene.standard](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/standard/#std-label-ref-standard-analyzer)
        """
        return pulumi.get(self, "analyzer")
    ...
    @property
    @pulumi.getter
    def analyzers(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        [Custom analyzers](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/custom/#std-label-custom-analyzers) to use in this index. This is an array of JSON objects.
        ```
        analyzers = <<-EOF
    ...
    @property
    @pulumi.getter(name="collectionName")
    def collection_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the collection the index is on. **NOTE:** The collection must exist before creating the index.
        """
        return pulumi.get(self, "collection_name")
    ...
    @property
    @pulumi.getter
    def fields(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Array of [Fields](https://www.mongodb.com/docs/atlas/atlas-search/field-types/knn-vector/#std-label-fts-data-types-knn-vector) to configure this `vectorSearch` index. It is mandatory for vector searches and it must contain at least one `vector` type field. This field needs to be a JSON string in order to be decoded correctly.
        """
        return pulumi.get(self, "fields")
    ...
    @property
    @pulumi.getter(name="mappingsDynamic")
    def mappings_dynamic(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the search index uses dynamic or static mapping. For dynamic mapping, set the value to `true`. For static mapping, specify the fields to index using `mappings_fields`
        """
        return pulumi.get(self, "mappings_dynamic")
    ...
    @property
    @pulumi.getter(name="mappingsFields")
    def mappings_fields(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        attribute is required in search indexes when `mappings_dynamic` is false. This field needs to be a JSON string in order to be decoded correctly.
        """
        return pulumi.get(self, "mappings_fields")
    ...
    @property
    @pulumi.getter(name="searchAnalyzer")
    def search_analyzer(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        [Analyzer](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/#std-label-analyzers-ref) to use when searching the index. Defaults to [lucene.standard](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/standard/#std-label-ref-standard-analyzer)
        """
        return pulumi.get(self, "search_analyzer")
    ...
    @property
    @pulumi.getter(name="storedSource")
    def stored_source(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        String that can be "true" (store all fields), "false" (default, don't store any field), or a JSON string that contains the list of fields to store (include) or not store (exclude) on Atlas Search. To learn more, see [Stored Source Fields](https://www.mongodb.com/docs/atlas/atlas-search/stored-source-definition/).
        """
        return pulumi.get(self, "stored_source")
    ...
    @property
    @pulumi.getter(name="waitForIndexBuildCompletion")
    def wait_for_index_build_completion(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "wait_for_index_build_completion")
