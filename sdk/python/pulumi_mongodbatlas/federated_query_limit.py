...
class FederatedQueryLimitArgs:
    def __init__(__self__, *,
                 limit_name: pulumi.Input[builtins.str],
                 overrun_policy: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] limit_name: String enum that indicates whether the identity provider is active or not. Accepted values are:
        ...
        :param pulumi.Input[builtins.str] overrun_policy: String enum that identifies action to take when the usage limit is exceeded. If limit span is set to QUERY, this is ignored because MongoDB Cloud stops the query when it exceeds the usage limit. Accepted values are "BLOCK" OR "BLOCK_AND_KILL"
        :param pulumi.Input[builtins.str] project_id: The unique ID for the project to create a Federated Database Instance.
        :param pulumi.Input[builtins.str] tenant_name: Name of the Atlas Federated Database Instance.
        :param pulumi.Input[builtins.int] value: Amount to set the limit to.
        :param pulumi.Input[builtins.int] default_limit: Default value of the limit.
    ...
    def limit_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @limit_name.setter
    def limit_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "limit_name", value)

    @property
    @pulumi.getter(name="overrunPolicy")
    def overrun_policy(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def overrun_policy(self, value: pulumi.Input[builtins.str]):
...
class _FederatedQueryLimitState:
    def __init__(__self__, *,
                 ...
                 maximum_limit: Optional[pulumi.Input[builtins.int]] = None,
                 overrun_policy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] current_usage: Amount that indicates the current usage of the limit.
        :param pulumi.Input[builtins.int] default_limit: Default value of the limit.
               * `lastModifiedDate` - Only used for Data Federation limits. Timestamp that indicates when this usage limit was last modified. This field uses the ISO 8601 timestamp format in UTC.
               * `maximumLimit` - Maximum value of the limit.
        :param pulumi.Input[builtins.str] limit_name: String enum that indicates whether the identity provider is active or not. Accepted values are:
    ...
    @property
    @pulumi.getter(name="limitName")
    def limit_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        String enum that indicates whether the identity provider is active or not. Accepted values are:
        * `bytesProcessed.query`: Limit on the number of bytes processed during a single data federation query.
        * `bytesProcessed.daily`: Limit on the number of bytes processed for the data federation instance for the current day.
    ...
    @limit_name.setter
    def limit_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "limit_name", value)
    ...
    @property
    @pulumi.getter(name="overrunPolicy")
    def overrun_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        String enum that identifies action to take when the usage limit is exceeded. If limit span is set to QUERY, this is ignored because MongoDB Cloud stops the query when it exceeds the usage limit. Accepted values are "BLOCK" OR "BLOCK_AND_KILL"
        """
        return pulumi.get(self, "overrun_policy")
    ...
    @overrun_policy.setter
    def overrun_policy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "overrun_policy", value)
...
@pulumi.type_token("mongodbatlas:index/federatedQueryLimit:FederatedQueryLimit")
class FederatedQueryLimit(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            tenant_name: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.int]] = None) -> 'FederatedQueryLimit':
        """
    ...
    @property
    @pulumi.getter(name="currentUsage")
    def current_usage(self) -> pulumi.Output[builtins.int]:
        """
        Amount that indicates the current usage of the limit.
        """
        return pulumi.get(self, "current_usage")
    ...
    @property
    @pulumi.getter(name="defaultLimit")
    def default_limit(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Default value of the limit.
        * `lastModifiedDate` - Only used for Data Federation limits. Timestamp that indicates when this usage limit was last modified. This field uses the ISO 8601 timestamp format in UTC.
        * `maximumLimit` - Maximum value of the limit.
    ...
    @property
    @pulumi.getter(name="limitName")
    def limit_name(self) -> pulumi.Output[builtins.str]:
        """
        String enum that indicates whether the identity provider is active or not. Accepted values are:
        * `bytesProcessed.query`: Limit on the number of bytes processed during a single data federation query.
        * `bytesProcessed.daily`: Limit on the number of bytes processed for the data federation instance for the current day.
    ...
    @property
    @pulumi.getter(name="maximumLimit")
    def maximum_limit(self) -> pulumi.Output[Optional[builtins.int]]:
        return pulumi.get(self, "maximum_limit")

    @property
    @pulumi.getter(name="overrunPolicy")
    def overrun_policy(self) -> pulumi.Output[builtins.str]:
        """
        String enum that identifies action to take when the usage limit is exceeded. If limit span is set to QUERY, this is ignored because MongoDB Cloud stops the query when it exceeds the usage limit. Accepted values are "BLOCK" OR "BLOCK_AND_KILL"
        """
        return pulumi.get(self, "overrun_policy")
