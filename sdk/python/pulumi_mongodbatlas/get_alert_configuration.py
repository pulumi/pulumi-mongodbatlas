...
def get_alert_configuration(alert_configuration_id: Optional[builtins.str] = None,
    ...
    :param builtins.str alert_configuration_id: Unique identifier for the alert configuration.
    ...
    :param builtins.str project_id: The ID of the project where the alert configuration will create.
    """
    __args__ = dict()
...
def get_alert_configuration_output(alert_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
