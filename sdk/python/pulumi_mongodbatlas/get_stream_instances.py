...
def get_stream_instances(items_per_page: Optional[_builtins.int] = None,
...
def get_stream_instances_output(items_per_page: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
