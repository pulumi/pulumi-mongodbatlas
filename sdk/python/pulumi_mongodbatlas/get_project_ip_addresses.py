...
def get_project_ip_addresses(project_id: Optional[builtins.str] = None,
...
def get_project_ip_addresses_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
