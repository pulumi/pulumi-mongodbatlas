...
def get_privatelink_endpoint_service_serverless(endpoint_id: Optional[_builtins.str] = None,
    ...
    **WARNING:** This data source is deprecated and will be removed in March 2025. For more datails see Migration Guide: Transition out of Serverless Instances and Shared-tier clusters
    ...
    :param _builtins.str endpoint_id: Unique 22-character alphanumeric string that identifies the private endpoint. Atlas supports AWS private endpoints using the [AWS PrivateLink](https://aws.amazon.com/privatelink/) feature.
    :param _builtins.str instance_name: Human-readable label that identifies the serverless instance
    :param _builtins.str project_id: Unique 24-digit hexadecimal string that identifies the project.
    """
    __args__ = dict()
...
def get_privatelink_endpoint_service_serverless_output(endpoint_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                       instance_name: Optional[pulumi.Input[_builtins.str]] = None,
                                                       project_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPrivatelinkEndpointServiceServerlessResult]:
    """
    **WARNING:** This data source is deprecated and will be removed in March 2025. For more datails see Migration Guide: Transition out of Serverless Instances and Shared-tier clusters
