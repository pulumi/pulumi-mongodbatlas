...
class GetGlobalClusterConfigResult:
    ...
    def custom_zone_mapping(self) -> Mapping[str, builtins.str]:
        """
    ...
    def custom_zone_mapping_zone_id(self) -> Mapping[str, builtins.str]:
        """
...
def get_global_cluster_config(cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_name: The name of the Global Cluster.
...
def get_global_cluster_config_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
