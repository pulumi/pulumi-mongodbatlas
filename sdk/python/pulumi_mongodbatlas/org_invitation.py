...
class OrgInvitationArgs:
    def __init__(__self__, *,
                 ...
                 teams_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a OrgInvitation resource.
        :param pulumi.Input[builtins.str] org_id: Unique 24-hexadecimal digit string that identifies the organization to which you want to invite a user.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: Atlas roles to assign to the invited user. If the user accepts the invitation, Atlas assigns these roles to them. The [MongoDB Documentation](https://www.mongodb.com/docs/atlas/reference/user-roles/#organization-roles) describes the roles a user can have.
        :param pulumi.Input[builtins.str] username: Email address of the invited user. This is the address to which Atlas sends the invite. If the user accepts the invitation, they log in to Atlas with this username.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] teams_ids: An array of unique 24-hexadecimal digit strings that identify the teams that the user was invited to join.
        """
    ...
    def teams_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @teams_ids.setter
    def teams_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _OrgInvitationState:
    def __init__(__self__, *,
                 ...
                 inviter_username: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] created_at: Timestamp in ISO 8601 date and time format in UTC when Atlas sent the invitation.
        :param pulumi.Input[builtins.str] expires_at: Timestamp in ISO 8601 date and time format in UTC when the invitation expires. Users have 30 days to accept an invitation.
        :param pulumi.Input[builtins.str] invitation_id: Unique 24-hexadecimal digit string that identifies the invitation in Atlas.
        :param pulumi.Input[builtins.str] inviter_username: Atlas user who invited `username` to the organization.
        :param pulumi.Input[builtins.str] org_id: Unique 24-hexadecimal digit string that identifies the organization to which you want to invite a user.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: Atlas roles to assign to the invited user. If the user accepts the invitation, Atlas assigns these roles to them. The [MongoDB Documentation](https://www.mongodb.com/docs/atlas/reference/user-roles/#organization-roles) describes the roles a user can have.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] teams_ids: An array of unique 24-hexadecimal digit strings that identify the teams that the user was invited to join.
        :param pulumi.Input[builtins.str] username: Email address of the invited user. This is the address to which Atlas sends the invite. If the user accepts the invitation, they log in to Atlas with this username.
    ...
    def invitation_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inviter_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inviter_username(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("mongodbatlas:index/orgInvitation:OrgInvitation")
class OrgInvitation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            teams_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'OrgInvitation':
        """
    ...
    @property
    @pulumi.getter(name="inviterUsername")
    def inviter_username(self) -> pulumi.Output[builtins.str]:
        """
        Atlas user who invited `username` to the organization.
        """
        return pulumi.get(self, "inviter_username")
    ...
    @property
    @pulumi.getter(name="teamsIds")
    def teams_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        An array of unique 24-hexadecimal digit strings that identify the teams that the user was invited to join.
        """
        return pulumi.get(self, "teams_ids")
