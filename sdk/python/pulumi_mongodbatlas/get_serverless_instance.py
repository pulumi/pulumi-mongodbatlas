...
class GetServerlessInstanceResult:
    ...
    def auto_indexing(self) -> builtins.bool:
        """
    ...
    def connection_strings_private_endpoint_srvs(self) -> Sequence[builtins.str]:
        """
    ...
    @_utilities.deprecated("""This parameter is deprecated and will be removed in March 2025. For more details see https://registry.terraform.io/providers/mongodb/mongodbatlas/latest/docs/guides/serverless-shared-migration-guide.""")
    def continuous_backup_enabled(self) -> builtins.bool:
        """
...
def get_serverless_instance(auto_indexing: Optional[builtins.bool] = None,
                            continuous_backup_enabled: Optional[builtins.bool] = None,
                            links: Optional[Sequence[Union['GetServerlessInstanceLinkArgs', 'GetServerlessInstanceLinkArgsDict']]] = None,
                            name: Optional[builtins.str] = None,
                            project_id: Optional[builtins.str] = None,
                            state_name: Optional[builtins.str] = None,
    ...
    **NOTE:**  `ServerlessInstance` and `PrivatelinkEndpointServiceServerless` resources have a circular dependency in some respects.\\
    ...
    :param builtins.bool auto_indexing: (Deprecated) Flag that indicates whether the serverless instance uses [Serverless Auto Indexing](https://www.mongodb.com/docs/atlas/performance-advisor/auto-index-serverless/).
    :param builtins.bool continuous_backup_enabled: (Deprecated) Flag that indicates whether the serverless instance uses Serverless Continuous Backup.
    :param builtins.str name: Human-readable label that identifies your serverless instance.
    :param builtins.str project_id: Unique 24-hexadecimal digit string that identifies the project that contains your serverless instance.
    :param builtins.str state_name: Stage of deployment of this serverless instance when the resource made its request.
    """
    __args__ = dict()
...
def get_serverless_instance_output(auto_indexing: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                   continuous_backup_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                   ...
                                   state_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
