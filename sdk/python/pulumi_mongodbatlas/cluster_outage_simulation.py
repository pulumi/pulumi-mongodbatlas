...
class ClusterOutageSimulationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_name: Name of the Atlas Cluster that is/will undergoing outage simulation.
        ...
        :param pulumi.Input[builtins.str] project_id: The unique ID for the project that contains the cluster that is/will undergoing outage simulation.
        """
...
class _ClusterOutageSimulationState:
    def __init__(__self__, *,
                 ...
                 start_request_date: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterOutageSimulationOutageFilterArgs']]] outage_filters: List of settings that specify the type of cluster outage simulation.
        :param pulumi.Input[builtins.str] project_id: The unique ID for the project that contains the cluster that is/will undergoing outage simulation.
        :param pulumi.Input[builtins.str] simulation_id: Unique 24-hexadecimal character string that identifies the outage simulation.
        :param pulumi.Input[builtins.str] start_request_date: Date and time when MongoDB Cloud started the regional outage simulation.
        :param pulumi.Input[builtins.str] state: Current phase of the outage simulation:
    ...
    def simulation_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def simulation_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "simulation_id", value)

    @property
    @pulumi.getter(name="startRequestDate")
    def start_request_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def start_request_date(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterOutageSimulation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            simulation_id: Optional[pulumi.Input[builtins.str]] = None,
            start_request_date: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'ClusterOutageSimulation':
        """
    ...
    @property
    @pulumi.getter(name="simulationId")
    def simulation_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique 24-hexadecimal character string that identifies the outage simulation.
        """
        return pulumi.get(self, "simulation_id")
    ...
    @property
    @pulumi.getter(name="startRequestDate")
    def start_request_date(self) -> pulumi.Output[builtins.str]:
        """
        Date and time when MongoDB Cloud started the regional outage simulation.
        """
        return pulumi.get(self, "start_request_date")
