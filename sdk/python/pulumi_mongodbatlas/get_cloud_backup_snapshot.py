...
class GetCloudBackupSnapshotResult:
    ...
    def snapshot_ids(self) -> Sequence[builtins.str]:
        """
...
def get_cloud_backup_snapshot(cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str snapshot_id: The unique identifier of the snapshot you want to retrieve.
    """
    __args__ = dict()
...
def get_cloud_backup_snapshot_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
