...
class GetServiceAccountAccessListEntryResult:
    ...
    """
    def __init__(__self__, cidr_block=None, client_id=None, created_at=None, ip_address=None, last_used_address=None, last_used_at=None, org_id=None, request_count=None):
