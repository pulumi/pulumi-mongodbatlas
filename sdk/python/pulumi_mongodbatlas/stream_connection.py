...
class StreamConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_name: Human-readable label that identifies the stream connection. In the case of the Sample type, this is the name of the sample source.
    ...
    def bootstrap_servers(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "bootstrap_servers")

    @bootstrap_servers.setter
    def bootstrap_servers(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StreamConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            security: Optional[pulumi.Input[Union['StreamConnectionSecurityArgs', 'StreamConnectionSecurityArgsDict']]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'StreamConnection':
        """
    ...
    @property
    @pulumi.getter(name="bootstrapServers")
    def bootstrap_servers(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "bootstrap_servers")
