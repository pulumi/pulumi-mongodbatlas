...
class GetCloudBackupSnapshotExportJobResult:
    ...
    def export_status_exported_collections(self) -> builtins.int:
        return pulumi.get(self, "export_status_exported_collections")

    @property
    @pulumi.getter(name="exportStatusTotalCollections")
    def export_status_total_collections(self) -> builtins.int:
...
def get_cloud_backup_snapshot_export_job(cluster_name: Optional[builtins.str] = None,
                                         export_job_id: Optional[builtins.str] = None,
    ...
    :param builtins.str export_job_id: Unique identifier of the export job to retrieve.
    :param builtins.str project_id: Unique 24-hexadecimal digit string that identifies the project which contains the Atlas cluster whose snapshot you want to retrieve.
    """
    __args__ = dict()
...
def get_cloud_backup_snapshot_export_job_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
