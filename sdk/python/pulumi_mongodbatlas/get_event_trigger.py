...
class GetEventTriggerResult:
    ...
    def config_full_document(self) -> builtins.bool:
        """
    ...
    def config_full_document_before(self) -> builtins.bool:
    ...
    def config_operation_types(self) -> Sequence[builtins.str]:
        """
    ...
    def config_providers(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def unordered(self) -> builtins.bool:
        """
...
def get_event_trigger(app_id: Optional[builtins.str] = None,
    ...
    :param builtins.str app_id: The ObjectID of your application.
    ...
    :param builtins.str project_id: The unique ID for the project to create the trigger.
    :param builtins.str trigger_id: The unique ID of the trigger.
    """
    __args__ = dict()
...
def get_event_trigger_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
