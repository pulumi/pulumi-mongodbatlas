...
def get_cluster_outage_simulation(cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_name: Name of the Atlas Cluster that is undergoing outage simulation.
    :param builtins.str project_id: The unique ID for the project that contains the cluster that is undergoing outage simulation.
    """
    __args__ = dict()
...
def get_cluster_outage_simulation_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
