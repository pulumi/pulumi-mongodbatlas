...
def get_encryption_at_rest_private_endpoint(cloud_provider: Optional[builtins.str] = None,
    ...
    :param builtins.str cloud_provider: Label that identifies the cloud provider for the Encryption At Rest private endpoint.
    :param builtins.str id: Unique 24-hexadecimal digit string that identifies the Private Endpoint Service.
...
def get_encryption_at_rest_private_endpoint_output(cloud_provider: Optional[pulumi.Input[builtins.str]] = None,
