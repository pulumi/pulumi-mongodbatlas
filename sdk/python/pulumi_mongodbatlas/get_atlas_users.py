...
def get_atlas_users(items_per_page: Optional[builtins.int] = None,
    ...
    :param builtins.str org_id: Unique 24-hexadecimal digit string that identifies the organization whose users you want to return. Also needed when `team_id` attributes is defined.
    ...
    :param builtins.str project_id: Unique 24-hexadecimal digit string that identifies the project whose users you want to return.
    :param builtins.str team_id: Unique 24-hexadecimal digit string that identifies the team whose users you want to return.
    """
    __args__ = dict()
...
def get_atlas_users_output(items_per_page: Optional[pulumi.Input[Optional[builtins.int]]] = None,
