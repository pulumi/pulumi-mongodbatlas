...
def get_cloud_backup_snapshot_export_bucket(export_bucket_id: Optional[_builtins.str] = None,
...
def get_cloud_backup_snapshot_export_bucket_output(export_bucket_id: Optional[pulumi.Input[_builtins.str]] = None,
