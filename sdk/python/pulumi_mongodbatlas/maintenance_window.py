...
class MaintenanceWindowArgs:
    def __init__(__self__, *,
                 day_of_week: pulumi.Input[builtins.int],
                 project_id: pulumi.Input[builtins.str],
                 auto_defer: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def day_of_week(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @day_of_week.setter
    def day_of_week(self, value: pulumi.Input[builtins.int]):
    ...
    def auto_defer(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @auto_defer.setter
    def auto_defer(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def auto_defer_once_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _MaintenanceWindowState:
    ...
    def number_of_deferrals(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def number_of_deferrals(self, value: Optional[pulumi.Input[builtins.int]]):
...
class MaintenanceWindow(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autoDefer")
    def auto_defer(self) -> pulumi.Output[builtins.bool]:
        """
        Defer any scheduled maintenance for the given project for one week.
        """
        return pulumi.get(self, "auto_defer")
    ...
    @property
    @pulumi.getter(name="dayOfWeek")
    def day_of_week(self) -> pulumi.Output[builtins.int]:
        """
        Day of the week when you would like the maintenance window to start as a 1-based integer: Su=1, M=2, T=3, W=4, T=5, F=6, Sa=7.
        """
        return pulumi.get(self, "day_of_week")
    ...
    @property
    @pulumi.getter
    def defer(self) -> pulumi.Output[builtins.bool]:
        """
        Defer the next scheduled maintenance for the given project for one week.
        """
        return pulumi.get(self, "defer")
    ...
    @property
    @pulumi.getter(name="hourOfDay")
    def hour_of_day(self) -> pulumi.Output[builtins.int]:
        """
        Hour of the day when you would like the maintenance window to start. This parameter uses the 24-hour clock, where midnight is 0, noon is 12 (Time zone is UTC). Defaults to 0.
        """
        return pulumi.get(self, "hour_of_day")
    ...
    @property
    @pulumi.getter(name="numberOfDeferrals")
    def number_of_deferrals(self) -> pulumi.Output[builtins.int]:
        """
        Number of times the current maintenance event for this project has been deferred, there can be a maximum of 2 deferrals.
        """
        return pulumi.get(self, "number_of_deferrals")
