...
def get_stream_privatelink_endpoints(project_id: Optional[builtins.str] = None,
...
def get_stream_privatelink_endpoints_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
