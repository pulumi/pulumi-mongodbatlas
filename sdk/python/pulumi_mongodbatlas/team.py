...
class TeamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] org_id: The unique identifier for the organization you want to associate the team with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] usernames: The Atlas usernames (email address). You can only add Atlas users who are part of the organization. Users who have not accepted an invitation to join the organization cannot be added as team members. There is a maximum of 250 Atlas users per team.
        :param pulumi.Input[builtins.str] name: The name of the team you want to create.
        """
...
class _TeamState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the team you want to create.
        :param pulumi.Input[builtins.str] org_id: The unique identifier for the organization you want to associate the team with.
        :param pulumi.Input[builtins.str] team_id: The unique identifier for the team.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] usernames: The Atlas usernames (email address). You can only add Atlas users who are part of the organization. Users who have not accepted an invitation to join the organization cannot be added as team members. There is a maximum of 250 Atlas users per team.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class Team(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            org_id: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None,
            usernames: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Team':
        """
    ...
    @property
    @pulumi.getter
    def usernames(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The Atlas usernames (email address). You can only add Atlas users who are part of the organization. Users who have not accepted an invitation to join the organization cannot be added as team members. There is a maximum of 250 Atlas users per team.
        """
        return pulumi.get(self, "usernames")
