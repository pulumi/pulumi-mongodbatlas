...
class OnlineArchiveArgs:
    def __init__(__self__, *,
                 ...
                 coll_name: pulumi.Input[builtins.str],
                 ...
                 sync_creation: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a OnlineArchive resource.
        :param pulumi.Input[builtins.str] cluster_name: Name of the cluster that contains the collection.
        :param pulumi.Input[builtins.str] coll_name: Name of the collection.
        :param pulumi.Input['OnlineArchiveCriteriaArgs'] criteria: Criteria to use for archiving data. See criteria.
        :param pulumi.Input[builtins.str] db_name: Name of the database that contains the collection.
        :param pulumi.Input[builtins.str] project_id: The unique ID for the project
        :param pulumi.Input[builtins.str] collection_type: Type of MongoDB collection that you want to return. This value can be "TIMESERIES" or "STANDARD". Default is "STANDARD".
        ...
        :param pulumi.Input[builtins.bool] paused: State of the online archive. This is required for pausing an active online archive or resuming a paused online archive. If the collection has another active online archive, the resume request fails.
        ...
        :param pulumi.Input[builtins.bool] sync_creation: Flag that indicates whether the provider will wait for the state of the online archive to reach `IDLE` or `ACTIVE` when creating an online archive. Defaults to `false`.
        """
    ...
    def coll_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @coll_name.setter
    def coll_name(self, value: pulumi.Input[builtins.str]):
    ...
    def sync_creation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sync_creation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _OnlineArchiveState:
    def __init__(__self__, *,
                 archive_id: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_name: Optional[pulumi.Input[builtins.str]] = None,
                 coll_name: Optional[pulumi.Input[builtins.str]] = None,
                 collection_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] archive_id: ID of the online archive.
        :param pulumi.Input[builtins.str] cluster_name: Name of the cluster that contains the collection.
        :param pulumi.Input[builtins.str] coll_name: Name of the collection.
        :param pulumi.Input[builtins.str] collection_type: Type of MongoDB collection that you want to return. This value can be "TIMESERIES" or "STANDARD". Default is "STANDARD".
        :param pulumi.Input['OnlineArchiveCriteriaArgs'] criteria: Criteria to use for archiving data. See criteria.
        ...
        :param pulumi.Input[builtins.str] project_id: The unique ID for the project
        :param pulumi.Input['OnlineArchiveScheduleArgs'] schedule: Regular frequency and duration when archiving process occurs. See schedule.
        :param pulumi.Input[builtins.str] state: Status of the online archive. Valid values are: Pending, Archiving, Idle, Pausing, Paused, Orphaned and Deleted
        :param pulumi.Input[builtins.bool] sync_creation: Flag that indicates whether the provider will wait for the state of the online archive to reach `IDLE` or `ACTIVE` when creating an online archive. Defaults to `false`.
        """
    ...
    def archive_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @archive_id.setter
    def archive_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="collName")
    def coll_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the collection.
        """
        return pulumi.get(self, "coll_name")
    ...
    @coll_name.setter
    def coll_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "coll_name", value)
...
class OnlineArchive(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schedule: Optional[pulumi.Input[Union['OnlineArchiveScheduleArgs', 'OnlineArchiveScheduleArgsDict']]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            sync_creation: Optional[pulumi.Input[builtins.bool]] = None) -> 'OnlineArchive':
        """
    ...
    @property
    @pulumi.getter(name="archiveId")
    def archive_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the online archive.
        """
        return pulumi.get(self, "archive_id")
    ...
    @property
    @pulumi.getter(name="collName")
    def coll_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the collection.
        """
        return pulumi.get(self, "coll_name")
    ...
    @property
    @pulumi.getter(name="syncCreation")
    def sync_creation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag that indicates whether the provider will wait for the state of the online archive to reach `IDLE` or `ACTIVE` when creating an online archive. Defaults to `false`.
        """
        return pulumi.get(self, "sync_creation")
