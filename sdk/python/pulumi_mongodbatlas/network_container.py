...
class NetworkContainerArgs:
    def __init__(__self__, *,
                 atlas_cidr_block: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] atlas_cidr_block: CIDR block that Atlas uses for the Network Peering containers in your project.  Atlas uses the specified CIDR block for all other Network Peering connections created in the project. The Atlas CIDR block must be at least a /24 and at most a /21 in one of the following [private networks](https://tools.ietf.org/html/rfc1918.html#section-3):
        ...
        :param pulumi.Input[builtins.str] project_id: Unique identifier for the Atlas project for this Network Peering Container.
        :param pulumi.Input[builtins.str] provider_name: Cloud provider for this Network Peering connection.  Accepted values are GCP, AWS, AZURE. If omitted, Atlas sets this parameter to AWS.
        :param pulumi.Input[builtins.str] region: Atlas region where the container resides, see the reference list for Atlas Azure region names [Azure](https://docs.atlas.mongodb.com/reference/microsoft-azure/).
        :param pulumi.Input[builtins.str] region_name: The Atlas AWS region name for where this container will exist, see the reference list for Atlas AWS region names [AWS](https://docs.atlas.mongodb.com/reference/amazon-aws/).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: Atlas regions where the container resides. Provide this field only if you provide an `atlas_cidr_block` smaller than `/18`. [GCP Regions values](https://docs.atlas.mongodb.com/reference/api/vpc-create-container/#request-body-parameters).
        """
    ...
    def atlas_cidr_block(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def atlas_cidr_block(self, value: pulumi.Input[builtins.str]):
...
class _NetworkContainerState:
    def __init__(__self__, *,
                 ...
                 provider_name: Optional[pulumi.Input[builtins.str]] = None,
                 provisioned: Optional[pulumi.Input[builtins.bool]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 region_name: Optional[pulumi.Input[builtins.str]] = None,
                 regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] container_id: The Network Peering Container ID.
        :param pulumi.Input[builtins.str] gcp_project_id: Unique identifier of the GCP project in which the network peer resides. Returns null. This value is populated once you create a new network peering connection with the network peering resource.
        :param pulumi.Input[builtins.str] network_name: Unique identifier of the Network Peering connection in the Atlas project. Returns null. This value is populated once you create a new network peering connection with the network peering resource.
        :param pulumi.Input[builtins.str] project_id: Unique identifier for the Atlas project for this Network Peering Container.
        :param pulumi.Input[builtins.str] provider_name: Cloud provider for this Network Peering connection.  Accepted values are GCP, AWS, AZURE. If omitted, Atlas sets this parameter to AWS.
        :param pulumi.Input[builtins.bool] provisioned: Indicates whether the project has Network Peering connections deployed in the container.
        :param pulumi.Input[builtins.str] region: Atlas region where the container resides, see the reference list for Atlas Azure region names [Azure](https://docs.atlas.mongodb.com/reference/microsoft-azure/).
        :param pulumi.Input[builtins.str] region_name: The Atlas AWS region name for where this container will exist, see the reference list for Atlas AWS region names [AWS](https://docs.atlas.mongodb.com/reference/amazon-aws/).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: Atlas regions where the container resides. Provide this field only if you provide an `atlas_cidr_block` smaller than `/18`. [GCP Regions values](https://docs.atlas.mongodb.com/reference/api/vpc-create-container/#request-body-parameters).
        :param pulumi.Input[builtins.str] vnet_name: The name of the Azure VNet. Returns null. This value is populated once you create a new network peering connection with the network peering resource.
        :param pulumi.Input[builtins.str] vpc_id: Unique identifier of Atlas' AWS VPC.
        """
    ...
    @property
    @pulumi.getter
    def provisioned(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @provisioned.setter
    def provisioned(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class NetworkContainer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            vnet_name: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkContainer':
        """
    ...
    @property
    @pulumi.getter
    def provisioned(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the project has Network Peering connections deployed in the container.
        """
        return pulumi.get(self, "provisioned")
