...
__all__ = [
    'GetAiModelApiKeyResult',
    'AwaitableGetAiModelApiKeyResult',
    'get_ai_model_api_key',
    'get_ai_model_api_key_output',
]

@pulumi.output_type
class GetAiModelApiKeyResult:
    """
    A collection of values returned by getAiModelApiKey.
    """
    def __init__(__self__, api_key_id=None, cloud=None, created_at=None, created_by=None, endpoint=None, geography=None, last_used_at=None, masked_secret=None, name=None, project_id=None, status=None):
...
class AwaitableGetAiModelApiKeyResult(GetAiModelApiKeyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAiModelApiKeyResult(
...
def get_ai_model_api_key(api_key_id: Optional[_builtins.str] = None,
                         project_id: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAiModelApiKeyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('mongodbatlas:index/getAiModelApiKey:getAiModelApiKey', __args__, opts=opts, typ=GetAiModelApiKeyResult).value

    return AwaitableGetAiModelApiKeyResult(
...
def get_ai_model_api_key_output(api_key_id: pulumi.Input[Optional[_builtins.str]] = None,
                                project_id: pulumi.Input[Optional[_builtins.str]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAiModelApiKeyResult]:
    """
    `AiModelApiKey` describes an AI Model API Key.
    ...
    __ret__ = pulumi.runtime.invoke_output('mongodbatlas:index/getAiModelApiKey:getAiModelApiKey', __args__, opts=opts, typ=GetAiModelApiKeyResult)
    return __ret__.apply(lambda __response__: GetAiModelApiKeyResult(
