...
def get_project_api_key(api_key_id: Optional[builtins.str] = None,
    ...
    :param builtins.str api_key_id: Unique identifier for this Project API key.
...
def get_project_api_key_output(api_key_id: Optional[pulumi.Input[builtins.str]] = None,
