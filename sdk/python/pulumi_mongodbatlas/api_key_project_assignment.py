...
class ApiKeyProjectAssignmentArgs:
    def __init__(__self__, *,
                 api_key_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] api_key_id: Unique 24-hexadecimal digit string that identifies this organization API key that you want to assign to one project.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: Human-readable label that identifies the collection of privileges that MongoDB Cloud grants a specific API key, MongoDB
    ...
    def api_key_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @api_key_id.setter
    def api_key_id(self, value: pulumi.Input[builtins.str]):
...
class ApiKeyProjectAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            api_key_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ApiKeyProjectAssignment':
        """
