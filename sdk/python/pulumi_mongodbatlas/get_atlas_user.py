...
class GetAtlasUserResult:
    ...
    def team_ids(self) -> Sequence[builtins.str]:
        """
...
def get_atlas_user(user_id: Optional[builtins.str] = None,
    ...
    :param builtins.str user_id: Unique 24-hexadecimal digit string that identifies this user.
    :param builtins.str username: Email address that belongs to the MongoDB Atlas user account. You can't modify this address after creating the user.
...
def get_atlas_user_output(user_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
