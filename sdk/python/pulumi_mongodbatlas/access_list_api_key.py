...
class AccessListApiKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_key_id: Unique identifier for the Organization API Key for which you want to create a new access list entry.
        ...
        :param pulumi.Input[builtins.str] cidr_block: Range of IP addresses in CIDR notation to be added to the access list. Your access list entry can include only one `cidrBlock`, or one `ipAddress`.
        :param pulumi.Input[builtins.str] ip_address: Single IP address to be added to the access list.
        """
...
class AccessListApiKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cidr_block: Optional[pulumi.Input[builtins.str]] = None,
            ip_address: Optional[pulumi.Input[builtins.str]] = None,
            org_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessListApiKey':
        """
