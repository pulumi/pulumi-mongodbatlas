...
class GetPrivateLinkEndpointServiceResult:
    ...
    def delete_requested(self) -> builtins.bool:
        """
...
def get_private_link_endpoint_service(endpoint_service_id: Optional[builtins.str] = None,
                                      private_link_id: Optional[builtins.str] = None,
    ...
    :param builtins.str endpoint_service_id: Unique identifier of the `AWS` or `AZURE` or `GCP` resource.
    :param builtins.str private_link_id: Unique identifier of the private endpoint service for which you want to retrieve a private endpoint.
    :param builtins.str project_id: Unique identifier for the project.
    :param builtins.str provider_name: Cloud provider for which you want to create a private endpoint. Atlas accepts `AWS` or `AZURE` or `GCP`.
    """
    __args__ = dict()
...
def get_private_link_endpoint_service_output(endpoint_service_id: Optional[pulumi.Input[builtins.str]] = None,
