...
def get_serverless_instances(project_id: Optional[builtins.str] = None,
...
def get_serverless_instances_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    **WARNING:** This data source is deprecated and will be removed in January 2026. For more details, see Migration Guide: Transition out of Serverless Instances and Shared-tier clusters.
    ...
    __ret__ = pulumi.runtime.invoke_output('mongodbatlas:index/getServerlessInstances:getServerlessInstances', __args__, opts=opts, typ=GetServerlessInstancesResult)
