...
def get_serverless_instances(project_id: Optional[_builtins.str] = None,
...
def get_serverless_instances_output(project_id: Optional[pulumi.Input[_builtins.str]] = None,
