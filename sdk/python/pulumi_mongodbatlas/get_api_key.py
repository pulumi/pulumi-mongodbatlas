...
def get_api_key(api_key_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str api_key_id: Unique identifier for the organization API key.
    :param _builtins.str org_id: Unique identifier for the organization.
    """
    __args__ = dict()
