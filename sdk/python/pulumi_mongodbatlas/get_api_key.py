...
def get_api_key(api_key_id: Optional[builtins.str] = None,
    ...
    :param builtins.str api_key_id: Unique identifier for the organization API key.
    :param builtins.str org_id: Unique identifier for the organization.
    """
    __args__ = dict()
...
def get_api_key_output(api_key_id: Optional[pulumi.Input[builtins.str]] = None,
