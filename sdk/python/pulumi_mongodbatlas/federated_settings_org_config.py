...
class FederatedSettingsOrgConfigArgs:
    def __init__(__self__, *,
                 domain_restriction_enabled: pulumi.Input[builtins.bool],
                 federation_settings_id: pulumi.Input[builtins.str],
                 org_id: pulumi.Input[builtins.str],
                 data_access_identity_provider_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 domain_allow_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 identity_provider_id: Optional[pulumi.Input[builtins.str]] = None,
                 post_auth_role_grants: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a FederatedSettingsOrgConfig resource.
        :param pulumi.Input[builtins.bool] domain_restriction_enabled: Flag that indicates whether domain restriction is enabled for the connected organization.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] data_access_identity_provider_ids: The collection of unique ids representing the identity providers that can be used for data access in this organization.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domain_allow_lists: List that contains the approved domains from which organization users can log in.
        :param pulumi.Input[builtins.str] identity_provider_id: Legacy 20-hexadecimal digit string that identifies the SAML access identity provider that this connected org config is associated with. Removing the attribute or providing the value `""` will detach/remove the SAML identity provider. This id can be found in two ways:
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] post_auth_role_grants: List that contains the default [roles](https://www.mongodb.com/docs/atlas/reference/user-roles/#std-label-organization-roles) granted to users who authenticate through the IdP in a connected organization.
        """
    ...
    def domain_restriction_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def domain_restriction_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def data_access_identity_provider_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def data_access_identity_provider_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "data_access_identity_provider_ids", value)

    @property
    @pulumi.getter(name="domainAllowLists")
    def domain_allow_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def domain_allow_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "domain_allow_lists", value)

    @property
    @pulumi.getter(name="identityProviderId")
    def identity_provider_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def identity_provider_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "identity_provider_id", value)

    @property
    @pulumi.getter(name="postAuthRoleGrants")
    def post_auth_role_grants(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def post_auth_role_grants(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _FederatedSettingsOrgConfigState:
    def __init__(__self__, *,
                 data_access_identity_provider_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 domain_allow_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 domain_restriction_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="domainRestrictionEnabled")
    def domain_restriction_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Flag that indicates whether domain restriction is enabled for the connected organization.
        """
        return pulumi.get(self, "domain_restriction_enabled")
    ...
    @domain_restriction_enabled.setter
    def domain_restriction_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "domain_restriction_enabled", value)
...
class FederatedSettingsOrgConfig(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dataAccessIdentityProviderIds")
    def data_access_identity_provider_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The collection of unique ids representing the identity providers that can be used for data access in this organization.
        """
        return pulumi.get(self, "data_access_identity_provider_ids")
    ...
    @property
    @pulumi.getter(name="domainAllowLists")
    def domain_allow_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List that contains the approved domains from which organization users can log in.
        """
        return pulumi.get(self, "domain_allow_lists")
    ...
    @property
    @pulumi.getter(name="domainRestrictionEnabled")
    def domain_restriction_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Flag that indicates whether domain restriction is enabled for the connected organization.
        """
        return pulumi.get(self, "domain_restriction_enabled")
    ...
    @property
    @pulumi.getter(name="identityProviderId")
    def identity_provider_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Legacy 20-hexadecimal digit string that identifies the SAML access identity provider that this connected org config is associated with. Removing the attribute or providing the value `""` will detach/remove the SAML identity provider. This id can be found in two ways:
        1. Within the Federation Management UI in Atlas in the Identity Providers tab by clicking the info icon in the IdP ID row of a configured SAML identity provider
        2. `okta_idp_id` on the `FederatedSettingsIdentityProvider` resource
    ...
    @property
    @pulumi.getter(name="postAuthRoleGrants")
    def post_auth_role_grants(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List that contains the default [roles](https://www.mongodb.com/docs/atlas/reference/user-roles/#std-label-organization-roles) granted to users who authenticate through the IdP in a connected organization.
        """
        return pulumi.get(self, "post_auth_role_grants")
