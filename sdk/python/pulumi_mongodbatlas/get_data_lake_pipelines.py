...
def get_data_lake_pipelines(project_id: Optional[builtins.str] = None,
...
def get_data_lake_pipelines_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
