...
class MongodbEmployeeAccessGrantArgs:
    def __init__(__self__, *,
                 ...
                 expiration_time: pulumi.Input[builtins.str],
                 grant_type: pulumi.Input[builtins.str],
                 project_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a MongodbEmployeeAccessGrant resource.
        :param pulumi.Input[builtins.str] cluster_name: Human-readable label that identifies this cluster.
        :param pulumi.Input[builtins.str] expiration_time: Expiration date for the employee access grant.
        :param pulumi.Input[builtins.str] grant_type: Level of access to grant to MongoDB Employees. Possible values are CLUSTER*DATABASE*LOGS, CLUSTER*INFRASTRUCTURE or CLUSTER*INFRASTRUCTURE*AND*APP*SERVICES*SYNC_DATA.
    ...
    def expiration_time(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def expiration_time(self, value: pulumi.Input[builtins.str]):
...
class _MongodbEmployeeAccessGrantState:
    def __init__(__self__, *,
                 ...
                 grant_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="grantType")
    def grant_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Level of access to grant to MongoDB Employees. Possible values are CLUSTER*DATABASE*LOGS, CLUSTER*INFRASTRUCTURE or CLUSTER*INFRASTRUCTURE*AND*APP*SERVICES*SYNC_DATA.
        """
        return pulumi.get(self, "grant_type")
    ...
    @grant_type.setter
    def grant_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "grant_type", value)
...
class MongodbEmployeeAccessGrant(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            expiration_time: Optional[pulumi.Input[builtins.str]] = None,
            grant_type: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MongodbEmployeeAccessGrant':
        """
    ...
    @property
    @pulumi.getter(name="grantType")
    def grant_type(self) -> pulumi.Output[builtins.str]:
        """
        Level of access to grant to MongoDB Employees. Possible values are CLUSTER*DATABASE*LOGS, CLUSTER*INFRASTRUCTURE or CLUSTER*INFRASTRUCTURE*AND*APP*SERVICES*SYNC_DATA.
        """
        return pulumi.get(self, "grant_type")
