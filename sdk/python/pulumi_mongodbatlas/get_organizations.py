...
def get_organizations(items_per_page: Optional[builtins.int] = None,
...
def get_organizations_output(items_per_page: Optional[pulumi.Input[Optional[builtins.int]]] = None,
