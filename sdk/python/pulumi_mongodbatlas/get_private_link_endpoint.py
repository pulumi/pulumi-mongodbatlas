...
class GetPrivateLinkEndpointResult:
    ...
    def endpoint_group_names(self) -> Sequence[builtins.str]:
        """
    ...
    def interface_endpoints(self) -> Sequence[builtins.str]:
        """
    ...
    def private_endpoints(self) -> Sequence[builtins.str]:
        """
    ...
    def service_attachment_names(self) -> Sequence[builtins.str]:
        """
...
def get_private_link_endpoint(private_link_id: Optional[builtins.str] = None,
    ...
    :param builtins.str private_link_id: Unique identifier of the private endpoint service that you want to retrieve.
    :param builtins.str project_id: Unique identifier for the project.
    :param builtins.str provider_name: Cloud provider for which you want to retrieve a private endpoint service. Atlas accepts `AWS`, `AZURE` or `GCP`.
    """
    __args__ = dict()
...
def get_private_link_endpoint_output(private_link_id: Optional[pulumi.Input[builtins.str]] = None,
