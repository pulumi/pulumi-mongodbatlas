...
def get_project_ip_access_list(aws_security_group: Optional[builtins.str] = None,
    ...
    :param builtins.str aws_security_group: Unique identifier of the AWS security group to add to the access list.
    :param builtins.str cidr_block: Range of IP addresses in CIDR notation to be added to the access list.
    :param builtins.str ip_address: Single IP address to be added to the access list.
           
           > **NOTE:** One of the following attributes must set:  `aws_security_group`, `cidr_block`  or `ip_address`.
    :param builtins.str project_id: Unique identifier for the project to which you want to add one or more access list entries.
    """
    __args__ = dict()
...
def get_project_ip_access_list_output(aws_security_group: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      cidr_block: Optional[pulumi.Input[Optional[builtins.str]]] = None,
