...
def get509_authentication_database_user(project_id: Optional[_builtins.str] = None,
...
def get509_authentication_database_user_output(project_id: Optional[pulumi.Input[_builtins.str]] = None,
