...
def get509_authentication_database_user(project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: Identifier for the Atlas project associated with the X.509 configuration.
    :param builtins.str username: Username of the database user to create a certificate for.
    """
...
def get509_authentication_database_user_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
