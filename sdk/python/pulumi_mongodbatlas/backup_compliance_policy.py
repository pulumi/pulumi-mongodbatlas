...
class BackupCompliancePolicyArgs:
    def __init__(__self__, *,
                 authorized_email: pulumi.Input[builtins.str],
                 authorized_user_first_name: pulumi.Input[builtins.str],
                 authorized_user_last_name: pulumi.Input[builtins.str],
                 project_id: pulumi.Input[builtins.str],
                 copy_protection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 encryption_at_rest_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] authorized_email: Email address of a security or legal representative for the Backup Compliance Policy who is authorized to update the Backup Compliance Policy settings.
        :param pulumi.Input[builtins.str] authorized_user_first_name: First name of the user who authorized to update the Backup Compliance Policy settings.
        :param pulumi.Input[builtins.str] authorized_user_last_name: Last name of the user who authorized to update the Backup Compliance Policy settings.
        :param pulumi.Input[builtins.str] project_id: Unique 24-hexadecimal digit string that identifies your project.
        :param pulumi.Input[builtins.bool] copy_protection_enabled: Flag that indicates whether to enable additional backup copies for the cluster. If unspecified, this value defaults to false.
        :param pulumi.Input[builtins.bool] encryption_at_rest_enabled: Flag that indicates whether Encryption at Rest using Customer Key Management is required for all clusters with a Backup Compliance Policy. If unspecified, this value defaults to false.
        ...
        :param pulumi.Input[builtins.bool] pit_enabled: Flag that indicates whether the cluster uses Continuous Cloud Backups with a Backup Compliance Policy. If unspecified, this value defaults to false.
        ...
        :param pulumi.Input[builtins.int] restore_window_days: Number of previous days that you can restore back to with Continuous Cloud Backup with a Backup Compliance Policy. You must specify a positive, non-zero integer, and the maximum retention window can't exceed the hourly retention time. This parameter applies only to Continuous Cloud Backups with a Backup Compliance Policy.
        """
    ...
    def authorized_email(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def authorized_email(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "authorized_email", value)

    @property
    @pulumi.getter(name="authorizedUserFirstName")
    def authorized_user_first_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def authorized_user_first_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "authorized_user_first_name", value)

    @property
    @pulumi.getter(name="authorizedUserLastName")
    def authorized_user_last_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def authorized_user_last_name(self, value: pulumi.Input[builtins.str]):
    ...
    def copy_protection_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def copy_protection_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "copy_protection_enabled", value)

    @property
    @pulumi.getter(name="encryptionAtRestEnabled")
    def encryption_at_rest_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def encryption_at_rest_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _BackupCompliancePolicyState:
    def __init__(__self__, *,
                 authorized_email: Optional[pulumi.Input[builtins.str]] = None,
                 authorized_user_first_name: Optional[pulumi.Input[builtins.str]] = None,
                 authorized_user_last_name: Optional[pulumi.Input[builtins.str]] = None,
                 copy_protection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 encryption_at_rest_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 on_demand_policy_item: Optional[pulumi.Input['BackupCompliancePolicyOnDemandPolicyItemArgs']] = None,
                 pit_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 updated_user: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] project_id: Unique 24-hexadecimal digit string that identifies your project.
        :param pulumi.Input[builtins.int] restore_window_days: Number of previous days that you can restore back to with Continuous Cloud Backup with a Backup Compliance Policy. You must specify a positive, non-zero integer, and the maximum retention window can't exceed the hourly retention time. This parameter applies only to Continuous Cloud Backups with a Backup Compliance Policy.
        :param pulumi.Input[builtins.str] state: Label that indicates the state of the Backup Compliance Policy settings. MongoDB Cloud ignores this setting when you enable or update the Backup Compliance Policy settings.
        :param pulumi.Input[builtins.str] updated_date: ISO 8601 timestamp format in UTC that indicates when the user updated the Data Protection Policy settings. MongoDB Cloud ignores this setting when you enable or update the Backup Compliance Policy settings.
        :param pulumi.Input[builtins.str] updated_user: Email address that identifies the user who updated the Backup Compliance Policy settings. MongoDB Cloud ignores this email setting when you enable or update the Backup Compliance Policy settings.
        """
    ...
    @property
    @pulumi.getter(name="authorizedEmail")
    def authorized_email(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Email address of a security or legal representative for the Backup Compliance Policy who is authorized to update the Backup Compliance Policy settings.
        """
        return pulumi.get(self, "authorized_email")
    ...
    @authorized_email.setter
    def authorized_email(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authorized_email", value)

    @property
    @pulumi.getter(name="authorizedUserFirstName")
    def authorized_user_first_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        First name of the user who authorized to update the Backup Compliance Policy settings.
        """
        return pulumi.get(self, "authorized_user_first_name")
    ...
    @authorized_user_first_name.setter
    def authorized_user_first_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authorized_user_first_name", value)

    @property
    @pulumi.getter(name="authorizedUserLastName")
    def authorized_user_last_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Last name of the user who authorized to update the Backup Compliance Policy settings.
        """
        return pulumi.get(self, "authorized_user_last_name")
    ...
    @authorized_user_last_name.setter
    def authorized_user_last_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authorized_user_last_name", value)
    ...
    def updated_user(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @updated_user.setter
    def updated_user(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BackupCompliancePolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            updated_date: Optional[pulumi.Input[builtins.str]] = None,
            updated_user: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupCompliancePolicy':
        """
    ...
    @property
    @pulumi.getter(name="authorizedEmail")
    def authorized_email(self) -> pulumi.Output[builtins.str]:
        """
        Email address of a security or legal representative for the Backup Compliance Policy who is authorized to update the Backup Compliance Policy settings.
        """
        return pulumi.get(self, "authorized_email")
    ...
    @property
    @pulumi.getter(name="authorizedUserFirstName")
    def authorized_user_first_name(self) -> pulumi.Output[builtins.str]:
        """
        First name of the user who authorized to update the Backup Compliance Policy settings.
        """
        return pulumi.get(self, "authorized_user_first_name")
    ...
    @property
    @pulumi.getter(name="authorizedUserLastName")
    def authorized_user_last_name(self) -> pulumi.Output[builtins.str]:
        """
        Last name of the user who authorized to update the Backup Compliance Policy settings.
        """
        return pulumi.get(self, "authorized_user_last_name")
    ...
    @property
    @pulumi.getter(name="copyProtectionEnabled")
    def copy_protection_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag that indicates whether to enable additional backup copies for the cluster. If unspecified, this value defaults to false.
        """
        return pulumi.get(self, "copy_protection_enabled")
    ...
    @property
    @pulumi.getter(name="encryptionAtRestEnabled")
    def encryption_at_rest_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag that indicates whether Encryption at Rest using Customer Key Management is required for all clusters with a Backup Compliance Policy. If unspecified, this value defaults to false.
        """
        return pulumi.get(self, "encryption_at_rest_enabled")
    ...
    @property
    @pulumi.getter(name="pitEnabled")
    def pit_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag that indicates whether the cluster uses Continuous Cloud Backups with a Backup Compliance Policy. If unspecified, this value defaults to false.
        """
        return pulumi.get(self, "pit_enabled")
    ...
    @property
    @pulumi.getter(name="restoreWindowDays")
    def restore_window_days(self) -> pulumi.Output[builtins.int]:
        """
        Number of previous days that you can restore back to with Continuous Cloud Backup with a Backup Compliance Policy. You must specify a positive, non-zero integer, and the maximum retention window can't exceed the hourly retention time. This parameter applies only to Continuous Cloud Backups with a Backup Compliance Policy.
        """
        return pulumi.get(self, "restore_window_days")
    ...
    @property
    @pulumi.getter(name="updatedUser")
    def updated_user(self) -> pulumi.Output[builtins.str]:
        """
        Email address that identifies the user who updated the Backup Compliance Policy settings. MongoDB Cloud ignores this email setting when you enable or update the Backup Compliance Policy settings.
        """
        return pulumi.get(self, "updated_user")
