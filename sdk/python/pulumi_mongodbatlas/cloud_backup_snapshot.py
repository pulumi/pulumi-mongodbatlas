...
class CloudBackupSnapshotArgs:
    def __init__(__self__, *,
                 ...
                 retention_in_days: pulumi.Input[builtins.int]):
        """
        The set of arguments for constructing a CloudBackupSnapshot resource.
        :param pulumi.Input[builtins.str] cluster_name: The name of the Atlas cluster that contains the snapshots you want to retrieve.
        :param pulumi.Input[builtins.str] description: Description of the on-demand snapshot.
        :param pulumi.Input[builtins.str] project_id: The unique identifier of the project for the Atlas cluster.
        :param pulumi.Input[builtins.int] retention_in_days: The number of days that Atlas should retain the on-demand snapshot. Must be at least 1.
        """
    ...
    def retention_in_days(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def retention_in_days(self, value: pulumi.Input[builtins.int]):
...
class _CloudBackupSnapshotState:
    def __init__(__self__, *,
                 ...
                 master_key_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 snapshot_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 snapshot_type: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 storage_size_bytes: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_name: The name of the Atlas cluster that contains the snapshots you want to retrieve.
        :param pulumi.Input[builtins.str] created_at: UTC ISO 8601 formatted point in time when Atlas took the snapshot.
        :param pulumi.Input[builtins.str] description: Description of the on-demand snapshot.
        :param pulumi.Input[builtins.str] expires_at: UTC ISO 8601 formatted point in time when Atlas will delete the snapshot.
        :param pulumi.Input[builtins.str] master_key_uuid: Unique ID of the AWS KMS Customer Master Key used to encrypt the snapshot. Only visible for clusters using Encryption at Rest via Customer KMS.
        ...
        :param pulumi.Input[builtins.str] mongod_version: Version of the MongoDB server.
        :param pulumi.Input[builtins.str] project_id: The unique identifier of the project for the Atlas cluster.
        ...
        :param pulumi.Input[builtins.int] retention_in_days: The number of days that Atlas should retain the on-demand snapshot. Must be at least 1.
        :param pulumi.Input[builtins.str] snapshot_id: Unique identifier of the snapshot.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] snapshot_ids: Unique identifiers of the snapshots created for the shards and config server for a sharded cluster. Atlas returns this parameter when `type` is `shardedCluster`. These identifiers should match those given in the `members[#].id` parameters. This allows you to map a snapshot to its shard or config server name.
        :param pulumi.Input[builtins.str] snapshot_type: Specified the type of snapshot. Valid values are onDemand and scheduled.
        :param pulumi.Input[builtins.str] status: Current status of the snapshot. One of the following values will be returned: queued, inProgress, completed, failed.
        :param pulumi.Input[builtins.int] storage_size_bytes: Specifies the size of the snapshot in bytes.
        :param pulumi.Input[builtins.str] type: Specifies the type of cluster: replicaSet or shardedCluster.
        """
    ...
    def master_key_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_key_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def snapshot_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @snapshot_ids.setter
    def snapshot_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def storage_size_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def storage_size_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class CloudBackupSnapshot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            storage_size_bytes: Optional[pulumi.Input[builtins.int]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'CloudBackupSnapshot':
        """
    ...
    @property
    @pulumi.getter(name="masterKeyUuid")
    def master_key_uuid(self) -> pulumi.Output[builtins.str]:
        """
        Unique ID of the AWS KMS Customer Master Key used to encrypt the snapshot. Only visible for clusters using Encryption at Rest via Customer KMS.
        """
        return pulumi.get(self, "master_key_uuid")
    ...
    @property
    @pulumi.getter(name="mongodVersion")
    def mongod_version(self) -> pulumi.Output[builtins.str]:
        """
        Version of the MongoDB server.
        """
        return pulumi.get(self, "mongod_version")
    ...
    @property
    @pulumi.getter(name="retentionInDays")
    def retention_in_days(self) -> pulumi.Output[builtins.int]:
        """
        The number of days that Atlas should retain the on-demand snapshot. Must be at least 1.
        """
        return pulumi.get(self, "retention_in_days")
    ...
    @property
    @pulumi.getter(name="snapshotIds")
    def snapshot_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Unique identifiers of the snapshots created for the shards and config server for a sharded cluster. Atlas returns this parameter when `type` is `shardedCluster`. These identifiers should match those given in the `members[#].id` parameters. This allows you to map a snapshot to its shard or config server name.
        """
        return pulumi.get(self, "snapshot_ids")
    ...
    @property
    @pulumi.getter(name="storageSizeBytes")
    def storage_size_bytes(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the size of the snapshot in bytes.
        """
        return pulumi.get(self, "storage_size_bytes")
