...
class GetCloudUserTeamAssignmentResult:
    ...
    """
    def __init__(__self__, country=None, created_at=None, first_name=None, invitation_created_at=None, invitation_expires_at=None, inviter_username=None, last_auth=None, last_name=None, mobile_number=None, org_id=None, org_membership_status=None, roles=None, team_id=None, team_ids=None, user_id=None, username=None):
