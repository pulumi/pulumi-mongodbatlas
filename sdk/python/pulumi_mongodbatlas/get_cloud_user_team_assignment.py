...
__all__ = [
    'GetCloudUserTeamAssignmentResult',
    'AwaitableGetCloudUserTeamAssignmentResult',
    'get_cloud_user_team_assignment',
    'get_cloud_user_team_assignment_output',
]

@pulumi.output_type
class GetCloudUserTeamAssignmentResult:
    """
    A collection of values returned by getCloudUserTeamAssignment.
    """
    def __init__(__self__, country=None, created_at=None, first_name=None, id=None, invitation_created_at=None, invitation_expires_at=None, inviter_username=None, last_auth=None, last_name=None, mobile_number=None, org_id=None, org_membership_status=None, roles=None, team_id=None, team_ids=None, user_id=None, username=None):
    ...
    @_builtins.property
    @pulumi.getter
    def roles(self) -> 'outputs.GetCloudUserTeamAssignmentRolesResult':
        """
...
class AwaitableGetCloudUserTeamAssignmentResult(GetCloudUserTeamAssignmentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudUserTeamAssignmentResult(
...
def get_cloud_user_team_assignment(org_id: Optional[_builtins.str] = None,
                                   team_id: Optional[_builtins.str] = None,
                                   user_id: Optional[_builtins.str] = None,
                                   username: Optional[_builtins.str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudUserTeamAssignmentResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('mongodbatlas:index/getCloudUserTeamAssignment:getCloudUserTeamAssignment', __args__, opts=opts, typ=GetCloudUserTeamAssignmentResult).value

    return AwaitableGetCloudUserTeamAssignmentResult(
...
def get_cloud_user_team_assignment_output(org_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('mongodbatlas:index/getCloudUserTeamAssignment:getCloudUserTeamAssignment', __args__, opts=opts, typ=GetCloudUserTeamAssignmentResult)
    return __ret__.apply(lambda __response__: GetCloudUserTeamAssignmentResult(
