...
class _CloudUserOrgAssignmentState:
    def __init__(__self__, *,
                 ...
                 roles: pulumi.Input[Optional['CloudUserOrgAssignmentRolesArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def roles(self) -> pulumi.Input[Optional['CloudUserOrgAssignmentRolesArgs']]:
        """
        Organization and project level roles to assign the MongoDB Cloud user within one organization.
        """
        return pulumi.get(self, "roles")
    ...
    @roles.setter
    def roles(self, value: pulumi.Input[Optional['CloudUserOrgAssignmentRolesArgs']]):
        pulumi.set(self, "roles", value)
