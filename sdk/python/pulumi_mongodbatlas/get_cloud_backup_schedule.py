...
class GetCloudBackupScheduleResult:
    ...
    def reference_hour_of_day(self) -> builtins.int:
        """
    ...
    def reference_minute_of_hour(self) -> builtins.int:
        """
    ...
    def restore_window_days(self) -> builtins.int:
        """
    ...
    def use_org_and_group_names_in_export_prefix(self) -> builtins.bool:
        """
    ...
    def use_zone_id_for_copy_settings(self) -> Optional[builtins.bool]:
...
def get_cloud_backup_schedule(cluster_name: Optional[builtins.str] = None,
...
def get_cloud_backup_schedule_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
