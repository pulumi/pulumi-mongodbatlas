...
class X509AuthenticationDatabaseUserArgs:
    def __init__(__self__, *,
                 ...
                 customer_x509_cas: Optional[pulumi.Input[builtins.str]] = None,
                 months_until_expiration: Optional[pulumi.Input[builtins.int]] = None,
                 username: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a X509AuthenticationDatabaseUser resource.
        :param pulumi.Input[builtins.str] project_id: Identifier for the Atlas project associated with the X.509 configuration.
        :param pulumi.Input[builtins.str] customer_x509_cas: PEM string containing one or more customer CAs for database user authentication.
        :param pulumi.Input[builtins.int] months_until_expiration: A number of months that the created certificate is valid for before expiry, up to 24 months. By default is 3.
        :param pulumi.Input[builtins.str] username: Username of the database user to create a certificate for.
        """
    ...
    def customer_x509_cas(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def customer_x509_cas(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "customer_x509_cas", value)

    @property
    @pulumi.getter(name="monthsUntilExpiration")
    def months_until_expiration(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def months_until_expiration(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _X509AuthenticationDatabaseUserState:
    def __init__(__self__, *,
                 ...
                 current_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 customer_x509_cas: Optional[pulumi.Input[builtins.str]] = None,
                 months_until_expiration: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] current_certificate: Contains the last X.509 certificate and private key created for a database user.
        :param pulumi.Input[builtins.str] customer_x509_cas: PEM string containing one or more customer CAs for database user authentication.
        :param pulumi.Input[builtins.int] months_until_expiration: A number of months that the created certificate is valid for before expiry, up to 24 months. By default is 3.
        :param pulumi.Input[builtins.str] project_id: Identifier for the Atlas project associated with the X.509 configuration.
        :param pulumi.Input[builtins.str] username: Username of the database user to create a certificate for.
    ...
    def current_certificate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def current_certificate(self, value: Optional[pulumi.Input[builtins.str]]):
...
class X509AuthenticationDatabaseUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            months_until_expiration: Optional[pulumi.Input[builtins.int]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'X509AuthenticationDatabaseUser':
        """
    ...
    @property
    @pulumi.getter(name="currentCertificate")
    def current_certificate(self) -> pulumi.Output[builtins.str]:
        """
        Contains the last X.509 certificate and private key created for a database user.
        """
        return pulumi.get(self, "current_certificate")
    ...
    @property
    @pulumi.getter(name="customerX509Cas")
    def customer_x509_cas(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        PEM string containing one or more customer CAs for database user authentication.
        """
        return pulumi.get(self, "customer_x509_cas")
    ...
    @property
    @pulumi.getter(name="monthsUntilExpiration")
    def months_until_expiration(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        A number of months that the created certificate is valid for before expiry, up to 24 months. By default is 3.
        """
        return pulumi.get(self, "months_until_expiration")
