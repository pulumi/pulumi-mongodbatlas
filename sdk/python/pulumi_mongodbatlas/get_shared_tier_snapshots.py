...
def get_shared_tier_snapshots(cluster_name: Optional[_builtins.str] = None,
...
def get_shared_tier_snapshots_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
