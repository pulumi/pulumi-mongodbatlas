...
class GetLdapConfigurationResult:
    ...
    def authorization_enabled(self) -> builtins.bool:
        """
...
def get_ldap_configuration(project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: Identifier for the Atlas project associated with the LDAP over TLS/SSL configuration.
    """
    __args__ = dict()
...
def get_ldap_configuration_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
