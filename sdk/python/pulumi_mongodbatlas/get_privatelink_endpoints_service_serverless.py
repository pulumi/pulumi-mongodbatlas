...
def get_privatelink_endpoints_service_serverless(instance_name: Optional[builtins.str] = None,
...
def get_privatelink_endpoints_service_serverless_output(instance_name: Optional[pulumi.Input[builtins.str]] = None,
