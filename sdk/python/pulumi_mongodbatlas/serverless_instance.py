...
class ServerlessInstanceArgs:
    def __init__(__self__, *,
                 ...
                 provider_settings_backing_provider_name: pulumi.Input[builtins.str],
                 provider_settings_provider_name: pulumi.Input[builtins.str],
                 provider_settings_region_name: pulumi.Input[builtins.str],
                 auto_indexing: Optional[pulumi.Input[builtins.bool]] = None,
                 continuous_backup_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] project_id: The ID of the organization or project you want to create the serverless instance within.
        :param pulumi.Input[builtins.str] provider_settings_backing_provider_name: Cloud service provider on which MongoDB Cloud provisioned the serverless instance.
        :param pulumi.Input[builtins.str] provider_settings_provider_name: Cloud service provider that applies to the provisioned the serverless instance.
        :param pulumi.Input[builtins.str] provider_settings_region_name: Human-readable label that identifies the physical location of your MongoDB serverless instance. The region you choose can affect network latency for clients accessing your databases.
        :param pulumi.Input[builtins.bool] auto_indexing: Flag that indicates whether the serverless instance uses [Serverless Auto Indexing](https://www.mongodb.com/docs/atlas/performance-advisor/auto-index-serverless/). This parameter defaults to true.
        :param pulumi.Input[builtins.bool] continuous_backup_enabled: Flag that indicates whether the serverless instance uses [Serverless Continuous Backup](https://www.mongodb.com/docs/atlas/configure-serverless-backup). If this parameter is false or not used, the serverless instance uses [Basic Backup](https://www.mongodb.com/docs/atlas/configure-serverless-backup).
        :param pulumi.Input[builtins.str] name: Human-readable label that identifies the serverless instance.
        :param pulumi.Input[builtins.str] state_name: Stage of deployment of this serverless instance when the resource made its request.
    ...
    def provider_settings_backing_provider_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def provider_settings_backing_provider_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "provider_settings_backing_provider_name", value)

    @property
    @pulumi.getter(name="providerSettingsProviderName")
    def provider_settings_provider_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def provider_settings_provider_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "provider_settings_provider_name", value)

    @property
    @pulumi.getter(name="providerSettingsRegionName")
    def provider_settings_region_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def provider_settings_region_name(self, value: pulumi.Input[builtins.str]):
    ...
    def auto_indexing(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_indexing(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_indexing", value)

    @property
    @pulumi.getter(name="continuousBackupEnabled")
    @_utilities.deprecated("""This parameter is deprecated and will be removed in March 2025. For more details see https://registry.terraform.io/providers/mongodb/mongodbatlas/latest/docs/guides/serverless-shared-migration-guide.""")
    def continuous_backup_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def continuous_backup_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ServerlessInstanceState:
    def __init__(__self__, *,
                 auto_indexing: Optional[pulumi.Input[builtins.bool]] = None,
                 connection_strings_private_endpoint_srvs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 connection_strings_standard_srv: Optional[pulumi.Input[builtins.str]] = None,
                 continuous_backup_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 provider_settings_backing_provider_name: Optional[pulumi.Input[builtins.str]] = None,
                 provider_settings_provider_name: Optional[pulumi.Input[builtins.str]] = None,
                 provider_settings_region_name: Optional[pulumi.Input[builtins.str]] = None,
                 state_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['ServerlessInstanceTagArgs']]]] = None,
                 termination_protection_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] auto_indexing: Flag that indicates whether the serverless instance uses [Serverless Auto Indexing](https://www.mongodb.com/docs/atlas/performance-advisor/auto-index-serverless/). This parameter defaults to true.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] connection_strings_private_endpoint_srvs: List of Serverless Private Endpoint Connections
        :param pulumi.Input[builtins.str] connection_strings_standard_srv: Public `mongodb+srv://` connection string that you can use to connect to this serverless instance.
        :param pulumi.Input[builtins.bool] continuous_backup_enabled: Flag that indicates whether the serverless instance uses [Serverless Continuous Backup](https://www.mongodb.com/docs/atlas/configure-serverless-backup). If this parameter is false or not used, the serverless instance uses [Basic Backup](https://www.mongodb.com/docs/atlas/configure-serverless-backup).
        :param pulumi.Input[builtins.str] create_date: Timestamp that indicates when MongoDB Cloud created the serverless instance. The timestamp displays in the ISO 8601 date and time format in UTC.
        :param pulumi.Input[builtins.str] mongo_db_version: Version of MongoDB that the serverless instance runs, in `<major version>`.`<minor version>` format.
        :param pulumi.Input[builtins.str] name: Human-readable label that identifies the serverless instance.
        :param pulumi.Input[builtins.str] project_id: The ID of the organization or project you want to create the serverless instance within.
        :param pulumi.Input[builtins.str] provider_settings_backing_provider_name: Cloud service provider on which MongoDB Cloud provisioned the serverless instance.
        :param pulumi.Input[builtins.str] provider_settings_provider_name: Cloud service provider that applies to the provisioned the serverless instance.
    ...
    def connection_strings_private_endpoint_srvs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def connection_strings_private_endpoint_srvs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "connection_strings_private_endpoint_srvs", value)

    @property
    @pulumi.getter(name="connectionStringsStandardSrv")
    def connection_strings_standard_srv(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connection_strings_standard_srv(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="providerSettingsBackingProviderName")
    def provider_settings_backing_provider_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Cloud service provider on which MongoDB Cloud provisioned the serverless instance.
        """
        return pulumi.get(self, "provider_settings_backing_provider_name")
    ...
    @provider_settings_backing_provider_name.setter
    def provider_settings_backing_provider_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_settings_backing_provider_name", value)

    @property
    @pulumi.getter(name="providerSettingsProviderName")
    def provider_settings_provider_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Cloud service provider that applies to the provisioned the serverless instance.
        """
        return pulumi.get(self, "provider_settings_provider_name")
    ...
    @provider_settings_provider_name.setter
    def provider_settings_provider_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_settings_provider_name", value)

    @property
    @pulumi.getter(name="providerSettingsRegionName")
    def provider_settings_region_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Human-readable label that identifies the physical location of your MongoDB serverless instance. The region you choose can affect network latency for clients accessing your databases.
        """
        return pulumi.get(self, "provider_settings_region_name")
    ...
    @provider_settings_region_name.setter
    def provider_settings_region_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_settings_region_name", value)
...
class ServerlessInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ServerlessInstanceTagArgs', 'ServerlessInstanceTagArgsDict']]]]] = None,
            termination_protection_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'ServerlessInstance':
        """
    ...
    @pulumi.getter(name="autoIndexing")
    @_utilities.deprecated("""This parameter is deprecated and will be removed in March 2025. For more details see https://registry.terraform.io/providers/mongodb/mongodbatlas/latest/docs/guides/serverless-shared-migration-guide.""")
    def auto_indexing(self) -> pulumi.Output[builtins.bool]:
        """
        Flag that indicates whether the serverless instance uses [Serverless Auto Indexing](https://www.mongodb.com/docs/atlas/performance-advisor/auto-index-serverless/). This parameter defaults to true.
        """
        return pulumi.get(self, "auto_indexing")
    ...
    @property
    @pulumi.getter(name="connectionStringsPrivateEndpointSrvs")
    def connection_strings_private_endpoint_srvs(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of Serverless Private Endpoint Connections
        """
        return pulumi.get(self, "connection_strings_private_endpoint_srvs")
    ...
    @property
    @pulumi.getter(name="connectionStringsStandardSrv")
    def connection_strings_standard_srv(self) -> pulumi.Output[builtins.str]:
        """
        Public `mongodb+srv://` connection string that you can use to connect to this serverless instance.
        """
        return pulumi.get(self, "connection_strings_standard_srv")
    ...
    @pulumi.getter(name="continuousBackupEnabled")
    @_utilities.deprecated("""This parameter is deprecated and will be removed in March 2025. For more details see https://registry.terraform.io/providers/mongodb/mongodbatlas/latest/docs/guides/serverless-shared-migration-guide.""")
    def continuous_backup_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Flag that indicates whether the serverless instance uses [Serverless Continuous Backup](https://www.mongodb.com/docs/atlas/configure-serverless-backup). If this parameter is false or not used, the serverless instance uses [Basic Backup](https://www.mongodb.com/docs/atlas/configure-serverless-backup).
        """
        return pulumi.get(self, "continuous_backup_enabled")
    ...
    @property
    @pulumi.getter(name="providerSettingsBackingProviderName")
    def provider_settings_backing_provider_name(self) -> pulumi.Output[builtins.str]:
        """
        Cloud service provider on which MongoDB Cloud provisioned the serverless instance.
        """
        return pulumi.get(self, "provider_settings_backing_provider_name")
    ...
    @property
    @pulumi.getter(name="providerSettingsProviderName")
    def provider_settings_provider_name(self) -> pulumi.Output[builtins.str]:
        """
        Cloud service provider that applies to the provisioned the serverless instance.
        """
        return pulumi.get(self, "provider_settings_provider_name")
    ...
    @property
    @pulumi.getter(name="providerSettingsRegionName")
    def provider_settings_region_name(self) -> pulumi.Output[builtins.str]:
        """
        Human-readable label that identifies the physical location of your MongoDB serverless instance. The region you choose can affect network latency for clients accessing your databases.
        """
        return pulumi.get(self, "provider_settings_region_name")
