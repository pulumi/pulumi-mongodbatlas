...
def get_access_list_api_key(api_key_id: Optional[builtins.str] = None,
    ...
    :param builtins.str api_key_id: Unique identifier for the Organization API Key for which you want to retrieve an access list entry.
           *
...
def get_access_list_api_key_output(api_key_id: Optional[pulumi.Input[builtins.str]] = None,
