...
def get_event_triggers(app_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: The unique ID for the project to get all event triggers.
    """
    __args__ = dict()
...
def get_event_triggers_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
