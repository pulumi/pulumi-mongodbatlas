...
class NetworkPeeringArgs:
    def __init__(__self__, *,
                 ...
                 accepter_region_name: Optional[pulumi.Input[builtins.str]] = None,
                 atlas_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
                 atlas_gcp_project_id: Optional[pulumi.Input[builtins.str]] = None,
                 atlas_vpc_name: Optional[pulumi.Input[builtins.str]] = None,
                 aws_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 azure_directory_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 route_table_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
                 vnet_name: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a NetworkPeering resource.
        :param pulumi.Input[builtins.str] container_id: Unique identifier of the MongoDB Atlas container for the provider (GCP) or provider/region (AWS, AZURE). You can create an MongoDB Atlas container using the network_container resource or it can be obtained from the cluster returned values if a cluster has been created before the first container.
        :param pulumi.Input[builtins.str] project_id: The unique ID for the MongoDB Atlas project.
        :param pulumi.Input[builtins.str] provider_name: Cloud provider to whom the peering connection is being made. (Possible Values `AWS`, `AZURE`, `GCP`).
               
               **AWS ONLY:**
        :param pulumi.Input[builtins.str] accepter_region_name: Specifies the AWS region where the peer VPC resides. For complete lists of supported regions, see [Amazon Web Services](https://docs.atlas.mongodb.com/reference/amazon-aws/).
        :param pulumi.Input[builtins.str] atlas_gcp_project_id: The Atlas GCP Project ID for the GCP VPC used by your atlas cluster that is needed to set up the reciprocal connection.
        :param pulumi.Input[builtins.str] atlas_vpc_name: Name of the GCP VPC used by your atlas cluster that is needed to set up the reciprocal connection.
        :param pulumi.Input[builtins.str] aws_account_id: AWS Account ID of the owner of the peer VPC.
        :param pulumi.Input[builtins.str] azure_directory_id: Unique identifier for an Azure AD directory.
        :param pulumi.Input[builtins.str] azure_subscription_id: Unique identifier of the Azure subscription in which the VNet resides.
        :param pulumi.Input[builtins.str] gcp_project_id: GCP project ID of the owner of the network peer.
        :param pulumi.Input[builtins.str] network_name: Name of the network peer to which Atlas connects.
               
               **AZURE ONLY:**
        :param pulumi.Input[builtins.str] resource_group_name: Name of your Azure resource group.
        :param pulumi.Input[builtins.str] route_table_cidr_block: AWS VPC CIDR block or subnet.
               
               **GCP ONLY:**
        :param pulumi.Input[builtins.str] vnet_name: Name of your Azure VNet.
        :param pulumi.Input[builtins.str] vpc_id: Unique identifier of the AWS peer VPC (Note: this is **not** the same as the Atlas AWS VPC that is returned by the network_container resource).
        """
    ...
    def accepter_region_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def accepter_region_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "accepter_region_name", value)

    @property
    @pulumi.getter(name="atlasCidrBlock")
    def atlas_cidr_block(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "atlas_cidr_block")

    @atlas_cidr_block.setter
    def atlas_cidr_block(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "atlas_cidr_block", value)

    @property
    @pulumi.getter(name="atlasGcpProjectId")
    def atlas_gcp_project_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def atlas_gcp_project_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "atlas_gcp_project_id", value)

    @property
    @pulumi.getter(name="atlasVpcName")
    def atlas_vpc_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def atlas_vpc_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def azure_directory_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def azure_directory_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def route_table_cidr_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def route_table_cidr_block(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NetworkPeeringState:
    def __init__(__self__, *,
                 ...
                 atlas_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
                 atlas_gcp_project_id: Optional[pulumi.Input[builtins.str]] = None,
                 atlas_id: Optional[pulumi.Input[builtins.str]] = None,
                 atlas_vpc_name: Optional[pulumi.Input[builtins.str]] = None,
                 aws_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 azure_directory_id: Optional[pulumi.Input[builtins.str]] = None,
                 azure_subscription_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 error_state: Optional[pulumi.Input[builtins.str]] = None,
                 error_state_name: Optional[pulumi.Input[builtins.str]] = None,
                 gcp_project_id: Optional[pulumi.Input[builtins.str]] = None,
                 network_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 status_name: Optional[pulumi.Input[builtins.str]] = None,
                 vnet_name: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] azure_directory_id: Unique identifier for an Azure AD directory.
        :param pulumi.Input[builtins.str] azure_subscription_id: Unique identifier of the Azure subscription in which the VNet resides.
        :param pulumi.Input[builtins.str] connection_id: Unique identifier of the Atlas network peering container.
        :param pulumi.Input[builtins.str] container_id: Unique identifier of the MongoDB Atlas container for the provider (GCP) or provider/region (AWS, AZURE). You can create an MongoDB Atlas container using the network_container resource or it can be obtained from the cluster returned values if a cluster has been created before the first container.
        :param pulumi.Input[builtins.str] error_message: When `"status" : "FAILED"`, Atlas provides a description of the error.
        :param pulumi.Input[builtins.str] error_state: Description of the Atlas error when `status` is `Failed`, Otherwise, Atlas returns `null`.
        :param pulumi.Input[builtins.str] error_state_name: Error state, if any. The VPC peering connection error state value can be one of the following: `REJECTED`, `EXPIRED`, `INVALID_ARGUMENT`.
        :param pulumi.Input[builtins.str] gcp_project_id: GCP project ID of the owner of the network peer.
        :param pulumi.Input[builtins.str] network_name: Name of the network peer to which Atlas connects.
               
               **AZURE ONLY:**
        :param pulumi.Input[builtins.str] peer_id: Unique identifier of the Atlas network peer.
        :param pulumi.Input[builtins.str] project_id: The unique ID for the MongoDB Atlas project.
        :param pulumi.Input[builtins.str] provider_name: Cloud provider to whom the peering connection is being made. (Possible Values `AWS`, `AZURE`, `GCP`).
        ...
        :param pulumi.Input[builtins.str] route_table_cidr_block: AWS VPC CIDR block or subnet.
               ...
               **GCP ONLY:**
        :param pulumi.Input[builtins.str] status: Status of the Atlas network peering connection.  Azure/GCP: `ADDING_PEER`, `AVAILABLE`, `FAILED`, `DELETING` GCP Only:  `WAITING_FOR_USER`.
        :param pulumi.Input[builtins.str] status_name: (AWS Only) The VPC peering connection status value can be one of the following: `INITIATING`, `PENDING_ACCEPTANCE`, `FAILED`, `FINALIZING`, `AVAILABLE`, `TERMINATING`.
        :param pulumi.Input[builtins.str] vnet_name: Name of your Azure VNet.
        :param pulumi.Input[builtins.str] vpc_id: Unique identifier of the AWS peer VPC (Note: this is **not** the same as the Atlas AWS VPC that is returned by the network_container resource).
        """
        if accepter_region_name is not None:
    ...
    def atlas_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "atlas_id")

    @atlas_id.setter
    def atlas_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def error_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @error_state.setter
    def error_state(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "error_state", value)

    @property
    @pulumi.getter(name="errorStateName")
    def error_state_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def error_state_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def status_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @status_name.setter
    def status_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NetworkPeering(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status_name: Optional[pulumi.Input[builtins.str]] = None,
            vnet_name: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkPeering':
        """
    ...
    @property
    @pulumi.getter(name="accepterRegionName")
    def accepter_region_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the AWS region where the peer VPC resides. For complete lists of supported regions, see [Amazon Web Services](https://docs.atlas.mongodb.com/reference/amazon-aws/).
        """
        return pulumi.get(self, "accepter_region_name")
    ...
    @property
    @pulumi.getter(name="atlasCidrBlock")
    def atlas_cidr_block(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "atlas_cidr_block")

    @property
    @pulumi.getter(name="atlasGcpProjectId")
    def atlas_gcp_project_id(self) -> pulumi.Output[builtins.str]:
        """
        The Atlas GCP Project ID for the GCP VPC used by your atlas cluster that is needed to set up the reciprocal connection.
        """
        return pulumi.get(self, "atlas_gcp_project_id")
    ...
    @property
    @pulumi.getter(name="atlasId")
    def atlas_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "atlas_id")

    @property
    @pulumi.getter(name="atlasVpcName")
    def atlas_vpc_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the GCP VPC used by your atlas cluster that is needed to set up the reciprocal connection.
        """
        return pulumi.get(self, "atlas_vpc_name")
    ...
    @property
    @pulumi.getter(name="azureDirectoryId")
    def azure_directory_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier for an Azure AD directory.
        """
        return pulumi.get(self, "azure_directory_id")
    ...
    @property
    @pulumi.getter(name="errorState")
    def error_state(self) -> pulumi.Output[builtins.str]:
        """
        Description of the Atlas error when `status` is `Failed`, Otherwise, Atlas returns `null`.
        """
        return pulumi.get(self, "error_state")
    ...
    @property
    @pulumi.getter(name="errorStateName")
    def error_state_name(self) -> pulumi.Output[builtins.str]:
        """
        Error state, if any. The VPC peering connection error state value can be one of the following: `REJECTED`, `EXPIRED`, `INVALID_ARGUMENT`.
        """
        return pulumi.get(self, "error_state_name")
    ...
    @property
    @pulumi.getter(name="routeTableCidrBlock")
    def route_table_cidr_block(self) -> pulumi.Output[builtins.str]:
        """
        AWS VPC CIDR block or subnet.
    ...
    @property
    @pulumi.getter(name="statusName")
    def status_name(self) -> pulumi.Output[builtins.str]:
        """
        (AWS Only) The VPC peering connection status value can be one of the following: `INITIATING`, `PENDING_ACCEPTANCE`, `FAILED`, `FINALIZING`, `AVAILABLE`, `TERMINATING`.
        """
        return pulumi.get(self, "status_name")
