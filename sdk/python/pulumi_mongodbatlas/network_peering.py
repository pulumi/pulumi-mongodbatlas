...
class NetworkPeeringArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] route_table_cidr_block: AWS VPC CIDR block or subnet.
               ...
               **GCP ONLY:**
        :param pulumi.Input[_builtins.str] vnet_name: Name of your Azure VNet.
        :param pulumi.Input[_builtins.str] vpc_id: Unique identifier of the AWS peer VPC (Note: this is **not** the same as the Atlas AWS VPC that is returned by the network_container resource).
        """
...
class _NetworkPeeringState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] route_table_cidr_block: AWS VPC CIDR block or subnet.
               ...
               **GCP ONLY:**
        :param pulumi.Input[_builtins.str] status: Status of the Atlas network peering connection.  Azure/GCP: `ADDING_PEER`, `AVAILABLE`, `FAILED`, `DELETING` GCP Only:  `WAITING_FOR_USER`.
        :param pulumi.Input[_builtins.str] status_name: (AWS Only) The VPC peering connection status value can be one of the following: `INITIATING`, `PENDING_ACCEPTANCE`, `FAILED`, `FINALIZING`, `AVAILABLE`, `TERMINATING`.
        :param pulumi.Input[_builtins.str] vnet_name: Name of your Azure VNet.
        :param pulumi.Input[_builtins.str] vpc_id: Unique identifier of the AWS peer VPC (Note: this is **not** the same as the Atlas AWS VPC that is returned by the network_container resource).
        """
        if accepter_region_name is not None:
...
class NetworkPeering(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="atlasCidrBlock")
    def atlas_cidr_block(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "atlas_cidr_block")

    @_builtins.property
    @pulumi.getter(name="atlasGcpProjectId")
    def atlas_gcp_project_id(self) -> pulumi.Output[_builtins.str]:
        """
        The Atlas GCP Project ID for the GCP VPC used by your atlas cluster that is needed to set up the reciprocal connection.
        """
        return pulumi.get(self, "atlas_gcp_project_id")
    ...
    @_builtins.property
    @pulumi.getter(name="atlasId")
    def atlas_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "atlas_id")

    @_builtins.property
    @pulumi.getter(name="atlasVpcName")
    def atlas_vpc_name(self) -> pulumi.Output[_builtins.str]:
        """
        Name of the GCP VPC used by your atlas cluster that is needed to set up the reciprocal connection.
        """
        return pulumi.get(self, "atlas_vpc_name")
    ...
    @_builtins.property
    @pulumi.getter(name="azureDirectoryId")
    def azure_directory_id(self) -> pulumi.Output[_builtins.str]:
        """
        Unique identifier for an Azure AD directory.
        """
        return pulumi.get(self, "azure_directory_id")
    ...
    @_builtins.property
    @pulumi.getter(name="errorState")
    def error_state(self) -> pulumi.Output[_builtins.str]:
        """
        Description of the Atlas error when `status` is `Failed`, Otherwise, Atlas returns `null`.
        """
        return pulumi.get(self, "error_state")
    ...
    @_builtins.property
    @pulumi.getter(name="errorStateName")
    def error_state_name(self) -> pulumi.Output[_builtins.str]:
        """
        Error state, if any. The VPC peering connection error state value can be one of the following: `REJECTED`, `EXPIRED`, `INVALID_ARGUMENT`.
        """
        return pulumi.get(self, "error_state_name")
    ...
    @_builtins.property
    @pulumi.getter(name="routeTableCidrBlock")
    def route_table_cidr_block(self) -> pulumi.Output[_builtins.str]:
        """
        AWS VPC CIDR block or subnet.
