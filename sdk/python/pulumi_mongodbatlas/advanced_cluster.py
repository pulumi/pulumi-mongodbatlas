...
class AdvancedClusterArgs:
    def __init__(__self__, *,
                 ...
                 adaptive_capacity: pulumi.Input[Optional[_builtins.str]] = None,
                 advanced_configuration: pulumi.Input[Optional['AdvancedClusterAdvancedConfigurationArgs']] = None,
                 ...
                 pinned_fcv: pulumi.Input[Optional['AdvancedClusterPinnedFcvArgs']] = None,
                 pit_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 redact_client_log_data: pulumi.Input[Optional[_builtins.bool]] = None,
                 replica_set_scaling_strategy: pulumi.Input[Optional[_builtins.str]] = None,
                 retain_backups_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 root_cert_type: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 termination_protection_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 timeouts: pulumi.Input[Optional['AdvancedClusterTimeoutsArgs']] = None,
                 use_aws_time_based_snapshot_copy_for_fast_initial_sync: pulumi.Input[Optional[_builtins.bool]] = None,
                 use_effective_fields: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.bool] paused: Flag that indicates whether the cluster is paused or not. You can pause M10 or larger clusters.  You cannot initiate pausing for a shared/tenant tier cluster. If you try to update a `paused` cluster you will get a `CANNOT_UPDATE_PAUSED_CLUSTER` error. See [Considerations for Paused Clusters](https://www.mongodb.com/docs/atlas/pause-terminate-cluster/#considerations-for-paused-clusters).
    ...
    def accept_data_risks_and_force_replica_set_reconfig(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def accept_data_risks_and_force_replica_set_reconfig(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "accept_data_risks_and_force_replica_set_reconfig", value)

    @_builtins.property
    @pulumi.getter(name="adaptiveCapacity")
    def adaptive_capacity(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @adaptive_capacity.setter
    def adaptive_capacity(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "adaptive_capacity", value)

    @_builtins.property
    @pulumi.getter(name="advancedConfiguration")
    def advanced_configuration(self) -> pulumi.Input[Optional['AdvancedClusterAdvancedConfigurationArgs']]:
        """
    ...
    def advanced_configuration(self, value: pulumi.Input[Optional['AdvancedClusterAdvancedConfigurationArgs']]):
    ...
    def bi_connector_config(self) -> pulumi.Input[Optional['AdvancedClusterBiConnectorConfigArgs']]:
        """
    ...
    def bi_connector_config(self, value: pulumi.Input[Optional['AdvancedClusterBiConnectorConfigArgs']]):
        pulumi.set(self, "bi_connector_config", value)

    @_builtins.property
    @pulumi.getter(name="configServerManagementMode")
    def config_server_management_mode(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def config_server_management_mode(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def global_cluster_self_managed_sharding(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def global_cluster_self_managed_sharding(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def mongo_db_major_version(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def pinned_fcv(self) -> pulumi.Input[Optional['AdvancedClusterPinnedFcvArgs']]:
        """
    ...
    @pinned_fcv.setter
    def pinned_fcv(self, value: pulumi.Input[Optional['AdvancedClusterPinnedFcvArgs']]):
    ...
    def redact_client_log_data(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def redact_client_log_data(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "redact_client_log_data", value)

    @_builtins.property
    @pulumi.getter(name="replicaSetScalingStrategy")
    def replica_set_scaling_strategy(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Replica set scaling mode for your cluster. Valid values are `WORKLOAD_TYPE`, `SEQUENTIAL` and `NODE_TYPE`. By default, Atlas scales under `WORKLOAD_TYPE`. This mode allows Atlas to scale your analytics nodes in parallel to your operational nodes. When configured as `SEQUENTIAL`, Atlas scales all nodes sequentially. This mode is intended for steady-state workloads and applications performing latency-sensitive secondary reads. When configured as `NODE_TYPE`, Atlas scales your electable nodes in parallel with your read-only and analytics nodes. This mode is intended for large, dynamic workloads requiring frequent and timely cluster tier scaling. This is the fastest scaling strategy, but it might impact latency of workloads when performing extensive secondary reads. [Modify the Replica Set Scaling Mode](https://www.mongodb.com/docs/atlas/cluster-additional-settings/#configure-replica-set-scaling-mode)
        """
    ...
    def replica_set_scaling_strategy(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "replica_set_scaling_strategy", value)

    @_builtins.property
    @pulumi.getter(name="retainBackupsEnabled")
    def retain_backups_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def retain_backups_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "retain_backups_enabled", value)

    @_builtins.property
    @pulumi.getter(name="rootCertType")
    def root_cert_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def root_cert_type(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def timeouts(self) -> pulumi.Input[Optional['AdvancedClusterTimeoutsArgs']]:
        """
        )
        """
    ...
    @timeouts.setter
    def timeouts(self, value: pulumi.Input[Optional['AdvancedClusterTimeoutsArgs']]):
        pulumi.set(self, "timeouts", value)

    @_builtins.property
    @pulumi.getter(name="useAwsTimeBasedSnapshotCopyForFastInitialSync")
    def use_aws_time_based_snapshot_copy_for_fast_initial_sync(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def use_aws_time_based_snapshot_copy_for_fast_initial_sync(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def use_effective_fields(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "use_effective_fields", value)

    @_builtins.property
    @pulumi.getter(name="versionReleaseSystem")
    def version_release_system(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def version_release_system(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _AdvancedClusterState:
    def __init__(__self__, *,
                 ...
                 redact_client_log_data: pulumi.Input[Optional[_builtins.bool]] = None,
                 replica_set_scaling_strategy: pulumi.Input[Optional[_builtins.str]] = None,
                 replication_specs: pulumi.Input[Optional[Sequence[pulumi.Input['AdvancedClusterReplicationSpecArgs']]]] = None,
                 retain_backups_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 root_cert_type: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def config_server_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def config_server_type(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "config_server_type", value)

    @_builtins.property
    @pulumi.getter(name="connectionStrings")
    def connection_strings(self) -> pulumi.Input[Optional['AdvancedClusterConnectionStringsArgs']]:
        """
    ...
    def connection_strings(self, value: pulumi.Input[Optional['AdvancedClusterConnectionStringsArgs']]):
    ...
    @replication_specs.setter
    def replication_specs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AdvancedClusterReplicationSpecArgs']]]]):
        pulumi.set(self, "replication_specs", value)
...
class AdvancedCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 accept_data_risks_and_force_replica_set_reconfig: pulumi.Input[Optional[_builtins.str]] = None,
                 adaptive_capacity: pulumi.Input[Optional[_builtins.str]] = None,
                 advanced_configuration: pulumi.Input[Optional[Union['AdvancedClusterAdvancedConfigurationArgs', 'AdvancedClusterAdvancedConfigurationArgsDict', 'outputs.AdvancedClusterAdvancedConfiguration']]] = None,
                 backup_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 paused: pulumi.Input[Optional[_builtins.bool]] = None,
                 pinned_fcv: pulumi.Input[Optional[Union['AdvancedClusterPinnedFcvArgs', 'AdvancedClusterPinnedFcvArgsDict', 'outputs.AdvancedClusterPinnedFcv']]] = None,
                 pit_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 redact_client_log_data: pulumi.Input[Optional[_builtins.bool]] = None,
                 replica_set_scaling_strategy: pulumi.Input[Optional[_builtins.str]] = None,
                 replication_specs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AdvancedClusterReplicationSpecArgs', 'AdvancedClusterReplicationSpecArgsDict', 'outputs.AdvancedClusterReplicationSpec']]]]] = None,
                 retain_backups_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 root_cert_type: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 termination_protection_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 timeouts: pulumi.Input[Optional[Union['AdvancedClusterTimeoutsArgs', 'AdvancedClusterTimeoutsArgsDict', 'outputs.AdvancedClusterTimeouts']]] = None,
                 use_aws_time_based_snapshot_copy_for_fast_initial_sync: pulumi.Input[Optional[_builtins.bool]] = None,
                 use_effective_fields: pulumi.Input[Optional[_builtins.bool]] = None,
                 version_release_system: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        **Key difference:** With `use_effective_fields = true`, your configuration stays clean and represents your intent, while effective specs show the reality of what Atlas has provisioned.
        ...
        1. Disable auto-scaling and set `instance_size` to a value inside your intended new range, then apply. Follow the Manually Updating Specs with use_effective_fields workflow, which also covers disabling disk auto-scaling and the related `oplog_min_retention_hours` requirement.
        2. Re-enable auto-scaling with the new `compute_min_instance_size` and `compute_max_instance_size` bounds, then apply.

        The same process applies to the `analytics_auto_scaling` block, using `analytics_specs.instance_size` in step 1.
        ...
        **Migration recommendation:** Adopt `use_effective_fields = true` in v2.x to prepare for the v3.x transition and benefit from improved auto-scaling workflows immediately. The recommendation is to toggle the flag and remove any existing `lifecycle.ignore_changes` blocks in the same apply, without combining other changes.
        ...
        :param pulumi.Input[_builtins.str] accept_data_risks_and_force_replica_set_reconfig: If reconfiguration is necessary to regain a primary due to a regional outage, submit this field alongside your topology reconfiguration to request a new regional outage resistant topology. Forced reconfigurations during an outage of the majority of electable nodes carry a risk of data loss if replicated writes (even majority committed writes) have not been replicated to the new primary node. MongoDB Atlas docs contain more information. To proceed with an operation which carries that risk, set `accept_data_risks_and_force_replica_set_reconfig` to the current date. Learn more about Reconfiguring a Replica Set during a regional outage [here](https://www.mongodb.com/docs/atlas/reconfigure-replica-set-during-regional-outage/).
        :param pulumi.Input[_builtins.str] adaptive_capacity: Governs adaptive capacity behavior of Azure nodes in single-cloud Azure clusters or multi-cloud clusters that include Azure nodes. Adaptive capacity enables fallback hardware selection when the primary instance family is unavailable. `ENABLED` means the cluster explicitly opts in to adaptive capacity. `DISABLED` means the cluster explicitly opts out; the cluster receives capacity errors instead of being placed on fallback hardware. `null` means the field is unset; Azure clusters use adaptive capacity by default when the feature is enabled at the group level. Setting this field for single-cloud AWS or GCP clusters is a no-op.
        :param pulumi.Input[Union['AdvancedClusterAdvancedConfigurationArgs', 'AdvancedClusterAdvancedConfigurationArgsDict', 'outputs.AdvancedClusterAdvancedConfiguration']] advanced_configuration: Additional settings for an Atlas cluster.
        :param pulumi.Input[_builtins.bool] backup_enabled: Flag that indicates whether the cluster can perform backups.
               If `true`, the cluster can perform backups. You must set this value to `true` for NVMe clusters.
        ...
        :param pulumi.Input[Union['AdvancedClusterPinnedFcvArgs', 'AdvancedClusterPinnedFcvArgsDict', 'outputs.AdvancedClusterPinnedFcv']] pinned_fcv: Pins the Feature Compatibility Version (FCV) to the current MongoDB version with a provided expiration date. To unpin the FCV the `pinned_fcv` attribute must be removed. This operation can take several minutes as the request processes through the MongoDB data plane. Once FCV is unpinned it will not be possible to downgrade the `mongo_db_major_version`. It is advised that updates to `pinned_fcv` are done isolated from other cluster changes. If a plan contains multiple changes, the FCV change will be applied first. If FCV is unpinned past the expiration date the `pinned_fcv` attribute must be removed. The following [knowledge hub article](https://kb.corp.mongodb.com/article/000021785/) and [FCV documentation](https://www.mongodb.com/docs/atlas/tutorial/major-version-change/#manage-feature-compatibility--fcv--during-upgrades) can be referenced for more details. See below.
        :param pulumi.Input[_builtins.bool] pit_enabled: Flag that indicates if the cluster uses Continuous Cloud Backup.
        :param pulumi.Input[_builtins.str] project_id: Unique ID for the project to create the cluster, also known as `groupId` in the official documentation.
        :param pulumi.Input[_builtins.bool] redact_client_log_data: Flag that enables or disables log redaction, see the [manual](https://www.mongodb.com/docs/manual/administration/monitoring/#log-redaction) for more information. Use this in conjunction with Encryption at Rest and TLS/SSL (Transport Encryption) to assist compliance with regulatory requirements. **Note**: Changing this setting on a cluster will trigger a rolling restart as soon as the cluster is updated.
        :param pulumi.Input[_builtins.str] replica_set_scaling_strategy: Replica set scaling mode for your cluster. Valid values are `WORKLOAD_TYPE`, `SEQUENTIAL` and `NODE_TYPE`. By default, Atlas scales under `WORKLOAD_TYPE`. This mode allows Atlas to scale your analytics nodes in parallel to your operational nodes. When configured as `SEQUENTIAL`, Atlas scales all nodes sequentially. This mode is intended for steady-state workloads and applications performing latency-sensitive secondary reads. When configured as `NODE_TYPE`, Atlas scales your electable nodes in parallel with your read-only and analytics nodes. This mode is intended for large, dynamic workloads requiring frequent and timely cluster tier scaling. This is the fastest scaling strategy, but it might impact latency of workloads when performing extensive secondary reads. [Modify the Replica Set Scaling Mode](https://www.mongodb.com/docs/atlas/cluster-additional-settings/#configure-replica-set-scaling-mode)
        :param pulumi.Input[Sequence[pulumi.Input[Union['AdvancedClusterReplicationSpecArgs', 'AdvancedClusterReplicationSpecArgsDict', 'outputs.AdvancedClusterReplicationSpec']]]] replication_specs: List of settings that configure your cluster regions. This attribute has one object per shard representing node configurations in each shard. For replica sets there is only one object representing node configurations. The `replication_specs` configuration for all shards within the same zone must be the same, with the exception of `instance_size` and `disk_iops` that can scale independently.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["adaptive_capacity"] = adaptive_capacity
    ...
    def get(resource_name: str,
            ...
            use_aws_time_based_snapshot_copy_for_fast_initial_sync: pulumi.Input[Optional[_builtins.bool]] = None,
            use_effective_fields: pulumi.Input[Optional[_builtins.bool]] = None,
            version_release_system: pulumi.Input[Optional[_builtins.str]] = None) -> 'AdvancedCluster':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="adaptiveCapacity")
    def adaptive_capacity(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Governs adaptive capacity behavior of Azure nodes in single-cloud Azure clusters or multi-cloud clusters that include Azure nodes. Adaptive capacity enables fallback hardware selection when the primary instance family is unavailable. `ENABLED` means the cluster explicitly opts in to adaptive capacity. `DISABLED` means the cluster explicitly opts out; the cluster receives capacity errors instead of being placed on fallback hardware. `null` means the field is unset; Azure clusters use adaptive capacity by default when the feature is enabled at the group level. Setting this field for single-cloud AWS or GCP clusters is a no-op.
        """
        return pulumi.get(self, "adaptive_capacity")
