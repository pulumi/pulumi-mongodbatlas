...
class CustomDnsConfigurationClusterAwsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Indicates whether the project's clusters deployed to AWS use custom DNS. If `true`, the `Get All Clusters` and `Get One Cluster` endpoints return the `connectionStrings.private` and `connectionStrings.privateSrv` fields for clusters deployed to AWS .
...
@pulumi.type_token("mongodbatlas:index/customDnsConfigurationClusterAws:CustomDnsConfigurationClusterAws")
class CustomDnsConfigurationClusterAws(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomDnsConfigurationClusterAws':
        """
