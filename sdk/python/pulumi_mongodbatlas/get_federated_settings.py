...
class GetFederatedSettingsResult:
    ...
    def federated_domains(self) -> Sequence[_builtins.str]:
        """
    ...
    def has_role_mappings(self) -> _builtins.bool:
        """
    ...
    def identity_provider_status(self) -> _builtins.str:
        """
...
def get_federated_settings(org_id: Optional[_builtins.str] = None,
