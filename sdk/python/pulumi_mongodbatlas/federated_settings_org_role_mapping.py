...
class FederatedSettingsOrgRoleMappingArgs:
    def __init__(__self__, *,
                 external_group_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] external_group_name: Unique human-readable label that identifies the identity provider group to which this role mapping applies.
    ...
    def external_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def external_group_name(self, value: pulumi.Input[builtins.str]):
...
class _FederatedSettingsOrgRoleMappingState:
    def __init__(__self__, *,
                 external_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 role_mapping_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] org_id: Unique 24-hexadecimal digit string that identifies the organization that contains your projects.
        :param pulumi.Input[Sequence[pulumi.Input['FederatedSettingsOrgRoleMappingRoleAssignmentArgs']]] role_assignments: Atlas roles and the unique identifiers of the groups and organizations associated with each role.
        :param pulumi.Input[builtins.str] role_mapping_id: Unique 24-hexadecimal digit string that identifies this role mapping.
        """
    ...
    @property
    @pulumi.getter(name="externalGroupName")
    def external_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique human-readable label that identifies the identity provider group to which this role mapping applies.
        """
        return pulumi.get(self, "external_group_name")
    ...
    @external_group_name.setter
    def external_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_group_name", value)
    ...
    def role_mapping_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def role_mapping_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FederatedSettingsOrgRoleMapping(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            org_id: Optional[pulumi.Input[builtins.str]] = None,
            role_assignments: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FederatedSettingsOrgRoleMappingRoleAssignmentArgs', 'FederatedSettingsOrgRoleMappingRoleAssignmentArgsDict']]]]] = None,
            role_mapping_id: Optional[pulumi.Input[builtins.str]] = None) -> 'FederatedSettingsOrgRoleMapping':
        """
    ...
    @property
    @pulumi.getter(name="externalGroupName")
    def external_group_name(self) -> pulumi.Output[builtins.str]:
        """
        Unique human-readable label that identifies the identity provider group to which this role mapping applies.
        """
        return pulumi.get(self, "external_group_name")
    ...
    @property
    @pulumi.getter(name="roleMappingId")
    def role_mapping_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique 24-hexadecimal digit string that identifies this role mapping.
        """
        return pulumi.get(self, "role_mapping_id")
