...
def get_shared_tier_snapshot(cluster_name: Optional[builtins.str] = None,
...
def get_shared_tier_snapshot_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
