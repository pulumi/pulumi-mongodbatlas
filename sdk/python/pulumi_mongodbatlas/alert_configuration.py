...
class AlertConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] event_type: The type of event that will trigger an alert.
        ...
        :param pulumi.Input[builtins.str] project_id: The ID of the project where the alert configuration will create.
        :param pulumi.Input[builtins.bool] enabled: It is not required, but If the attribute is omitted, by default will be false, and the configuration would be disabled. You must set true to enable the configuration.
        """
...
class _AlertConfigurationState:
    def __init__(__self__, *,
                 alert_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] alert_configuration_id: Unique identifier for the alert configuration.
        :param pulumi.Input[builtins.str] created: Timestamp in ISO 8601 date and time format in UTC when this alert configuration was created.
        :param pulumi.Input[builtins.bool] enabled: It is not required, but If the attribute is omitted, by default will be false, and the configuration would be disabled. You must set true to enable the configuration.
        :param pulumi.Input[builtins.str] event_type: The type of event that will trigger an alert.
               ...
               > **NOTE:** If `event_type` is set to `OUTSIDE_METRIC_THRESHOLD` or `OUTSIDE_SERVERLESS_METRIC_THRESHOLD`, the `metric_threshold_config` field must also be configured.
        :param pulumi.Input[builtins.str] project_id: The ID of the project where the alert configuration will create.
        :param pulumi.Input[builtins.str] updated: Timestamp in ISO 8601 date and time format in UTC when this alert configuration was last updated.
        """
    ...
    def alert_configuration_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_configuration_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AlertConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            threshold_config: Optional[pulumi.Input[Union['AlertConfigurationThresholdConfigArgs', 'AlertConfigurationThresholdConfigArgsDict']]] = None,
            updated: Optional[pulumi.Input[builtins.str]] = None) -> 'AlertConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="alertConfigurationId")
    def alert_configuration_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier for the alert configuration.
        """
        return pulumi.get(self, "alert_configuration_id")
