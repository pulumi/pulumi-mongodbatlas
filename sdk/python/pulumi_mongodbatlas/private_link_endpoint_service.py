...
class PrivateLinkEndpointServiceArgs:
    def __init__(__self__, *,
                 ...
                 private_link_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] endpoint_service_id: Unique identifier of the interface endpoint you created in your VPC with the `AWS`, `AZURE` or `GCP` resource.
        :param pulumi.Input[builtins.str] private_link_id: Unique identifier of the `AWS` or `AZURE` PrivateLink connection which is created by `PrivateLinkEndpoint` resource.
        :param pulumi.Input[builtins.str] project_id: Unique identifier for the project.
        :param pulumi.Input[builtins.str] provider_name: Cloud provider for which you want to create a private endpoint. Atlas accepts `AWS`, `AZURE` or `GCP`.
        ...
        :param pulumi.Input[builtins.str] gcp_project_id: Unique identifier of the GCP project in which you created your endpoints. Only for `GCP`.
        :param pulumi.Input[builtins.str] private_endpoint_ip_address: Private IP address of the private endpoint network interface you created in your Azure VNet. Only for `AZURE`.
        """
    ...
    def private_link_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def private_link_id(self, value: pulumi.Input[builtins.str]):
...
class _PrivateLinkEndpointServiceState:
    def __init__(__self__, *,
                 aws_connection_status: Optional[pulumi.Input[builtins.str]] = None,
                 azure_status: Optional[pulumi.Input[builtins.str]] = None,
                 delete_requested: Optional[pulumi.Input[builtins.bool]] = None,
                 endpoint_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_service_id: Optional[pulumi.Input[builtins.str]] = None,
                 endpoints: Optional[pulumi.Input[Sequence[pulumi.Input['PrivateLinkEndpointServiceEndpointArgs']]]] = None,
                 error_message: Optional[pulumi.Input[builtins.str]] = None,
                 gcp_project_id: Optional[pulumi.Input[builtins.str]] = None,
                 gcp_status: Optional[pulumi.Input[builtins.str]] = None,
                 interface_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
                 private_endpoint_connection_name: Optional[pulumi.Input[builtins.str]] = None,
                 private_endpoint_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 private_endpoint_resource_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] aws_connection_status: Status of the interface endpoint for AWS.
        ...
        :param pulumi.Input[builtins.str] azure_status: Status of the interface endpoint for AZURE.
               Returns one of the following values:
               * `INITIATING` - Atlas has not yet accepted the connection to your private endpoint.
               * `AVAILABLE` - Atlas approved the connection to your private endpoint.
               * `FAILED` - Atlas failed to accept the connection your private endpoint.
               * `DELETING` - Atlas is removing the connection to your private endpoint from the Private Link service.
        :param pulumi.Input[builtins.bool] delete_requested: Indicates if Atlas received a request to remove the interface endpoint from the private endpoint connection.
        :param pulumi.Input[builtins.str] endpoint_group_name: (Optional) Unique identifier of the endpoint group. The endpoint group encompasses all of the endpoints that you created in GCP.
        :param pulumi.Input[builtins.str] endpoint_service_id: Unique identifier of the interface endpoint you created in your VPC with the `AWS`, `AZURE` or `GCP` resource.
        :param pulumi.Input[Sequence[pulumi.Input['PrivateLinkEndpointServiceEndpointArgs']]] endpoints: Collection of individual private endpoints that comprise your endpoint group. Only for `GCP`. See below.
        :param pulumi.Input[builtins.str] error_message: Error message pertaining to the interface endpoint. Returns null if there are no errors.
        :param pulumi.Input[builtins.str] gcp_project_id: Unique identifier of the GCP project in which you created your endpoints. Only for `GCP`.
        :param pulumi.Input[builtins.str] gcp_status: Status of the interface endpoint for GCP.
               Returns one of the following values:
               * `INITIATING` - Atlas has not yet accepted the connection to your private endpoint.
               * `AVAILABLE` - Atlas approved the connection to your private endpoint.
               * `FAILED` - Atlas failed to accept the connection your private endpoint.
               * `DELETING` - Atlas is removing the connection to your private endpoint from the Private Link service.
        :param pulumi.Input[builtins.str] interface_endpoint_id: Unique identifier of the interface endpoint.
        :param pulumi.Input[builtins.str] private_endpoint_connection_name: Name of the connection for this private endpoint that Atlas generates.
        :param pulumi.Input[builtins.str] private_endpoint_ip_address: Private IP address of the private endpoint network interface you created in your Azure VNet. Only for `AZURE`.
        :param pulumi.Input[builtins.str] private_endpoint_resource_id: Unique identifier of the private endpoint.
        :param pulumi.Input[builtins.str] private_link_id: Unique identifier of the `AWS` or `AZURE` PrivateLink connection which is created by `PrivateLinkEndpoint` resource.
        :param pulumi.Input[builtins.str] project_id: Unique identifier for the project.
        :param pulumi.Input[builtins.str] provider_name: Cloud provider for which you want to create a private endpoint. Atlas accepts `AWS`, `AZURE` or `GCP`.
        """
    ...
    def aws_connection_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aws_connection_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aws_connection_status", value)

    @property
    @pulumi.getter(name="azureStatus")
    def azure_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @azure_status.setter
    def azure_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "azure_status", value)

    @property
    @pulumi.getter(name="deleteRequested")
    def delete_requested(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def delete_requested(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "delete_requested", value)

    @property
    @pulumi.getter(name="endpointGroupName")
    def endpoint_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def gcp_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @gcp_status.setter
    def gcp_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "gcp_status", value)

    @property
    @pulumi.getter(name="interfaceEndpointId")
    def interface_endpoint_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def interface_endpoint_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def private_endpoint_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_endpoint_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PrivateLinkEndpointService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            private_link_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            provider_name: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateLinkEndpointService':
        """
    ...
    @property
    @pulumi.getter(name="awsConnectionStatus")
    def aws_connection_status(self) -> pulumi.Output[builtins.str]:
        """
        Status of the interface endpoint for AWS.
        Returns one of the following values:
        * `NONE` - Atlas created the network load balancer and VPC endpoint service, but AWS hasn't yet created the VPC endpoint.
    ...
    @property
    @pulumi.getter(name="azureStatus")
    def azure_status(self) -> pulumi.Output[builtins.str]:
        """
        Status of the interface endpoint for AZURE.
        Returns one of the following values:
        * `INITIATING` - Atlas has not yet accepted the connection to your private endpoint.
    ...
    @property
    @pulumi.getter(name="deleteRequested")
    def delete_requested(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if Atlas received a request to remove the interface endpoint from the private endpoint connection.
        """
        return pulumi.get(self, "delete_requested")
    ...
    @property
    @pulumi.getter(name="endpointGroupName")
    def endpoint_group_name(self) -> pulumi.Output[builtins.str]:
        """
        (Optional) Unique identifier of the endpoint group. The endpoint group encompasses all of the endpoints that you created in GCP.
        """
        return pulumi.get(self, "endpoint_group_name")
    ...
    @property
    @pulumi.getter(name="gcpStatus")
    def gcp_status(self) -> pulumi.Output[builtins.str]:
        """
        Status of the interface endpoint for GCP.
        Returns one of the following values:
        * `INITIATING` - Atlas has not yet accepted the connection to your private endpoint.
    ...
    @property
    @pulumi.getter(name="interfaceEndpointId")
    def interface_endpoint_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier of the interface endpoint.
        """
        return pulumi.get(self, "interface_endpoint_id")
    ...
    @property
    @pulumi.getter(name="privateEndpointResourceId")
    def private_endpoint_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier of the private endpoint.
        """
        return pulumi.get(self, "private_endpoint_resource_id")
