...
def get_api_key_project_assignments(project_id: Optional[builtins.str] = None,
...
def get_api_key_project_assignments_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
