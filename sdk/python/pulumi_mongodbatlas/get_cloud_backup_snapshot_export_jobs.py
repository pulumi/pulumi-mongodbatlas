...
def get_cloud_backup_snapshot_export_jobs(cluster_name: Optional[_builtins.str] = None,
...
def get_cloud_backup_snapshot_export_jobs_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
