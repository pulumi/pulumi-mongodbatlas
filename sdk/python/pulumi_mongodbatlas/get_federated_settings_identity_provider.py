...
class GetFederatedSettingsIdentityProviderResult:
    ...
    def associated_domains(self) -> Sequence[builtins.str]:
        """
    ...
    def requested_scopes(self) -> Sequence[builtins.str]:
        """
    ...
    def sso_debug_enabled(self) -> builtins.bool:
        """
...
def get_federated_settings_identity_provider(federation_settings_id: Optional[builtins.str] = None,
    ...
    :param builtins.str identity_provider_id: Unique 24-hexadecimal digit string that identifies the IdP.
    """
    __args__ = dict()
...
def get_federated_settings_identity_provider_output(federation_settings_id: Optional[pulumi.Input[builtins.str]] = None,
