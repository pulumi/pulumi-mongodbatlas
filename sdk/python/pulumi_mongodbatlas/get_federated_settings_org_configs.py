...
def get_federated_settings_org_configs(federation_settings_id: Optional[builtins.str] = None,
...
def get_federated_settings_org_configs_output(federation_settings_id: Optional[pulumi.Input[builtins.str]] = None,
