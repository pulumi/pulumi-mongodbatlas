...
class GetFederatedSettingsIdentityProvidersResult:
    ...
    def idp_types(self) -> Optional[Sequence[_builtins.str]]:
...
def get_federated_settings_identity_providers(federation_settings_id: Optional[_builtins.str] = None,
                                              idp_types: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] protocols: The protocols of the target identity providers. Valid values are `SAML` and `OIDC`.
    """
    __args__ = dict()
