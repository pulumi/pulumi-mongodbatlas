...
class GetFederatedSettingsIdentityProvidersResult:
    ...
    def idp_types(self) -> Optional[Sequence[builtins.str]]:
...
def get_federated_settings_identity_providers(federation_settings_id: Optional[builtins.str] = None,
                                              idp_types: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] idp_types: The types of the target identity providers. Valid values are `WORKFORCE` and `WORKLOAD`.
    :param Sequence[builtins.str] protocols: The protocols of the target identity providers. Valid values are `SAML` and `OIDC`.
    """
    __args__ = dict()
...
def get_federated_settings_identity_providers_output(federation_settings_id: Optional[pulumi.Input[builtins.str]] = None,
                                                     idp_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                     protocols: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
