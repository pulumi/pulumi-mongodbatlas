...
class CloudBackupScheduleArgs:
    def __init__(__self__, *,
                 ...
                 auto_export_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 use_org_and_group_names_in_export_prefix: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a CloudBackupSchedule resource.
        :param pulumi.Input[builtins.str] cluster_name: The name of the Atlas cluster that contains the snapshot backup policy you want to retrieve.
        :param pulumi.Input[builtins.str] project_id: The unique identifier of the project for the Atlas cluster.
        :param pulumi.Input[builtins.bool] auto_export_enabled: Flag that indicates whether MongoDB Cloud automatically exports Cloud Backup Snapshots to the Export Bucket. Once enabled, it must be disabled by explicitly setting the value to `false`. Value can be one of the following:
        ...
        :param pulumi.Input[builtins.int] reference_hour_of_day: UTC Hour of day between 0 and 23, inclusive, representing which hour of the day that Atlas takes snapshots for backup policy items.
        :param pulumi.Input[builtins.int] reference_minute_of_hour: UTC Minutes after `reference_hour_of_day` that Atlas takes snapshots for backup policy items. Must be between 0 and 59, inclusive.
        :param pulumi.Input[builtins.int] restore_window_days: Number of days back in time you can restore to with point-in-time accuracy. Must be a positive, non-zero integer.
        :param pulumi.Input[builtins.bool] use_org_and_group_names_in_export_prefix: Specify true to use organization and project names instead of organization and project UUIDs in the path for the metadata files that Atlas uploads to your bucket after it finishes exporting the snapshots. To learn more about the metadata files that Atlas uploads, see [Export Cloud Backup Snapshot](https://www.mongodb.com/docs/atlas/backup/cloud-backup/export/#std-label-cloud-provider-snapshot-export).
        """
    ...
    def auto_export_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_export_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def use_org_and_group_names_in_export_prefix(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_org_and_group_names_in_export_prefix(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _CloudBackupScheduleState:
    def __init__(__self__, *,
                 ...
                 copy_settings: Optional[pulumi.Input[Sequence[pulumi.Input['CloudBackupScheduleCopySettingArgs']]]] = None,
                 export: Optional[pulumi.Input['CloudBackupScheduleExportArgs']] = None,
                 id_policy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_export_enabled: Flag that indicates whether MongoDB Cloud automatically exports Cloud Backup Snapshots to the Export Bucket. Once enabled, it must be disabled by explicitly setting the value to `false`. Value can be one of the following:
               * true - Enables automatic export of cloud backup snapshots to the Export Bucket.
               * false - Disables automatic export of cloud backup snapshots to the Export Bucket. (default)
        :param pulumi.Input[builtins.str] cluster_id: Unique identifier of the Atlas cluster.
        :param pulumi.Input[builtins.str] cluster_name: The name of the Atlas cluster that contains the snapshot backup policy you want to retrieve.
        :param pulumi.Input[Sequence[pulumi.Input['CloudBackupScheduleCopySettingArgs']]] copy_settings: List that contains a document for each copy setting item in the desired backup policy. See below
        :param pulumi.Input['CloudBackupScheduleExportArgs'] export: Policy for automatically exporting Cloud Backup Snapshots. `auto_export_enabled` must be set to true when defining this attribute. See below
        :param pulumi.Input[builtins.str] id_policy: Unique identifier of the backup policy.
        :param pulumi.Input[builtins.str] next_snapshot: Timestamp in the number of seconds that have elapsed since the UNIX epoch when Atlas takes the next snapshot.
        :param pulumi.Input['CloudBackupSchedulePolicyItemDailyArgs'] policy_item_daily: Daily policy item. See below
        :param pulumi.Input['CloudBackupSchedulePolicyItemHourlyArgs'] policy_item_hourly: Hourly policy item. See below
        :param pulumi.Input[Sequence[pulumi.Input['CloudBackupSchedulePolicyItemMonthlyArgs']]] policy_item_monthlies: Monthly policy item. See below
        :param pulumi.Input[Sequence[pulumi.Input['CloudBackupSchedulePolicyItemWeeklyArgs']]] policy_item_weeklies: Weekly policy item. See below
    ...
    def id_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @id_policy.setter
    def id_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CloudBackupSchedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            restore_window_days: Optional[pulumi.Input[builtins.int]] = None,
            update_snapshots: Optional[pulumi.Input[builtins.bool]] = None,
            use_org_and_group_names_in_export_prefix: Optional[pulumi.Input[builtins.bool]] = None) -> 'CloudBackupSchedule':
        """
    ...
    @property
    @pulumi.getter(name="autoExportEnabled")
    def auto_export_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Flag that indicates whether MongoDB Cloud automatically exports Cloud Backup Snapshots to the Export Bucket. Once enabled, it must be disabled by explicitly setting the value to `false`. Value can be one of the following:
        * true - Enables automatic export of cloud backup snapshots to the Export Bucket.
        * false - Disables automatic export of cloud backup snapshots to the Export Bucket. (default)
    ...
    @property
    @pulumi.getter(name="idPolicy")
    def id_policy(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier of the backup policy.
        """
        return pulumi.get(self, "id_policy")
    ...
    @property
    @pulumi.getter(name="nextSnapshot")
    def next_snapshot(self) -> pulumi.Output[builtins.str]:
        """
        Timestamp in the number of seconds that have elapsed since the UNIX epoch when Atlas takes the next snapshot.
        """
        return pulumi.get(self, "next_snapshot")
    ...
    @property
    @pulumi.getter(name="referenceHourOfDay")
    def reference_hour_of_day(self) -> pulumi.Output[builtins.int]:
        """
        UTC Hour of day between 0 and 23, inclusive, representing which hour of the day that Atlas takes snapshots for backup policy items.
        """
        return pulumi.get(self, "reference_hour_of_day")
    ...
    @property
    @pulumi.getter(name="referenceMinuteOfHour")
    def reference_minute_of_hour(self) -> pulumi.Output[builtins.int]:
        """
        UTC Minutes after `reference_hour_of_day` that Atlas takes snapshots for backup policy items. Must be between 0 and 59, inclusive.
        """
        return pulumi.get(self, "reference_minute_of_hour")
    ...
    @property
    @pulumi.getter(name="updateSnapshots")
    def update_snapshots(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "update_snapshots")

    @property
    @pulumi.getter(name="useOrgAndGroupNamesInExportPrefix")
    def use_org_and_group_names_in_export_prefix(self) -> pulumi.Output[builtins.bool]:
        """
        Specify true to use organization and project names instead of organization and project UUIDs in the path for the metadata files that Atlas uploads to your bucket after it finishes exporting the snapshots. To learn more about the metadata files that Atlas uploads, see [Export Cloud Backup Snapshot](https://www.mongodb.com/docs/atlas/backup/cloud-backup/export/#std-label-cloud-provider-snapshot-export).
        """
        return pulumi.get(self, "use_org_and_group_names_in_export_prefix")
