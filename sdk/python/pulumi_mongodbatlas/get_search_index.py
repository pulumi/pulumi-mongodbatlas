...
class GetSearchIndexResult:
    ...
    def mappings_dynamic(self) -> builtins.bool:
        """
...
def get_search_index(cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_name: The name of the cluster containing the collection with one or more Atlas Search indexes.
    :param builtins.str index_id: The unique identifier of the Atlas Search index. Use the `get_search_indexes`datasource to find the IDs of all Atlas Search indexes.
    :param builtins.str project_id: The unique identifier for the [project](https://docs.atlas.mongodb.com/organizations-projects/#std-label-projects) that contains the specified cluster.
    """
    __args__ = dict()
...
def get_search_index_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
