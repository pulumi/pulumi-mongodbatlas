...
class CloudBackupSnapshotExportBucketArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket_name: Name of the bucket that the provided role ID is authorized to access.
        :param pulumi.Input[builtins.str] cloud_provider: Name of the provider of the cloud service where Atlas can access the S3 bucket.
        :param pulumi.Input[builtins.str] project_id: The unique identifier of the project for the Atlas cluster.
        :param pulumi.Input[builtins.str] iam_role_id: Unique identifier of the role that Atlas can use to access the bucket. Required if `cloud_provider` is set to `AWS`.
        :param pulumi.Input[builtins.str] role_id: Unique identifier of the Azure Service Principal that Atlas can use to access the Azure Blob Storage Container. Required if `cloud_provider` is set to `AZURE`.
        :param pulumi.Input[builtins.str] service_url: URL that identifies the blob Endpoint of the Azure Blob Storage Account. Required if `cloud_provider` is set to `AZURE`.
        :param pulumi.Input[builtins.str] tenant_id: This field is ignored; the `mongodbatlas_cloud_provider_access_authorization.azure.tenant_id` is used instead and returned as an attribute. UUID that identifies the Azure Active Directory Tenant ID.
        """
...
class _CloudBackupSnapshotExportBucketState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket_name: Name of the bucket that the provided role ID is authorized to access.
        :param pulumi.Input[builtins.str] cloud_provider: Name of the provider of the cloud service where Atlas can access the S3 bucket.
        :param pulumi.Input[builtins.str] export_bucket_id: Unique identifier of the snapshot export bucket.
        :param pulumi.Input[builtins.str] iam_role_id: Unique identifier of the role that Atlas can use to access the bucket. Required if `cloud_provider` is set to `AWS`.
        :param pulumi.Input[builtins.str] project_id: The unique identifier of the project for the Atlas cluster.
        :param pulumi.Input[builtins.str] role_id: Unique identifier of the Azure Service Principal that Atlas can use to access the Azure Blob Storage Container. Required if `cloud_provider` is set to `AZURE`.
        :param pulumi.Input[builtins.str] service_url: URL that identifies the blob Endpoint of the Azure Blob Storage Account. Required if `cloud_provider` is set to `AZURE`.
...
class CloudBackupSnapshotExportBucket(pulumi.CustomResource):
    ...
    pulumi_type = "mongodbatlas:index/cloudBackupSnapshotExportBucket:CloudBackupSnapshotExportBucket"
    ...
    def get(resource_name: str,
            ...
            role_id: Optional[pulumi.Input[builtins.str]] = None,
            service_url: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CloudBackupSnapshotExportBucket':
        """
    ...
    @property
    @pulumi.getter(name="iamRoleId")
    def iam_role_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Unique identifier of the role that Atlas can use to access the bucket. Required if `cloud_provider` is set to `AWS`.
        """
        return pulumi.get(self, "iam_role_id")
    ...
    @property
    @pulumi.getter(name="serviceUrl")
    def service_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URL that identifies the blob Endpoint of the Azure Blob Storage Account. Required if `cloud_provider` is set to `AZURE`.
        """
        return pulumi.get(self, "service_url")
