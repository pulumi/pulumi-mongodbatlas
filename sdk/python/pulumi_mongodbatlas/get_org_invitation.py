...
class GetOrgInvitationResult:
    ...
    def teams_ids(self) -> Sequence[builtins.str]:
        """
...
def get_org_invitation(invitation_id: Optional[builtins.str] = None,
    ...
    :param builtins.str invitation_id: Unique 24-hexadecimal digit string that identifies the invitation in Atlas.
    :param builtins.str org_id: Unique 24-hexadecimal digit string that identifies the organization to which you invited the user.
    :param builtins.str username: Email address of the invited user. This is the address to which Atlas sends the invite. If the user accepts the invitation, they log in to Atlas with this username.
    """
    __args__ = dict()
...
def get_org_invitation_output(invitation_id: Optional[pulumi.Input[builtins.str]] = None,
