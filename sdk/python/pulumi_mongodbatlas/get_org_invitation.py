...
class GetOrgInvitationResult:
    ...
    def teams_ids(self) -> Sequence[_builtins.str]:
        """
...
def get_org_invitation(invitation_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str org_id: Unique 24-hexadecimal digit string that identifies the organization to which you invited the user.
