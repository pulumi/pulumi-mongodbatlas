...
def get_network_peering(peering_id: Optional[builtins.str] = None,
    ...
    :param builtins.str peering_id: Atlas assigned unique ID for the peering connection.
...
def get_network_peering_output(peering_id: Optional[pulumi.Input[builtins.str]] = None,
