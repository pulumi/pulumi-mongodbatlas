...
def get_network_peering(peering_id: Optional[str] = None,
    ...
    return AwaitableGetNetworkPeeringResult(
        accepter_region_name=__ret__.accepter_region_name,
        atlas_cidr_block=__ret__.atlas_cidr_block,
        atlas_id=__ret__.atlas_id,
        aws_account_id=__ret__.aws_account_id,
        azure_directory_id=__ret__.azure_directory_id,
        ...
        error_state=__ret__.error_state,
        error_state_name=__ret__.error_state_name,
        ...
        route_table_cidr_block=__ret__.route_table_cidr_block,
