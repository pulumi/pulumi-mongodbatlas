...
def get_custom_db_roles(project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: The unique ID for the project to get all custom db roles.
    """
    __args__ = dict()
...
def get_custom_db_roles_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
