...
class OrganizationArgs:
    def __init__(__self__, *,
                 ...
                 org_owner_id: pulumi.Input[builtins.str],
                 role_names: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 api_access_list_required: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] federation_settings_id: Unique 24-hexadecimal digit string that identifies the federation to link the newly created organization to. If specified, the proposed Organization Owner of the new organization must have the Organization Owner role in an organization associated with the federation.
        :param pulumi.Input[builtins.bool] gen_ai_features_enabled: Flag that indicates whether this organization has access to generative AI features. This setting only applies to Atlas Commercial and defaults to `true`. With this setting on, Project Owners may be able to enable or disable individual AI features at the project level. To learn more, see https://www.mongodb.com/docs/generative-ai-faq/.
    ...
    def org_owner_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @org_owner_id.setter
    def org_owner_id(self, value: pulumi.Input[builtins.str]):
    ...
    def api_access_list_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def api_access_list_required(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def gen_ai_features_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def gen_ai_features_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "gen_ai_features_enabled", value)

    @property
    @pulumi.getter(name="multiFactorAuthRequired")
    def multi_factor_auth_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def multi_factor_auth_required(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def restrict_employee_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
...
class _OrganizationState:
    ...
    @property
    @pulumi.getter(name="orgOwnerId")
    def org_owner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique 24-hexadecimal digit string that identifies the Atlas user that you want to assign the Organization Owner role. This user must be a member of the same organization as the calling API key.  This is only required when authenticating with Programmatic API Keys. [MongoDB Atlas Admin API - Get User By Username](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/MongoDB-Cloud-Users/operation/getUserByUsername)
        """
        return pulumi.get(self, "org_owner_id")
    ...
    @org_owner_id.setter
    def org_owner_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "org_owner_id", value)
...
class Organization(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="apiAccessListRequired")
    def api_access_list_required(self) -> pulumi.Output[builtins.bool]:
        """
        Flag that indicates whether to require API operations to originate from an IP Address added to the API access list for the specified organization.
        """
        return pulumi.get(self, "api_access_list_required")
    ...
    @property
    @pulumi.getter(name="federationSettingsId")
    def federation_settings_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Unique 24-hexadecimal digit string that identifies the federation to link the newly created organization to. If specified, the proposed Organization Owner of the new organization must have the Organization Owner role in an organization associated with the federation.
        """
        return pulumi.get(self, "federation_settings_id")
    ...
    @property
    @pulumi.getter(name="genAiFeaturesEnabled")
    def gen_ai_features_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag that indicates whether this organization has access to generative AI features. This setting only applies to Atlas Commercial and defaults to `true`. With this setting on, Project Owners may be able to enable or disable individual AI features at the project level. To learn more, see https://www.mongodb.com/docs/generative-ai-faq/.
        """
        return pulumi.get(self, "gen_ai_features_enabled")
    ...
    @property
    @pulumi.getter(name="multiFactorAuthRequired")
    def multi_factor_auth_required(self) -> pulumi.Output[builtins.bool]:
        """
        Flag that indicates whether to require users to set up Multi-Factor Authentication (MFA) before accessing the specified organization. To learn more, see: https://www.mongodb.com/docs/atlas/security-multi-factor-authentication/.
        """
        return pulumi.get(self, "multi_factor_auth_required")
    ...
    @property
    @pulumi.getter(name="orgOwnerId")
    def org_owner_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique 24-hexadecimal digit string that identifies the Atlas user that you want to assign the Organization Owner role. This user must be a member of the same organization as the calling API key.  This is only required when authenticating with Programmatic API Keys. [MongoDB Atlas Admin API - Get User By Username](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/MongoDB-Cloud-Users/operation/getUserByUsername)
        """
        return pulumi.get(self, "org_owner_id")
    ...
    @property
    @pulumi.getter(name="restrictEmployeeAccess")
    def restrict_employee_access(self) -> pulumi.Output[builtins.bool]:
        """
        Flag that indicates whether to block MongoDB Support from accessing Atlas infrastructure for any deployment in the specified organization without explicit permission. Once this setting is turned on, you can grant MongoDB Support a 24-hour bypass access to the Atlas deployment to resolve support issues. To learn more, see: https://www.mongodb.com/docs/atlas/security-restrict-support-access/.
        """
        return pulumi.get(self, "restrict_employee_access")
