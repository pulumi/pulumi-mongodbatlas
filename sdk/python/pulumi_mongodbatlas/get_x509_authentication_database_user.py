...
def get_x509_authentication_database_user(project_id: Optional[builtins.str] = None,
...
def get_x509_authentication_database_user_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
