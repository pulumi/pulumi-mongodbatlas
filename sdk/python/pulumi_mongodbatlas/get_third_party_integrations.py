...
def get_third_party_integrations(project_id: Optional[builtins.str] = None,
...
def get_third_party_integrations_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
