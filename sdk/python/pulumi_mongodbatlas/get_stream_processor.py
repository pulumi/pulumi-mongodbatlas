...
def get_stream_processor(instance_name: Optional[builtins.str] = None,
                         processor_name: Optional[builtins.str] = None,
...
def get_stream_processor_output(instance_name: Optional[pulumi.Input[builtins.str]] = None,
