...
def get_cloud_backup_snapshots(cluster_name: Optional[_builtins.str] = None,
...
def get_cloud_backup_snapshots_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
