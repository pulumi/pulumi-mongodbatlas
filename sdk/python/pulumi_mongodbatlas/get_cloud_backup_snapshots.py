...
def get_cloud_backup_snapshots(cluster_name: Optional[str] = None,
    ...
    """
    _get_cloud_backup_snapshots_ provides an Cloud Backup Snapshot datasource. Atlas Cloud Backup Snapshots provide localized backup storage using the native snapshot functionality of the cluster’s cloud service.
