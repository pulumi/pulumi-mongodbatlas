...
class EventTriggerArgs:
    def __init__(__self__, *,
                 ...
                 config_collection: Optional[pulumi.Input[builtins.str]] = None,
                 config_database: Optional[pulumi.Input[builtins.str]] = None,
                 config_full_document: Optional[pulumi.Input[builtins.bool]] = None,
                 config_full_document_before: Optional[pulumi.Input[builtins.bool]] = None,
                 config_match: Optional[pulumi.Input[builtins.str]] = None,
                 config_operation_type: Optional[pulumi.Input[builtins.str]] = None,
                 config_operation_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 config_project: Optional[pulumi.Input[builtins.str]] = None,
                 config_providers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 config_schedule: Optional[pulumi.Input[builtins.str]] = None,
                 config_service_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 unordered: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] config_match: Optional for `DATABASE` type. A [$match](https://docs.mongodb.com/manual/reference/operator/aggregation/match/) expression document that MongoDB Realm includes in the underlying change stream pipeline for the trigger. This is useful when you want to filter change events beyond their operation type. The trigger will only fire if the expression evaluates to true for a given change event.
        :param pulumi.Input[builtins.str] config_operation_type: Required for `AUTHENTICATION` type. The [authentication operation type](https://docs.mongodb.com/realm/triggers/authentication-triggers/#std-label-authentication-event-operation-types) to listen for. Possible Values: `LOGIN`, `CREATE`, `DELETE`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] config_operation_types: Required for `DATABASE` type. The [database event operation types](https://docs.mongodb.com/realm/triggers/database-triggers/#std-label-database-events) to listen for. This must contain at least one value. Possible Values: `INSERT`, `UPDATE`, `REPLACE`, `DELETE`
        :param pulumi.Input[builtins.str] config_project: Optional for `DATABASE` type. A [$project](https://docs.mongodb.com/manual/reference/operator/aggregation/project/) expression document that Realm uses to filter the fields that appear in change event objects.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] config_providers: Required for `AUTHENTICATION` type. A list of one or more [authentication provider](https://docs.mongodb.com/realm/authentication/providers/) id values. The trigger will only listen for authentication events produced by these providers.
        :param pulumi.Input[builtins.str] config_schedule: Required for `SCHEDULED` type. A [cron expression](https://docs.mongodb.com/realm/triggers/cron-expressions/) that defines the trigger schedule.
        :param pulumi.Input[builtins.str] config_service_id: Required for `DATABASE` type. The ID of the MongoDB Service associated with the trigger.
        :param pulumi.Input[builtins.bool] disabled: Default: `false` If `true`, the trigger is disabled.
        ...
        :param pulumi.Input[builtins.str] function_id: The ID of the function associated with the trigger.
        :param pulumi.Input[builtins.str] name: The name of the trigger.
        :param pulumi.Input[builtins.bool] unordered: Only Available for Database Triggers. If true, event ordering is disabled and this trigger can process events in parallel. If false, event ordering is enabled and the trigger executes serially.
        """
    ...
    def config_collection(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def config_collection(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "config_collection", value)

    @property
    @pulumi.getter(name="configDatabase")
    def config_database(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def config_database(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "config_database", value)

    @property
    @pulumi.getter(name="configFullDocument")
    def config_full_document(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def config_full_document(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "config_full_document", value)

    @property
    @pulumi.getter(name="configFullDocumentBefore")
    def config_full_document_before(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "config_full_document_before")

    @config_full_document_before.setter
    def config_full_document_before(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "config_full_document_before", value)

    @property
    @pulumi.getter(name="configMatch")
    def config_match(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @config_match.setter
    def config_match(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "config_match", value)

    @property
    @pulumi.getter(name="configOperationType")
    def config_operation_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def config_operation_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "config_operation_type", value)

    @property
    @pulumi.getter(name="configOperationTypes")
    def config_operation_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def config_operation_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "config_operation_types", value)

    @property
    @pulumi.getter(name="configProject")
    def config_project(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def config_project(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "config_project", value)

    @property
    @pulumi.getter(name="configProviders")
    def config_providers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def config_providers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "config_providers", value)

    @property
    @pulumi.getter(name="configSchedule")
    def config_schedule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def config_schedule(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "config_schedule", value)

    @property
    @pulumi.getter(name="configServiceId")
    def config_service_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def config_service_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def unordered(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @unordered.setter
    def unordered(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _EventTriggerState:
    def __init__(__self__, *,
                 ...
                 config_providers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 config_schedule: Optional[pulumi.Input[builtins.str]] = None,
                 config_schedule_type: Optional[pulumi.Input[builtins.str]] = None,
                 config_service_id: Optional[pulumi.Input[builtins.str]] = None,
                 disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 event_processors: Optional[pulumi.Input['EventTriggerEventProcessorsArgs']] = None,
                 function_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['EventTriggerEventProcessorsArgs'] event_processors: An object where each field name is an event processor ID and each value is an object that configures its corresponding event processor. The following event processors are supported: `AWS_EVENTBRIDGE` For an example configuration object, see [Send Trigger Events to AWS EventBridge](https://docs.mongodb.com/realm/triggers/eventbridge/#std-label-event_processor_example).
               ...
               * `event_processors.0.aws_eventbridge.config_region` - (Optional) Region of AWS Account.
        :param pulumi.Input[builtins.str] function_id: The ID of the function associated with the trigger.
        :param pulumi.Input[builtins.str] function_name: The name of the function associated with the trigger.
        :param pulumi.Input[builtins.str] name: The name of the trigger.
        :param pulumi.Input[builtins.str] project_id: The unique ID for the project to create the trigger.
        :param pulumi.Input[builtins.str] trigger_id: The unique ID of the trigger.
        :param pulumi.Input[builtins.str] type: The type of the trigger. Possible Values: `DATABASE`, `AUTHENTICATION`,`SCHEDULED`
        :param pulumi.Input[builtins.bool] unordered: Only Available for Database Triggers. If true, event ordering is disabled and this trigger can process events in parallel. If false, event ordering is enabled and the trigger executes serially.
        """
    ...
    def config_schedule_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "config_schedule_type")

    @config_schedule_type.setter
    def config_schedule_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EventTrigger(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            trigger_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            unordered: Optional[pulumi.Input[builtins.bool]] = None) -> 'EventTrigger':
        """
    ...
    @property
    @pulumi.getter(name="configCollection")
    def config_collection(self) -> pulumi.Output[builtins.str]:
        """
        Optional for `DATABASE` type. The name of the MongoDB collection that the trigger watches for change events. The collection must be part of the specified database.
        """
        return pulumi.get(self, "config_collection")
    ...
    @property
    @pulumi.getter(name="configDatabase")
    def config_database(self) -> pulumi.Output[builtins.str]:
        """
        Required for `DATABASE` type. The name of the MongoDB database to watch.
        """
        return pulumi.get(self, "config_database")
    ...
    @property
    @pulumi.getter(name="configFullDocument")
    def config_full_document(self) -> pulumi.Output[builtins.bool]:
        """
        Optional for `DATABASE` type. If true, indicates that `UPDATE` change events should include the most current [majority-committed](https://docs.mongodb.com/manual/reference/read-concern-majority/) version of the modified document in the fullDocument field.
        """
        return pulumi.get(self, "config_full_document")
    ...
    @property
    @pulumi.getter(name="configFullDocumentBefore")
    def config_full_document_before(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "config_full_document_before")

    @property
    @pulumi.getter(name="configMatch")
    def config_match(self) -> pulumi.Output[builtins.str]:
        """
        Optional for `DATABASE` type. A [$match](https://docs.mongodb.com/manual/reference/operator/aggregation/match/) expression document that MongoDB Realm includes in the underlying change stream pipeline for the trigger. This is useful when you want to filter change events beyond their operation type. The trigger will only fire if the expression evaluates to true for a given change event.
        """
        return pulumi.get(self, "config_match")
    ...
    @property
    @pulumi.getter(name="configOperationType")
    def config_operation_type(self) -> pulumi.Output[builtins.str]:
        """
        Required for `AUTHENTICATION` type. The [authentication operation type](https://docs.mongodb.com/realm/triggers/authentication-triggers/#std-label-authentication-event-operation-types) to listen for. Possible Values: `LOGIN`, `CREATE`, `DELETE`
        """
        return pulumi.get(self, "config_operation_type")
    ...
    @property
    @pulumi.getter(name="configOperationTypes")
    def config_operation_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Required for `DATABASE` type. The [database event operation types](https://docs.mongodb.com/realm/triggers/database-triggers/#std-label-database-events) to listen for. This must contain at least one value. Possible Values: `INSERT`, `UPDATE`, `REPLACE`, `DELETE`
        """
        return pulumi.get(self, "config_operation_types")
    ...
    @property
    @pulumi.getter(name="configProject")
    def config_project(self) -> pulumi.Output[builtins.str]:
        """
        Optional for `DATABASE` type. A [$project](https://docs.mongodb.com/manual/reference/operator/aggregation/project/) expression document that Realm uses to filter the fields that appear in change event objects.
        """
        return pulumi.get(self, "config_project")
    ...
    @property
    @pulumi.getter(name="configProviders")
    def config_providers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Required for `AUTHENTICATION` type. A list of one or more [authentication provider](https://docs.mongodb.com/realm/authentication/providers/) id values. The trigger will only listen for authentication events produced by these providers.
        """
        return pulumi.get(self, "config_providers")
    ...
    @property
    @pulumi.getter(name="configSchedule")
    def config_schedule(self) -> pulumi.Output[builtins.str]:
        """
        Required for `SCHEDULED` type. A [cron expression](https://docs.mongodb.com/realm/triggers/cron-expressions/) that defines the trigger schedule.
        """
        return pulumi.get(self, "config_schedule")
    ...
    @property
    @pulumi.getter(name="configScheduleType")
    def config_schedule_type(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "config_schedule_type")

    @property
    @pulumi.getter(name="configServiceId")
    def config_service_id(self) -> pulumi.Output[builtins.str]:
        """
        Required for `DATABASE` type. The ID of the MongoDB Service associated with the trigger.
        """
        return pulumi.get(self, "config_service_id")
    ...
    @property
    @pulumi.getter(name="functionId")
    def function_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the function associated with the trigger.
        """
        return pulumi.get(self, "function_id")
    ...
    @property
    @pulumi.getter
    def unordered(self) -> pulumi.Output[builtins.bool]:
        """
        Only Available for Database Triggers. If true, event ordering is disabled and this trigger can process events in parallel. If false, event ordering is enabled and the trigger executes serially.
        """
        return pulumi.get(self, "unordered")
