...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 provider_instance_size_name: pulumi.Input[builtins.str],
                 provider_name: pulumi.Input[builtins.str],
                 accept_data_risks_and_force_replica_set_reconfig: Optional[pulumi.Input[builtins.str]] = None,
                 advanced_configuration: Optional[pulumi.Input['ClusterAdvancedConfigurationArgs']] = None,
                 auto_scaling_compute_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 auto_scaling_compute_scale_down_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 auto_scaling_disk_gb_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 cloud_backup: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 mongo_db_major_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 pit_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 provider_auto_scaling_compute_max_instance_size: Optional[pulumi.Input[builtins.str]] = None,
                 provider_auto_scaling_compute_min_instance_size: Optional[pulumi.Input[builtins.str]] = None,
                 provider_disk_iops: Optional[pulumi.Input[builtins.int]] = None,
                 provider_disk_type_name: Optional[pulumi.Input[builtins.str]] = None,
                 provider_encrypt_ebs_volume: Optional[pulumi.Input[builtins.bool]] = None,
                 provider_region_name: Optional[pulumi.Input[builtins.str]] = None,
                 provider_volume_type: Optional[pulumi.Input[builtins.str]] = None,
                 redact_client_log_data: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 retain_backups_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] accept_data_risks_and_force_replica_set_reconfig: If reconfiguration is necessary to regain a primary due to a regional outage, submit this field alongside your topology reconfiguration to request a new regional outage resistant topology. Forced reconfigurations during an outage of the majority of electable nodes carry a risk of data loss if replicated writes (even majority committed writes) have not been replicated to the new primary node. MongoDB Atlas docs contain more information. To proceed with an operation which carries that risk, set `accept_data_risks_and_force_replica_set_reconfig` to the current date. Learn more about Reconfiguring a Replica Set during a regional outage [here](https://dochub.mongodb.org/core/regional-outage-reconfigure-replica-set).
        :param pulumi.Input[builtins.bool] auto_scaling_compute_scale_down_enabled: Set to `true` to enable the cluster tier to scale down. This option is only available if `autoScaling.compute.enabled` is `true`.
               - If this option is enabled, you must specify a value for `providerSettings.autoScaling.compute.minInstanceSize`
        :param pulumi.Input[builtins.str] backing_provider_name: Cloud service provider on which the server for a multi-tenant cluster is provisioned.
               ...
               - GCP - Google Cloud Platform
               - AZURE - Microsoft Azure
        :param pulumi.Input[builtins.bool] backup_enabled: Legacy Backup - Set to true to enable Atlas legacy backups for the cluster.
        ...
        :param pulumi.Input[builtins.str] cluster_type: Specifies the type of the cluster that you want to modify. You cannot convert a sharded cluster deployment to a replica set deployment.
        ...
        :param pulumi.Input[builtins.float] disk_size_gb: Capacity, in gigabytes, of the host’s root volume. Increase this number to add capacity, up to a maximum possible value of 4096 (i.e., 4 TB). This value must be a positive integer.
        ...
        :param pulumi.Input[builtins.str] mongo_db_major_version: Version of the cluster to deploy. Atlas supports all the MongoDB versions that have **not** reached [End of Live](https://www.mongodb.com/legal/support-policy/lifecycles) for M10+ clusters. If omitted, Atlas deploys the cluster with the default version. For more details, see [documentation](https://www.mongodb.com/docs/atlas/reference/faq/database/#which-versions-of-mongodb-do-service-clusters-use-). Atlas always deploys the cluster with the latest stable release of the specified version. See [Release Notes](https://www.mongodb.com/docs/upcoming/release-notes/) for latest Current Stable Release.
        :param pulumi.Input[builtins.str] name: Name of the cluster as it appears in Atlas. Once the cluster is created, its name cannot be changed. **WARNING** Changing the name will result in destruction of the existing cluster and the creation of a new cluster.
        ...
        :param pulumi.Input[builtins.bool] pit_enabled: Flag that indicates if the cluster uses Continuous Cloud Backup. If set to true, cloud_backup must also be set to true.
        :param pulumi.Input[builtins.str] provider_auto_scaling_compute_max_instance_size: Maximum instance size to which your cluster can automatically scale (e.g., M40). Required if `autoScaling.compute.enabled` is `true`.
        :param pulumi.Input[builtins.str] provider_auto_scaling_compute_min_instance_size: Minimum instance size to which your cluster can automatically scale (e.g., M10). Required if `autoScaling.compute.scaleDownEnabled` is `true`.
        :param pulumi.Input[builtins.int] provider_disk_iops: The maximum input/output operations per second (IOPS) the system can perform. The possible values depend on the selected `provider_instance_size_name` and `disk_size_gb`.  This setting requires that `provider_instance_size_name` to be M30 or greater and cannot be used with clusters with local NVMe SSDs.  The default value for `provider_disk_iops` is the same as the cluster tier's Standard IOPS value, as viewable in the Atlas console.  It is used in cases where a higher number of IOPS is needed and possible.  If a value is submitted that is lower or equal to the default IOPS value for the cluster tier Atlas ignores the requested value and uses the default.  More details available under the providerSettings.diskIOPS parameter: [MongoDB API Clusters](https://docs.atlas.mongodb.com/reference/api/clusters-create-one/)
               * You do not need to configure IOPS for a STANDARD disk configuration but only for a PROVISIONED configuration.
        :param pulumi.Input[builtins.str] provider_disk_type_name: Azure disk type of the server’s root volume. If omitted, Atlas uses the default disk type for the selected providerSettings.instanceSizeName.  Example disk types and associated storage sizes: P4 - 32GB, P6 - 64GB, P10 - 128GB, P15 - 256GB, P20 - 512GB, P30 - 1024GB, P40 - 2048GB, P50 - 4095GB.  More information and the most update to date disk types/storage sizes can be located at https://docs.atlas.mongodb.com/reference/api/clusters-create-one/.
        :param pulumi.Input[builtins.bool] provider_encrypt_ebs_volume: **(Deprecated) The Flag is always true.** Flag that indicates whether the Amazon EBS encryption feature encrypts the host's root volume for both data at rest within the volume and for data moving between the volume and the cluster. Note: This setting is always enabled for clusters with local NVMe SSDs. **Atlas encrypts all cluster storage and snapshot volumes, securing all cluster data on disk: a concept known as encryption at rest, by default.**.
        :param pulumi.Input[builtins.str] provider_region_name: Physical location of your MongoDB cluster. The region you choose can affect network latency for clients accessing your databases.  Requires the **Atlas region name**, see the reference list for [AWS](https://docs.atlas.mongodb.com/reference/amazon-aws/), [GCP](https://docs.atlas.mongodb.com/reference/google-gcp/), [Azure](https://docs.atlas.mongodb.com/reference/microsoft-azure/).
               Do not specify this field when creating a multi-region cluster using the replicationSpec document or a Global Cluster with the replicationSpecs array.
        :param pulumi.Input[builtins.str] provider_volume_type: The type of the volume. The possible values are: `STANDARD` and `PROVISIONED`.  `PROVISIONED` is ONLY required if setting IOPS higher than the default instance IOPS.
               > **NOTE:** `STANDARD` is not available for NVME clusters.
        :param pulumi.Input[builtins.bool] redact_client_log_data: Flag that enables or disables log redaction, see the [manual](https://www.mongodb.com/docs/manual/administration/monitoring/#log-redaction) for more information. Use this in conjunction with Encryption at Rest and TLS/SSL (Transport Encryption) to assist compliance with regulatory requirements. **Note**: Changing this setting on a cluster will trigger a rolling restart as soon as the cluster is updated. The log redaction field is updated via an Atlas API call after cluster creation. Consequently, there may be a brief period during resource creation when log redaction is not yet enabled. To ensure complete log redaction from the outset, use `AdvancedCluster`.
        :param pulumi.Input[builtins.int] replication_factor: Number of replica set members. Each member keeps a copy of your databases, providing high availability and data redundancy. The possible values are 3, 5, or 7. The default value is 3.
        ...
        :param pulumi.Input[builtins.bool] retain_backups_enabled: - (Optional) Set to true to retain backup snapshots for the deleted cluster. This parameter applies to the Delete operation and only affects M10 and above clusters. If you encounter the `CANNOT_DELETE_SNAPSHOT_WITH_BACKUP_COMPLIANCE_POLICY` error code, see how to delete a cluster with Backup Compliance Policy.
        ...
        :param pulumi.Input[builtins.str] version_release_system: Release cadence that Atlas uses for this cluster. This parameter defaults to `LTS`. If you set this field to `CONTINUOUS`, you must omit the `mongo_db_major_version` field. Atlas accepts:
    ...
    def provider_instance_size_name(self) -> pulumi.Input[builtins.str]:
        """
        Atlas provides different instance sizes, each with a default storage capacity and RAM size. The instance size you select is used for all the data-bearing servers in your cluster. See [Create a Cluster](https://docs.atlas.mongodb.com/reference/api/clusters-create-one/) `providerSettings.instanceSizeName` for valid values and default resources.
        """
    ...
    def provider_instance_size_name(self, value: pulumi.Input[builtins.str]):
    ...
    def accept_data_risks_and_force_replica_set_reconfig(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def accept_data_risks_and_force_replica_set_reconfig(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def auto_scaling_compute_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "auto_scaling_compute_enabled")

    @auto_scaling_compute_enabled.setter
    def auto_scaling_compute_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_scaling_compute_enabled", value)

    @property
    @pulumi.getter(name="autoScalingComputeScaleDownEnabled")
    def auto_scaling_compute_scale_down_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_scaling_compute_scale_down_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_scaling_compute_scale_down_enabled", value)

    @property
    @pulumi.getter(name="autoScalingDiskGbEnabled")
    def auto_scaling_disk_gb_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "auto_scaling_disk_gb_enabled")

    @auto_scaling_disk_gb_enabled.setter
    def auto_scaling_disk_gb_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def cloud_backup(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "cloud_backup")

    @cloud_backup.setter
    def cloud_backup(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def mongo_db_major_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mongo_db_major_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def pit_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @pit_enabled.setter
    def pit_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "pit_enabled", value)

    @property
    @pulumi.getter(name="providerAutoScalingComputeMaxInstanceSize")
    def provider_auto_scaling_compute_max_instance_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_auto_scaling_compute_max_instance_size(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provider_auto_scaling_compute_min_instance_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_auto_scaling_compute_min_instance_size(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_auto_scaling_compute_min_instance_size", value)

    @property
    @pulumi.getter(name="providerDiskIops")
    def provider_disk_iops(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def provider_disk_iops(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "provider_disk_iops", value)

    @property
    @pulumi.getter(name="providerDiskTypeName")
    def provider_disk_type_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Azure disk type of the server’s root volume. If omitted, Atlas uses the default disk type for the selected providerSettings.instanceSizeName.  Example disk types and associated storage sizes: P4 - 32GB, P6 - 64GB, P10 - 128GB, P15 - 256GB, P20 - 512GB, P30 - 1024GB, P40 - 2048GB, P50 - 4095GB.  More information and the most update to date disk types/storage sizes can be located at https://docs.atlas.mongodb.com/reference/api/clusters-create-one/.
        """
    ...
    def provider_disk_type_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provider_encrypt_ebs_volume(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def provider_encrypt_ebs_volume(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "provider_encrypt_ebs_volume", value)

    @property
    @pulumi.getter(name="providerRegionName")
    def provider_region_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_region_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_region_name", value)

    @property
    @pulumi.getter(name="providerVolumeType")
    def provider_volume_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_volume_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_volume_type", value)

    @property
    @pulumi.getter(name="redactClientLogData")
    def redact_client_log_data(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def redact_client_log_data(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def retain_backups_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def retain_backups_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ClusterState:
    def __init__(__self__, *,
                 ...
                 mongo_uri: Optional[pulumi.Input[builtins.str]] = None,
                 mongo_uri_updated: Optional[pulumi.Input[builtins.str]] = None,
                 mongo_uri_with_options: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 num_shards: Optional[pulumi.Input[builtins.int]] = None,
                 paused: Optional[pulumi.Input[builtins.bool]] = None,
                 pinned_fcv: Optional[pulumi.Input['ClusterPinnedFcvArgs']] = None,
                 ...
                 provider_disk_type_name: Optional[pulumi.Input[builtins.str]] = None,
                 provider_encrypt_ebs_volume: Optional[pulumi.Input[builtins.bool]] = None,
                 provider_encrypt_ebs_volume_flag: Optional[pulumi.Input[builtins.bool]] = None,
                 provider_instance_size_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 srv_address: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] container_id: The Container ID is the id of the container created when the first cluster in the region (AWS/Azure) or project (GCP) was created.
        :param pulumi.Input[builtins.float] disk_size_gb: Capacity, in gigabytes, of the host’s root volume. Increase this number to add capacity, up to a maximum possible value of 4096 (i.e., 4 TB). This value must be a positive integer.
               * The minimum disk size for dedicated clusters is 10GB for AWS and GCP. If you specify diskSizeGB with a lower disk size, Atlas defaults to the minimum disk size value.
               * Note: The maximum value for disk storage cannot exceed 50 times the maximum RAM for the selected cluster. If you require additional storage space beyond this limitation, consider upgrading your cluster to a higher tier.
               * Cannot be used with clusters with local NVMe SSDs
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterLabelArgs']]] labels: Set that contains key-value pairs between 1 to 255 characters in length for tagging and categorizing the cluster. See below. **DEPRECATED** Use `tags` instead.
        :param pulumi.Input[builtins.str] mongo_db_major_version: Version of the cluster to deploy. Atlas supports all the MongoDB versions that have **not** reached [End of Live](https://www.mongodb.com/legal/support-policy/lifecycles) for M10+ clusters. If omitted, Atlas deploys the cluster with the default version. For more details, see [documentation](https://www.mongodb.com/docs/atlas/reference/faq/database/#which-versions-of-mongodb-do-service-clusters-use-). Atlas always deploys the cluster with the latest stable release of the specified version. See [Release Notes](https://www.mongodb.com/docs/upcoming/release-notes/) for latest Current Stable Release.
        :param pulumi.Input[builtins.str] mongo_db_version: Version of MongoDB the cluster runs, in `major-version`.`minor-version` format.
        :param pulumi.Input[builtins.str] mongo_uri: Base connection string for the cluster. Atlas only displays this field after the cluster is operational, not while it builds the cluster.
        :param pulumi.Input[builtins.str] mongo_uri_updated: Lists when the connection string was last updated. The connection string changes, for example, if you change a replica set to a sharded cluster.
        :param pulumi.Input[builtins.str] mongo_uri_with_options: connection string for connecting to the Atlas cluster. Includes the replicaSet, ssl, and authSource query parameters in the connection string with values appropriate for the cluster.
        :param pulumi.Input[builtins.str] name: Name of the cluster as it appears in Atlas. Once the cluster is created, its name cannot be changed. **WARNING** Changing the name will result in destruction of the existing cluster and the creation of a new cluster.
        :param pulumi.Input[builtins.int] num_shards: Selects whether the cluster is a replica set or a sharded cluster. If you use the replicationSpecs parameter, you must set num_shards.
        :param pulumi.Input['ClusterPinnedFcvArgs'] pinned_fcv: Pins the Feature Compatibility Version (FCV) to the current MongoDB version with a provided expiration date. To unpin the FCV the `pinned_fcv` attribute must be removed. This operation can take several minutes as the request processes through the MongoDB data plane. Once FCV is unpinned it will not be possible to downgrade the `mongo_db_major_version`. It is advised that updates to `pinned_fcv` are done isolated from other cluster changes. If a plan contains multiple changes, the FCV change will be applied first. If FCV is unpinned past the expiration date the `pinned_fcv` attribute must be removed. The following [knowledge hub article](https://kb.corp.mongodb.com/article/000021785/) and [FCV documentation](https://www.mongodb.com/docs/atlas/tutorial/major-version-change/#manage-feature-compatibility--fcv--during-upgrades) can be referenced for more details. See below.
        :param pulumi.Input[builtins.bool] pit_enabled: Flag that indicates if the cluster uses Continuous Cloud Backup. If set to true, cloud_backup must also be set to true.
        ...
        :param pulumi.Input[builtins.str] srv_address: Connection string for connecting to the Atlas cluster. The +srv modifier forces the connection to use TLS/SSL. See the mongoURI for additional options.
        :param pulumi.Input[builtins.str] state_name: Current state of the cluster. The possible states are:
               - IDLE
               - CREATING
               - UPDATING
               - DELETING
    ...
    def mongo_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @mongo_uri.setter
    def mongo_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mongo_uri", value)

    @property
    @pulumi.getter(name="mongoUriUpdated")
    def mongo_uri_updated(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mongo_uri_updated(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mongo_uri_updated", value)

    @property
    @pulumi.getter(name="mongoUriWithOptions")
    def mongo_uri_with_options(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mongo_uri_with_options(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provider_encrypt_ebs_volume_flag(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "provider_encrypt_ebs_volume_flag")

    @provider_encrypt_ebs_volume_flag.setter
    def provider_encrypt_ebs_volume_flag(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "provider_encrypt_ebs_volume_flag", value)

    @property
    @pulumi.getter(name="providerInstanceSizeName")
    def provider_instance_size_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Atlas provides different instance sizes, each with a default storage capacity and RAM size. The instance size you select is used for all the data-bearing servers in your cluster. See [Create a Cluster](https://docs.atlas.mongodb.com/reference/api/clusters-create-one/) `providerSettings.instanceSizeName` for valid values and default resources.
        """
        return pulumi.get(self, "provider_instance_size_name")
    ...
    @provider_instance_size_name.setter
    def provider_instance_size_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_instance_size_name", value)
    ...
    def srv_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @srv_address.setter
    def srv_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ClusterTagArgs', 'ClusterTagArgsDict']]]]] = None,
            termination_protection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            version_release_system: Optional[pulumi.Input[builtins.str]] = None) -> 'Cluster':
        """
    ...
    @property
    @pulumi.getter(name="acceptDataRisksAndForceReplicaSetReconfig")
    def accept_data_risks_and_force_replica_set_reconfig(self) -> pulumi.Output[builtins.str]:
        """
        If reconfiguration is necessary to regain a primary due to a regional outage, submit this field alongside your topology reconfiguration to request a new regional outage resistant topology. Forced reconfigurations during an outage of the majority of electable nodes carry a risk of data loss if replicated writes (even majority committed writes) have not been replicated to the new primary node. MongoDB Atlas docs contain more information. To proceed with an operation which carries that risk, set `accept_data_risks_and_force_replica_set_reconfig` to the current date. Learn more about Reconfiguring a Replica Set during a regional outage [here](https://dochub.mongodb.org/core/regional-outage-reconfigure-replica-set).
        """
        return pulumi.get(self, "accept_data_risks_and_force_replica_set_reconfig")
    ...
    @property
    @pulumi.getter(name="autoScalingComputeEnabled")
    def auto_scaling_compute_enabled(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "auto_scaling_compute_enabled")

    @property
    @pulumi.getter(name="autoScalingComputeScaleDownEnabled")
    def auto_scaling_compute_scale_down_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Set to `true` to enable the cluster tier to scale down. This option is only available if `autoScaling.compute.enabled` is `true`.
        - If this option is enabled, you must specify a value for `providerSettings.autoScaling.compute.minInstanceSize`
        """
    ...
    @property
    @pulumi.getter(name="autoScalingDiskGbEnabled")
    def auto_scaling_disk_gb_enabled(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "auto_scaling_disk_gb_enabled")

    @property
    @pulumi.getter(name="backingProviderName")
    def backing_provider_name(self) -> pulumi.Output[builtins.str]:
        """
        Cloud service provider on which the server for a multi-tenant cluster is provisioned.
    ...
    @property
    @pulumi.getter(name="backupEnabled")
    def backup_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Legacy Backup - Set to true to enable Atlas legacy backups for the cluster.
        **Important** - MongoDB deprecated the Legacy Backup feature. Clusters that use Legacy Backup can continue to use it. MongoDB recommends using [Cloud Backups](https://docs.atlas.mongodb.com/backup/cloud-backup/overview/).
        * New Atlas clusters of any type do not support this parameter. These clusters must use Cloud Backup, `cloud_backup`, to enable Cloud Backup.  If you create a new Atlas cluster and set `backup_enabled` to true, the Provider will respond with an error.  This change doesn’t affect existing clusters that use legacy backups.
    ...
    @property
    @pulumi.getter(name="cloudBackup")
    def cloud_backup(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "cloud_backup")
    ...
    @property
    @pulumi.getter(name="diskSizeGb")
    def disk_size_gb(self) -> pulumi.Output[builtins.float]:
        """
        Capacity, in gigabytes, of the host’s root volume. Increase this number to add capacity, up to a maximum possible value of 4096 (i.e., 4 TB). This value must be a positive integer.
        * The minimum disk size for dedicated clusters is 10GB for AWS and GCP. If you specify diskSizeGB with a lower disk size, Atlas defaults to the minimum disk size value.
        * Note: The maximum value for disk storage cannot exceed 50 times the maximum RAM for the selected cluster. If you require additional storage space beyond this limitation, consider upgrading your cluster to a higher tier.
    ...
    @property
    @pulumi.getter(name="mongoDbMajorVersion")
    def mongo_db_major_version(self) -> pulumi.Output[builtins.str]:
        """
        Version of the cluster to deploy. Atlas supports all the MongoDB versions that have **not** reached [End of Live](https://www.mongodb.com/legal/support-policy/lifecycles) for M10+ clusters. If omitted, Atlas deploys the cluster with the default version. For more details, see [documentation](https://www.mongodb.com/docs/atlas/reference/faq/database/#which-versions-of-mongodb-do-service-clusters-use-). Atlas always deploys the cluster with the latest stable release of the specified version. See [Release Notes](https://www.mongodb.com/docs/upcoming/release-notes/) for latest Current Stable Release.
        """
        return pulumi.get(self, "mongo_db_major_version")
    ...
    @property
    @pulumi.getter(name="mongoUri")
    def mongo_uri(self) -> pulumi.Output[builtins.str]:
        """
        Base connection string for the cluster. Atlas only displays this field after the cluster is operational, not while it builds the cluster.
        """
        return pulumi.get(self, "mongo_uri")
    ...
    @property
    @pulumi.getter(name="mongoUriUpdated")
    def mongo_uri_updated(self) -> pulumi.Output[builtins.str]:
        """
        Lists when the connection string was last updated. The connection string changes, for example, if you change a replica set to a sharded cluster.
        """
        return pulumi.get(self, "mongo_uri_updated")
    ...
    @property
    @pulumi.getter(name="mongoUriWithOptions")
    def mongo_uri_with_options(self) -> pulumi.Output[builtins.str]:
        """
        connection string for connecting to the Atlas cluster. Includes the replicaSet, ssl, and authSource query parameters in the connection string with values appropriate for the cluster.
        """
        return pulumi.get(self, "mongo_uri_with_options")
    ...
    @property
    @pulumi.getter(name="numShards")
    def num_shards(self) -> pulumi.Output[builtins.int]:
        """
        Selects whether the cluster is a replica set or a sharded cluster. If you use the replicationSpecs parameter, you must set num_shards.
        """
        return pulumi.get(self, "num_shards")
    ...
    @property
    @pulumi.getter(name="pitEnabled")
    def pit_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Flag that indicates if the cluster uses Continuous Cloud Backup. If set to true, cloud_backup must also be set to true.
        """
        return pulumi.get(self, "pit_enabled")
    ...
    @property
    @pulumi.getter(name="providerAutoScalingComputeMaxInstanceSize")
    def provider_auto_scaling_compute_max_instance_size(self) -> pulumi.Output[builtins.str]:
        """
        Maximum instance size to which your cluster can automatically scale (e.g., M40). Required if `autoScaling.compute.enabled` is `true`.
        """
        return pulumi.get(self, "provider_auto_scaling_compute_max_instance_size")
    ...
    @property
    @pulumi.getter(name="providerAutoScalingComputeMinInstanceSize")
    def provider_auto_scaling_compute_min_instance_size(self) -> pulumi.Output[builtins.str]:
        """
        Minimum instance size to which your cluster can automatically scale (e.g., M10). Required if `autoScaling.compute.scaleDownEnabled` is `true`.
        """
        return pulumi.get(self, "provider_auto_scaling_compute_min_instance_size")
    ...
    @property
    @pulumi.getter(name="providerDiskIops")
    def provider_disk_iops(self) -> pulumi.Output[builtins.int]:
        """
        The maximum input/output operations per second (IOPS) the system can perform. The possible values depend on the selected `provider_instance_size_name` and `disk_size_gb`.  This setting requires that `provider_instance_size_name` to be M30 or greater and cannot be used with clusters with local NVMe SSDs.  The default value for `provider_disk_iops` is the same as the cluster tier's Standard IOPS value, as viewable in the Atlas console.  It is used in cases where a higher number of IOPS is needed and possible.  If a value is submitted that is lower or equal to the default IOPS value for the cluster tier Atlas ignores the requested value and uses the default.  More details available under the providerSettings.diskIOPS parameter: [MongoDB API Clusters](https://docs.atlas.mongodb.com/reference/api/clusters-create-one/)
        * You do not need to configure IOPS for a STANDARD disk configuration but only for a PROVISIONED configuration.
        """
    ...
    @property
    @pulumi.getter(name="providerDiskTypeName")
    def provider_disk_type_name(self) -> pulumi.Output[builtins.str]:
        """
        Azure disk type of the server’s root volume. If omitted, Atlas uses the default disk type for the selected providerSettings.instanceSizeName.  Example disk types and associated storage sizes: P4 - 32GB, P6 - 64GB, P10 - 128GB, P15 - 256GB, P20 - 512GB, P30 - 1024GB, P40 - 2048GB, P50 - 4095GB.  More information and the most update to date disk types/storage sizes can be located at https://docs.atlas.mongodb.com/reference/api/clusters-create-one/.
        """
        return pulumi.get(self, "provider_disk_type_name")
    ...
    @pulumi.getter(name="providerEncryptEbsVolume")
    @_utilities.deprecated("""All EBS volumes are encrypted by default, the option to disable encryption has been removed""")
    def provider_encrypt_ebs_volume(self) -> pulumi.Output[builtins.bool]:
        """
        **(Deprecated) The Flag is always true.** Flag that indicates whether the Amazon EBS encryption feature encrypts the host's root volume for both data at rest within the volume and for data moving between the volume and the cluster. Note: This setting is always enabled for clusters with local NVMe SSDs. **Atlas encrypts all cluster storage and snapshot volumes, securing all cluster data on disk: a concept known as encryption at rest, by default.**.
        """
        return pulumi.get(self, "provider_encrypt_ebs_volume")
    ...
    @property
    @pulumi.getter(name="providerEncryptEbsVolumeFlag")
    def provider_encrypt_ebs_volume_flag(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "provider_encrypt_ebs_volume_flag")

    @property
    @pulumi.getter(name="providerInstanceSizeName")
    def provider_instance_size_name(self) -> pulumi.Output[builtins.str]:
        """
        Atlas provides different instance sizes, each with a default storage capacity and RAM size. The instance size you select is used for all the data-bearing servers in your cluster. See [Create a Cluster](https://docs.atlas.mongodb.com/reference/api/clusters-create-one/) `providerSettings.instanceSizeName` for valid values and default resources.
        """
        return pulumi.get(self, "provider_instance_size_name")
    ...
    @property
    @pulumi.getter(name="providerRegionName")
    def provider_region_name(self) -> pulumi.Output[builtins.str]:
        """
        Physical location of your MongoDB cluster. The region you choose can affect network latency for clients accessing your databases.  Requires the **Atlas region name**, see the reference list for [AWS](https://docs.atlas.mongodb.com/reference/amazon-aws/), [GCP](https://docs.atlas.mongodb.com/reference/google-gcp/), [Azure](https://docs.atlas.mongodb.com/reference/microsoft-azure/).
        Do not specify this field when creating a multi-region cluster using the replicationSpec document or a Global Cluster with the replicationSpecs array.
        """
    ...
    @property
    @pulumi.getter(name="providerVolumeType")
    def provider_volume_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the volume. The possible values are: `STANDARD` and `PROVISIONED`.  `PROVISIONED` is ONLY required if setting IOPS higher than the default instance IOPS.
        > **NOTE:** `STANDARD` is not available for NVME clusters.
        """
    ...
    @property
    @pulumi.getter(name="redactClientLogData")
    def redact_client_log_data(self) -> pulumi.Output[builtins.bool]:
        """
        Flag that enables or disables log redaction, see the [manual](https://www.mongodb.com/docs/manual/administration/monitoring/#log-redaction) for more information. Use this in conjunction with Encryption at Rest and TLS/SSL (Transport Encryption) to assist compliance with regulatory requirements. **Note**: Changing this setting on a cluster will trigger a rolling restart as soon as the cluster is updated. The log redaction field is updated via an Atlas API call after cluster creation. Consequently, there may be a brief period during resource creation when log redaction is not yet enabled. To ensure complete log redaction from the outset, use `AdvancedCluster`.
        """
        return pulumi.get(self, "redact_client_log_data")
    ...
    @property
    @pulumi.getter(name="retainBackupsEnabled")
    def retain_backups_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        - (Optional) Set to true to retain backup snapshots for the deleted cluster. This parameter applies to the Delete operation and only affects M10 and above clusters. If you encounter the `CANNOT_DELETE_SNAPSHOT_WITH_BACKUP_COMPLIANCE_POLICY` error code, see how to delete a cluster with Backup Compliance Policy.
        """
        return pulumi.get(self, "retain_backups_enabled")
    ...
    @property
    @pulumi.getter(name="srvAddress")
    def srv_address(self) -> pulumi.Output[builtins.str]:
        """
        Connection string for connecting to the Atlas cluster. The +srv modifier forces the connection to use TLS/SSL. See the mongoURI for additional options.
        """
        return pulumi.get(self, "srv_address")
