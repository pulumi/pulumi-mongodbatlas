...
if not MYPY:
    class AdvancedClusterAdvancedConfigurationArgsDict(TypedDict):
        change_stream_options_pre_and_post_images_expire_after_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        custom_openssl_cipher_config_tls12s: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        **(DEPRECATED)** (Optional) When true, documents can only be updated or inserted if, for all indexed fields on the target collection, the corresponding index entries do not exceed 1024 bytes. When false, mongod writes documents that exceed the limit but does not index them.
        ...
        - TLS1_2
        """
        no_table_scan: NotRequired[pulumi.Input[builtins.bool]]
        """
        When true, the cluster disables the execution of any query that requires a collection scan to return results. When false, the cluster allows the execution of those operations.
        """
        oplog_min_retention_hours: NotRequired[pulumi.Input[builtins.float]]
        """
        Minimum retention window for cluster's oplog expressed in hours. A value of null indicates that the cluster uses the default minimum oplog window that MongoDB Cloud calculates.
        * **Note**  A minimum oplog retention is required when seeking to change a cluster's class to Local NVMe SSD. To learn more and for latest guidance see [`oplogMinRetentionHours`](https://www.mongodb.com/docs/manual/core/replica-set-oplog/#std-label-replica-set-minimum-oplog-size)
        """
        oplog_size_mb: NotRequired[pulumi.Input[builtins.int]]
        """
        The custom oplog size of the cluster. Without a value that indicates that the cluster uses the default oplog size calculated by Atlas.
        """
        sample_refresh_interval_bi_connector: NotRequired[pulumi.Input[builtins.int]]
        """
        Interval in seconds at which the mongosqld process re-samples data to create its relational schema. The default value is 300. The specified value must be a positive integer. Available only for Atlas deployments in which BI Connector for Atlas is enabled.
        """
        sample_size_bi_connector: NotRequired[pulumi.Input[builtins.int]]
        """
        Number of documents per database to sample when gathering schema information. Defaults to 100. Available only for Atlas deployments in which BI Connector for Atlas is enabled.
        """
        tls_cipher_config_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        transaction_lifetime_limit_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AdvancedClusterAdvancedConfigurationArgs:
    def __init__(__self__, *,
                 change_stream_options_pre_and_post_images_expire_after_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 custom_openssl_cipher_config_tls12s: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 default_max_time_ms: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 fail_index_key_too_long: Optional[pulumi.Input[builtins.bool]] = None,
                 javascript_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 minimum_enabled_tls_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 no_table_scan: Optional[pulumi.Input[builtins.bool]] = None,
                 oplog_min_retention_hours: Optional[pulumi.Input[builtins.float]] = None,
                 oplog_size_mb: Optional[pulumi.Input[builtins.int]] = None,
                 sample_refresh_interval_bi_connector: Optional[pulumi.Input[builtins.int]] = None,
                 sample_size_bi_connector: Optional[pulumi.Input[builtins.int]] = None,
                 tls_cipher_config_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] minimum_enabled_tls_protocol: Sets the minimum Transport Layer Security (TLS) version the cluster accepts for incoming connections. Valid values are:
               ...
               - TLS1_1
               - TLS1_2
        :param pulumi.Input[builtins.bool] no_table_scan: When true, the cluster disables the execution of any query that requires a collection scan to return results. When false, the cluster allows the execution of those operations.
        :param pulumi.Input[builtins.float] oplog_min_retention_hours: Minimum retention window for cluster's oplog expressed in hours. A value of null indicates that the cluster uses the default minimum oplog window that MongoDB Cloud calculates.
               * **Note**  A minimum oplog retention is required when seeking to change a cluster's class to Local NVMe SSD. To learn more and for latest guidance see [`oplogMinRetentionHours`](https://www.mongodb.com/docs/manual/core/replica-set-oplog/#std-label-replica-set-minimum-oplog-size)
        :param pulumi.Input[builtins.int] oplog_size_mb: The custom oplog size of the cluster. Without a value that indicates that the cluster uses the default oplog size calculated by Atlas.
        :param pulumi.Input[builtins.int] sample_refresh_interval_bi_connector: Interval in seconds at which the mongosqld process re-samples data to create its relational schema. The default value is 300. The specified value must be a positive integer. Available only for Atlas deployments in which BI Connector for Atlas is enabled.
        :param pulumi.Input[builtins.int] sample_size_bi_connector: Number of documents per database to sample when gathering schema information. Defaults to 100. Available only for Atlas deployments in which BI Connector for Atlas is enabled.
        :param pulumi.Input[builtins.str] tls_cipher_config_mode: The TLS cipher suite configuration mode. Valid values include `CUSTOM` or `DEFAULT`. The `DEFAULT` mode uses the default cipher suites. The `CUSTOM` mode allows you to specify custom cipher suites for both TLS 1.2 and TLS 1.3. To unset, this should be set back to `DEFAULT`.
        :param pulumi.Input[builtins.int] transaction_lifetime_limit_seconds: Lifetime, in seconds, of multi-document transactions. Defaults to 60 seconds.
        """
    ...
    def change_stream_options_pre_and_post_images_expire_after_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minimum pre- and post-image retention time in seconds. This option corresponds to the `changeStreamOptions.preAndPostImages.expireAfterSeconds` cluster parameter. Defaults to `-1`(off). This setting controls the retention policy of change stream pre- and post-images. Pre- and post-images are the versions of a document before and after document modification, respectively. `expireAfterSeconds` controls how long MongoDB retains pre- and post-images. When set to -1 (off), MongoDB uses the default retention policy: pre- and post-images are retained until the corresponding change stream events are removed from the oplog. To set the minimum pre- and post-image retention time, specify an integer value greater than zero. Setting this too low could increase the risk of interrupting Realm sync or triggers processing. This parameter is only supported for MongoDB version 6.0 and above.
        """
    ...
    def change_stream_options_pre_and_post_images_expire_after_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def custom_openssl_cipher_config_tls12s(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The custom OpenSSL cipher suite list for TLS 1.2. This field is only valid when `tls_cipher_config_mode` is set to `CUSTOM`.
        """
    ...
    def custom_openssl_cipher_config_tls12s(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "custom_openssl_cipher_config_tls12s", value)

    @property
    @pulumi.getter(name="defaultMaxTimeMs")
    def default_max_time_ms(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Default time limit in milliseconds for individual read operations to complete. This option corresponds to the [defaultMaxTimeMS](https://www.mongodb.com/docs/upcoming/reference/cluster-parameters/defaultMaxTimeMS/) cluster parameter. This parameter is supported only for MongoDB version 8.0 and above.
        """
    ...
    def default_max_time_ms(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def fail_index_key_too_long(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "fail_index_key_too_long", value)

    @property
    @pulumi.getter(name="javascriptEnabled")
    def javascript_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When true (default), the cluster allows execution of operations that perform server-side executions of JavaScript. When false, the cluster disables execution of those operations.
        """
    ...
    def javascript_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def minimum_enabled_tls_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "minimum_enabled_tls_protocol", value)

    @property
    @pulumi.getter(name="noTableScan")
    def no_table_scan(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When true, the cluster disables the execution of any query that requires a collection scan to return results. When false, the cluster allows the execution of those operations.
        """
    ...
    def no_table_scan(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "no_table_scan", value)

    @property
    @pulumi.getter(name="oplogMinRetentionHours")
    def oplog_min_retention_hours(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Minimum retention window for cluster's oplog expressed in hours. A value of null indicates that the cluster uses the default minimum oplog window that MongoDB Cloud calculates.
        * **Note**  A minimum oplog retention is required when seeking to change a cluster's class to Local NVMe SSD. To learn more and for latest guidance see [`oplogMinRetentionHours`](https://www.mongodb.com/docs/manual/core/replica-set-oplog/#std-label-replica-set-minimum-oplog-size)
        """
    ...
    def oplog_min_retention_hours(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "oplog_min_retention_hours", value)

    @property
    @pulumi.getter(name="oplogSizeMb")
    def oplog_size_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The custom oplog size of the cluster. Without a value that indicates that the cluster uses the default oplog size calculated by Atlas.
        """
    ...
    def oplog_size_mb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "oplog_size_mb", value)

    @property
    @pulumi.getter(name="sampleRefreshIntervalBiConnector")
    def sample_refresh_interval_bi_connector(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Interval in seconds at which the mongosqld process re-samples data to create its relational schema. The default value is 300. The specified value must be a positive integer. Available only for Atlas deployments in which BI Connector for Atlas is enabled.
        """
    ...
    def sample_refresh_interval_bi_connector(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "sample_refresh_interval_bi_connector", value)

    @property
    @pulumi.getter(name="sampleSizeBiConnector")
    def sample_size_bi_connector(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of documents per database to sample when gathering schema information. Defaults to 100. Available only for Atlas deployments in which BI Connector for Atlas is enabled.
        """
    ...
    def sample_size_bi_connector(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "sample_size_bi_connector", value)

    @property
    @pulumi.getter(name="tlsCipherConfigMode")
    def tls_cipher_config_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The TLS cipher suite configuration mode. Valid values include `CUSTOM` or `DEFAULT`. The `DEFAULT` mode uses the default cipher suites. The `CUSTOM` mode allows you to specify custom cipher suites for both TLS 1.2 and TLS 1.3. To unset, this should be set back to `DEFAULT`.
        """
    ...
    def tls_cipher_config_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AdvancedClusterBiConnectorConfigArgsDict(TypedDict):
        ...
        *
        ...
        """
        read_preference: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AdvancedClusterBiConnectorConfigArgs:
    def __init__(__self__, *,
                 ...
                 read_preference: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Specifies whether or not BI Connector for Atlas is enabled on the cluster.
               *
               - Set to `true` to enable BI Connector for Atlas.
               - Set to `false` to disable BI Connector for Atlas.
        :param pulumi.Input[builtins.str] read_preference: Specifies the read preference to be used by BI Connector for Atlas on the cluster. Each BI Connector for Atlas read preference contains a distinct combination of [readPreference](https://docs.mongodb.com/manual/core/read-preference/) and [readPreferenceTags](https://docs.mongodb.com/manual/core/read-preference/#tag-sets) options. For details on BI Connector for Atlas read preferences, refer to the [BI Connector Read Preferences Table](https://docs.atlas.mongodb.com/tutorial/create-global-writes-cluster/#bic-read-preferences).
    ...
    def read_preference(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the read preference to be used by BI Connector for Atlas on the cluster. Each BI Connector for Atlas read preference contains a distinct combination of [readPreference](https://docs.mongodb.com/manual/core/read-preference/) and [readPreferenceTags](https://docs.mongodb.com/manual/core/read-preference/#tag-sets) options. For details on BI Connector for Atlas read preferences, refer to the [BI Connector Read Preferences Table](https://docs.atlas.mongodb.com/tutorial/create-global-writes-cluster/#bic-read-preferences).
    ...
    def read_preference(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "read_preference", value)


if not MYPY:
    class AdvancedClusterConnectionStringArgsDict(TypedDict):
        private: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        private_srv: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        standard: NotRequired[pulumi.Input[builtins.str]]
        """
        Public mongodb:// connection string for this cluster.
        """
        standard_srv: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AdvancedClusterConnectionStringArgs:
    def __init__(__self__, *,
                 private: Optional[pulumi.Input[builtins.str]] = None,
                 private_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input['AdvancedClusterConnectionStringPrivateEndpointArgs']]]] = None,
                 private_srv: Optional[pulumi.Input[builtins.str]] = None,
                 standard: Optional[pulumi.Input[builtins.str]] = None,
                 standard_srv: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] private: [Network-peering-endpoint-aware](https://docs.atlas.mongodb.com/security-vpc-peering/#vpc-peering) mongodb://connection strings for each interface VPC endpoint you configured to connect to this cluster. Returned only if you created a network peering connection to this cluster.
        :param pulumi.Input[Sequence[pulumi.Input['AdvancedClusterConnectionStringPrivateEndpointArgs']]] private_endpoints: Private endpoint connection strings. Each object describes the connection strings you can use to connect to this cluster through a private endpoint. Atlas returns this parameter only if you deployed a private endpoint to all regions to which you deployed this cluster's nodes.
               ...
               - `connection_strings.private_endpoint.#.endpoints.#.provider_name` - Cloud provider to which you deployed the private endpoint. Atlas returns `AWS` or `AZURE`.
               - `connection_strings.private_endpoint.#.endpoints.#.region` - Region to which you deployed the private endpoint.
        :param pulumi.Input[builtins.str] private_srv: [Network-peering-endpoint-aware](https://docs.atlas.mongodb.com/security-vpc-peering/#vpc-peering) mongodb+srv://connection strings for each interface VPC endpoint you configured to connect to this cluster. Returned only if you created a network peering connection to this cluster.
        :param pulumi.Input[builtins.str] standard: Public mongodb:// connection string for this cluster.
        :param pulumi.Input[builtins.str] standard_srv: Public mongodb+srv:// connection string for this cluster. The mongodb+srv protocol tells the driver to look up the seed list of hosts in DNS. Atlas synchronizes this list with the nodes in a cluster. If the connection string uses this URI format, you don’t need to append the seed list or change the URI if the nodes change. Use this URI format if your driver supports it. If it doesn’t  , use connectionStrings.standard.
        """
    ...
    @property
    @pulumi.getter
    def private(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        [Network-peering-endpoint-aware](https://docs.atlas.mongodb.com/security-vpc-peering/#vpc-peering) mongodb://connection strings for each interface VPC endpoint you configured to connect to this cluster. Returned only if you created a network peering connection to this cluster.
        """
    ...
    @private.setter
    def private(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def private_srv(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        [Network-peering-endpoint-aware](https://docs.atlas.mongodb.com/security-vpc-peering/#vpc-peering) mongodb+srv://connection strings for each interface VPC endpoint you configured to connect to this cluster. Returned only if you created a network peering connection to this cluster.
        """
    ...
    @private_srv.setter
    def private_srv(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "private_srv", value)

    @property
    @pulumi.getter
    def standard(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Public mongodb:// connection string for this cluster.
        """
    ...
    @standard.setter
    def standard(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "standard", value)

    @property
    @pulumi.getter(name="standardSrv")
    def standard_srv(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Public mongodb+srv:// connection string for this cluster. The mongodb+srv protocol tells the driver to look up the seed list of hosts in DNS. Atlas synchronizes this list with the nodes in a cluster. If the connection string uses this URI format, you don’t need to append the seed list or change the URI if the nodes change. Use this URI format if your driver supports it. If it doesn’t  , use connectionStrings.standard.
        """
    ...
    @standard_srv.setter
    def standard_srv(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AdvancedClusterConnectionStringPrivateEndpointArgsDict(TypedDict):
        ...
        srv_connection_string: NotRequired[pulumi.Input[builtins.str]]
        srv_shard_optimized_connection_string: NotRequired[pulumi.Input[builtins.str]]
...
class AdvancedClusterConnectionStringPrivateEndpointArgs:
    def __init__(__self__, *,
                 ...
                 srv_connection_string: Optional[pulumi.Input[builtins.str]] = None,
                 srv_shard_optimized_connection_string: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def srv_connection_string(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "srv_connection_string")

    @srv_connection_string.setter
    def srv_connection_string(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "srv_connection_string", value)

    @property
    @pulumi.getter(name="srvShardOptimizedConnectionString")
    def srv_shard_optimized_connection_string(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "srv_shard_optimized_connection_string")

    @srv_shard_optimized_connection_string.setter
    def srv_shard_optimized_connection_string(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AdvancedClusterConnectionStringPrivateEndpointEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] provider_name: Cloud service provider on which the servers are provisioned.
               The possible values are:
               - `AWS` - Amazon AWS
               - `GCP` - Google Cloud Platform
               - `AZURE` - Microsoft Azure
...
class AdvancedClusterLabelArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: The key that you want to write.
        :param pulumi.Input[builtins.str] value: The value that you want to write.
...
class AdvancedClusterPinnedFcvArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] expiration_date: Expiration date of the fixed FCV. This value is in the ISO 8601 timestamp format (e.g. "2024-12-04T16:25:00Z"). Note that this field cannot exceed 4 weeks from the pinned date.
        :param pulumi.Input[builtins.str] version: Feature compatibility version of the cluster.
        """
...
if not MYPY:
    class AdvancedClusterReplicationSpecArgsDict(TypedDict):
        ...
        """
        container_id: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
...
class AdvancedClusterReplicationSpecArgs:
    def __init__(__self__, *,
                 ...
                 container_id: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] id: **(DEPRECATED)** Unique identifer of the replication document for a zone in a Global Cluster. This value corresponds to the legacy sharding schema (no independent shard scaling) and is different from the Shard ID you may see in the Atlas UI. This value is not populated (empty string) when a sharded cluster has independently scaled shards.
        :param pulumi.Input[builtins.int] num_shards: Provide this value if you set a `cluster_type` of SHARDED or GEOSHARDED. Omit this value if you selected a `cluster_type` of REPLICASET. This API resource accepts 1 through 50, inclusive. This parameter defaults to 1. If you specify a `num_shards` value of 1 and a `cluster_type` of SHARDED, Atlas deploys a single-shard [sharded cluster](https://docs.atlas.mongodb.com/reference/glossary/#std-term-sharded-cluster). Don't create a sharded cluster with a single shard for production environments. Single-shard sharded clusters don't provide the same benefits as multi-shard configurations.
               If you are upgrading a replica set to a sharded cluster, you cannot increase the number of shards in the same update request. You should wait until after the cluster has completed upgrading to sharded and you have reconnected all application clients to the MongoDB router before adding additional shards. Otherwise, your data might become inconsistent once MongoDB Cloud begins distributing data across shards. To learn more, see [Convert a replica set to a sharded cluster documentation](https://www.mongodb.com/docs/atlas/scale-cluster/#convert-a-replica-set-to-a-sharded-cluster) and [Convert a replica set to a sharded cluster tutorial](https://www.mongodb.com/docs/upcoming/tutorial/convert-replica-set-to-replicated-shard-cluster). **(DEPRECATED)** To learn more, see the 1.18.0 Upgrade Guide.
        :param pulumi.Input[builtins.str] zone_id: Unique 24-hexadecimal digit string that identifies the zone in a Global Cluster. If clusterType is GEOSHARDED, this value indicates the zone that the given shard belongs to and can be used to configure Global Cluster backup policies.
        :param pulumi.Input[builtins.str] zone_name: Name for the zone in a Global Cluster.
        """
    ...
    def container_id(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "container_id")

    @container_id.setter
    def container_id(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class AdvancedClusterReplicationSpecRegionConfigArgsDict(TypedDict):
        ...
        * If your region has set `region_configs.#.electable_specs.0.node_count` to 1 or higher, it must have a priority of exactly one (1) less than another region in the `replication_specs.#.region_configs.#` array. The highest-priority region must have a priority of 7. The lowest possible priority is 1.
        ...
        """
        backing_provider_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AdvancedClusterReplicationSpecRegionConfigArgs:
    def __init__(__self__, *,
                 ...
                 backing_provider_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.int] priority: Election priority of the region. For regions with only read-only nodes, set this value to 0.
               * If you have multiple `region_configs` objects (your cluster is multi-region or multi-cloud), they must have priorities in descending order. The highest priority is 7.
               * If your region has set `region_configs.#.electable_specs.0.node_count` to 1 or higher, it must have a priority of exactly one (1) less than another region in the `replication_specs.#.region_configs.#` array. The highest-priority region must have a priority of 7. The lowest possible priority is 1.
        :param pulumi.Input[builtins.str] provider_name: Cloud service provider on which the servers are provisioned.
               The possible values are:
               ...
               - `AZURE` - Microsoft Azure
               - `TENANT` - M0 multi-tenant cluster. Use `replication_specs.#.region_configs.#.backing_provider_name` to set the cloud service provider.
        :param pulumi.Input[builtins.str] region_name: Physical location of your MongoDB cluster. The region you choose can affect network latency for clients accessing your databases.  Requires the **Atlas region name**, see the reference list for [AWS](https://docs.atlas.mongodb.com/reference/amazon-aws/), [GCP](https://docs.atlas.mongodb.com/reference/google-gcp/), [Azure](https://docs.atlas.mongodb.com/reference/microsoft-azure/).
        ...
        :param pulumi.Input[builtins.str] backing_provider_name: Cloud service provider on which you provision the host for a multi-tenant cluster. Use this only when a `provider_name` is `TENANT` and `instance_size` is `M0`.
    ...
    def backing_provider_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Cloud service provider on which you provision the host for a multi-tenant cluster. Use this only when a `provider_name` is `TENANT` and `instance_size` is `M0`.
        """
    ...
    def backing_provider_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AdvancedClusterReplicationSpecRegionConfigAnalyticsAutoScalingArgsDict(TypedDict):
        compute_enabled: NotRequired[pulumi.Input[builtins.bool]]
        compute_max_instance_size: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        compute_min_instance_size: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        compute_scale_down_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        disk_gb_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AdvancedClusterReplicationSpecRegionConfigAnalyticsAutoScalingArgs:
    def __init__(__self__, *,
                 compute_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 compute_max_instance_size: Optional[pulumi.Input[builtins.str]] = None,
                 compute_min_instance_size: Optional[pulumi.Input[builtins.str]] = None,
                 compute_scale_down_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 disk_gb_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] compute_max_instance_size: Maximum instance size to which your cluster can automatically scale (such as M40). Atlas requires this parameter if `replication_specs.#.region_configs.#.analytics_auto_scaling.0.compute_enabled` is true.
        :param pulumi.Input[builtins.str] compute_min_instance_size: Minimum instance size to which your cluster can automatically scale (such as M10). Atlas requires this parameter if `replication_specs.#.region_configs.#.analytics_auto_scaling.0.compute_scale_down_enabled` is true.
        :param pulumi.Input[builtins.bool] compute_scale_down_enabled: Flag that indicates whether the instance size may scale down. Atlas requires this parameter if `replication_specs.#.region_configs.#.analytics_auto_scaling.0.compute_enabled` : true. If you enable this option, specify a value for `replication_specs.#.region_configs.#.analytics_auto_scaling.0.compute_min_instance_size`.
        :param pulumi.Input[builtins.bool] disk_gb_enabled: Flag that indicates whether this cluster enables disk auto-scaling. This parameter defaults to false.
        """
    ...
    def compute_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "compute_enabled")

    @compute_enabled.setter
    def compute_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "compute_enabled", value)

    @property
    @pulumi.getter(name="computeMaxInstanceSize")
    def compute_max_instance_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Maximum instance size to which your cluster can automatically scale (such as M40). Atlas requires this parameter if `replication_specs.#.region_configs.#.analytics_auto_scaling.0.compute_enabled` is true.
        """
    ...
    def compute_max_instance_size(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "compute_max_instance_size", value)

    @property
    @pulumi.getter(name="computeMinInstanceSize")
    def compute_min_instance_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Minimum instance size to which your cluster can automatically scale (such as M10). Atlas requires this parameter if `replication_specs.#.region_configs.#.analytics_auto_scaling.0.compute_scale_down_enabled` is true.
        """
    ...
    def compute_min_instance_size(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "compute_min_instance_size", value)

    @property
    @pulumi.getter(name="computeScaleDownEnabled")
    def compute_scale_down_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Flag that indicates whether the instance size may scale down. Atlas requires this parameter if `replication_specs.#.region_configs.#.analytics_auto_scaling.0.compute_enabled` : true. If you enable this option, specify a value for `replication_specs.#.region_configs.#.analytics_auto_scaling.0.compute_min_instance_size`.
        """
    ...
    def compute_scale_down_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "compute_scale_down_enabled", value)

    @property
    @pulumi.getter(name="diskGbEnabled")
    def disk_gb_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Flag that indicates whether this cluster enables disk auto-scaling. This parameter defaults to false.
        """
...
if not MYPY:
    class AdvancedClusterReplicationSpecRegionConfigAnalyticsSpecsArgsDict(TypedDict):
        ...
        """
        disk_iops: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        ebs_volume_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AdvancedClusterReplicationSpecRegionConfigAnalyticsSpecsArgs:
    def __init__(__self__, *,
                 instance_size: pulumi.Input[builtins.str],
                 disk_iops: Optional[pulumi.Input[builtins.int]] = None,
                 disk_size_gb: Optional[pulumi.Input[builtins.float]] = None,
                 ebs_volume_type: Optional[pulumi.Input[builtins.str]] = None,
                 node_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] instance_size: Hardware specification for the instance sizes in this region. Each instance size has a default storage and memory capacity. The instance size you select applies to all the data-bearing hosts in your instance size. Electable nodes and read-only nodes (known as "base nodes") within a single shard must use the same instance size. Analytics nodes can scale independently from base nodes within a shard. Both base nodes and analytics nodes can scale independently from their equivalents in other shards.
        :param pulumi.Input[builtins.int] disk_iops: Target IOPS (Input/Output Operations Per Second) desired for storage attached to this hardware. Define this attribute only if you selected AWS as your cloud service provider, `instance_size` is set to "M30" or greater (not including "Mxx_NVME" tiers), and `ebs_volume_type` is "PROVISIONED". You can't set this attribute for a multi-cloud cluster.
        :param pulumi.Input[builtins.float] disk_size_gb: Storage capacity that the host's root volume possesses expressed in gigabytes. This value must be equal for all shards and node types. If disk size specified is below the minimum (10 GB), this parameter defaults to the minimum disk size value. Storage charge calculations depend on whether you choose the default value or a custom value.  The maximum value for disk storage cannot exceed 50 times the maximum RAM for the selected cluster. If you require more storage space, consider upgrading your cluster to a higher tier. **Note:** Using `disk_size_gb` with Standard IOPS could lead to errors and configuration issues. Therefore, it should be used only with the Provisioned IOPS volume type. When using Provisioned IOPS, the disk_size_gb parameter specifies the storage capacity, but the IOPS are set independently. Ensuring that `disk_size_gb` is used exclusively with Provisioned IOPS will help avoid these issues.
        :param pulumi.Input[builtins.str] ebs_volume_type: Type of storage you want to attach to your AWS-provisioned cluster. Set only if you selected AWS as your cloud service provider. You can't set this parameter for a multi-cloud cluster. Valid values are:
               * `STANDARD` volume types can't exceed the default IOPS rate for the selected volume size.
               * `PROVISIONED` volume types must fall within the allowable IOPS range for the selected volume size.
        :param pulumi.Input[builtins.int] node_count: Number of nodes of the given type for MongoDB Atlas to deploy to the region.
        """
    ...
    def instance_size(self) -> pulumi.Input[builtins.str]:
        """
        Hardware specification for the instance sizes in this region. Each instance size has a default storage and memory capacity. The instance size you select applies to all the data-bearing hosts in your instance size. Electable nodes and read-only nodes (known as "base nodes") within a single shard must use the same instance size. Analytics nodes can scale independently from base nodes within a shard. Both base nodes and analytics nodes can scale independently from their equivalents in other shards.
        """
    ...
    def instance_size(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "instance_size", value)

    @property
    @pulumi.getter(name="diskIops")
    def disk_iops(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Target IOPS (Input/Output Operations Per Second) desired for storage attached to this hardware. Define this attribute only if you selected AWS as your cloud service provider, `instance_size` is set to "M30" or greater (not including "Mxx_NVME" tiers), and `ebs_volume_type` is "PROVISIONED". You can't set this attribute for a multi-cloud cluster.
        """
    ...
    @disk_iops.setter
    def disk_iops(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def ebs_volume_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Type of storage you want to attach to your AWS-provisioned cluster. Set only if you selected AWS as your cloud service provider. You can't set this parameter for a multi-cloud cluster. Valid values are:
        * `STANDARD` volume types can't exceed the default IOPS rate for the selected volume size.
        * `PROVISIONED` volume types must fall within the allowable IOPS range for the selected volume size.
    ...
    def ebs_volume_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AdvancedClusterReplicationSpecRegionConfigAutoScalingArgs:
    def __init__(__self__, *,
                 ...
                 disk_gb_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] compute_max_instance_size: Maximum instance size to which your cluster can automatically scale (such as M40). Atlas requires this parameter if `replication_specs.#.region_configs.#.auto_scaling.0.compute_enabled` is true.
        :param pulumi.Input[builtins.str] compute_min_instance_size: Minimum instance size to which your cluster can automatically scale (such as M10). Atlas requires this parameter if `replication_specs.#.region_configs.#.auto_scaling.0.compute_scale_down_enabled` is true.
        :param pulumi.Input[builtins.bool] compute_scale_down_enabled: Flag that indicates whether the instance size may scale down. Atlas requires this parameter if `replication_specs.#.region_configs.#.auto_scaling.0.compute_enabled` : true. If you enable this option, specify a value for `replication_specs.#.region_configs.#.auto_scaling.0.compute_min_instance_size`.
        :param pulumi.Input[builtins.bool] disk_gb_enabled: Flag that indicates whether this cluster enables disk auto-scaling. This parameter defaults to false.
        """
        if compute_enabled is not None:
            pulumi.set(__self__, "compute_enabled", compute_enabled)
...
class AdvancedClusterTagArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: Constant that defines the set of the tag.
        :param pulumi.Input[builtins.str] value: Variable that belongs to the set of the tag.
...
class AlertConfigurationMatcherArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] field_name: Name of the field in the target object to match on.
               ...
               All other types of alerts do not support matchers.
        :param pulumi.Input[builtins.str] value: Value to test with the specified operator. If `field_name` is set to TYPE_NAME, you can match on the following values:
               - `PRIMARY`
               - `SECONDARY`
               - `STANDALONE`
               - `CONFIG`
...
class AlertConfigurationMetricThresholdConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] metric_name: Name of the metric to check. The full list being quite large, please refer to atlas docs [here for general metrics](https://docs.atlas.mongodb.com/reference/alert-host-metrics/#measurement-types) and [here for serverless metrics](https://www.mongodb.com/docs/atlas/reference/api/alert-configurations-create-config/#serverless-measurements)
        :param pulumi.Input[builtins.str] mode: This must be set to AVERAGE. Atlas computes the current metric value as an average.
        """
...
if not MYPY:
    class AlertConfigurationNotificationArgsDict(TypedDict):
        ...
        """
        datadog_api_key: NotRequired[pulumi.Input[builtins.str]]
        """
        Datadog API Key. Found in the Datadog dashboard. Required for the DATADOG notifications type.
        """
        datadog_region: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        delay_min: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        integration_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The ID of the associated integration, the credentials of which to use for requests.
        """
        interval_min: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        mobile_number: NotRequired[pulumi.Input[builtins.str]]
        """
        Mobile number to which alert notifications are sent. Required for the SMS notifications type.
        """
        notifier_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        ops_genie_api_key: NotRequired[pulumi.Input[builtins.str]]
        """
        Opsgenie API Key. Required for the `OPS_GENIE` notifications type. If the key later becomes invalid, Atlas sends an email to the project owner and eventually removes the token.
        """
        ops_genie_region: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        | `GROUP_READ_ONLY`               |                     |
        """
        service_key: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        victor_ops_api_key: NotRequired[pulumi.Input[builtins.str]]
        """
        VictorOps API key. Required for the `VICTOR_OPS` notifications type. If the key later becomes invalid, Atlas sends an email to the project owner and eventually removes the key.
        """
        victor_ops_routing_key: NotRequired[pulumi.Input[builtins.str]]
        """
        VictorOps routing key. Optional for the `VICTOR_OPS` notifications type. If the key later becomes invalid, Atlas sends an email to the project owner and eventually removes the key.
        """
        webhook_secret: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AlertConfigurationNotificationArgs:
    def __init__(__self__, *,
                 ...
                 datadog_region: Optional[pulumi.Input[builtins.str]] = None,
                 delay_min: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 interval_min: Optional[pulumi.Input[builtins.int]] = None,
                 microsoft_teams_webhook_url: Optional[pulumi.Input[builtins.str]] = None,
                 mobile_number: Optional[pulumi.Input[builtins.str]] = None,
                 notifier_id: Optional[pulumi.Input[builtins.str]] = None,
                 ops_genie_api_key: Optional[pulumi.Input[builtins.str]] = None,
                 ops_genie_region: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 victor_ops_api_key: Optional[pulumi.Input[builtins.str]] = None,
                 victor_ops_routing_key: Optional[pulumi.Input[builtins.str]] = None,
                 webhook_secret: Optional[pulumi.Input[builtins.str]] = None,
                 webhook_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type_name: Type of alert notification.
               Accepted values are:
               - `DATADOG`
               - `EMAIL`
               - `GROUP` (Project)
               ...
               - `WEBHOOK`
               - `MICROSOFT_TEAMS`
        :param pulumi.Input[builtins.str] api_token: Slack API token. Required for the SLACK notifications type. If the token later becomes invalid, Atlas sends an email to the project owner and eventually removes the token.
        :param pulumi.Input[builtins.str] channel_name: Slack channel name. Required for the SLACK notifications type.
        :param pulumi.Input[builtins.str] datadog_api_key: Datadog API Key. Found in the Datadog dashboard. Required for the DATADOG notifications type.
        :param pulumi.Input[builtins.str] datadog_region: Region that indicates which API URL to use. See the `datadogRegion` field in the `notifications` request parameter of [MongoDB API Alert Configuration documentation](https://www.mongodb.com/docs/api/doc/atlas-admin-api-v2/operation/operation-createalertconfiguration) for more details. The default Datadog region is US.
        :param pulumi.Input[builtins.int] delay_min: Number of minutes to wait after an alert condition is detected before sending out the first notification.
        :param pulumi.Input[builtins.str] email_address: Email address to which alert notifications are sent. Required for the EMAIL notifications type.
        :param pulumi.Input[builtins.bool] email_enabled: Flag indicating email notifications should be sent. This flag is only valid if `type_name` is set to `ORG`, `GROUP`, or `USER`.
        :param pulumi.Input[builtins.str] integration_id: The ID of the associated integration, the credentials of which to use for requests.
        :param pulumi.Input[builtins.int] interval_min: Number of minutes to wait between successive notifications for unacknowledged alerts that are not resolved. The minimum value is 5. **NOTE** `PAGER_DUTY`, `VICTOR_OPS`, and `OPS_GENIE` notifications do not return this value. The notification interval must be configured and managed within each external service.
        :param pulumi.Input[builtins.str] microsoft_teams_webhook_url: Microsoft Teams Webhook Uniform Resource Locator (URL) that MongoDB Cloud needs to send this notification via Microsoft Teams. Required if `type_name` is `MICROSOFT_TEAMS`. If the URL later becomes invalid, MongoDB Cloud sends an email to the project owners. If the key remains invalid, MongoDB Cloud removes it.
        :param pulumi.Input[builtins.str] mobile_number: Mobile number to which alert notifications are sent. Required for the SMS notifications type.
        :param pulumi.Input[builtins.str] notifier_id: The notifier ID is a system-generated unique identifier assigned to each notification method. This is needed when updating third-party notifications without requiring explicit authentication credentials.
        :param pulumi.Input[builtins.str] ops_genie_api_key: Opsgenie API Key. Required for the `OPS_GENIE` notifications type. If the key later becomes invalid, Atlas sends an email to the project owner and eventually removes the token.
        :param pulumi.Input[builtins.str] ops_genie_region: Region that indicates which API URL to use. Accepted regions are: `US` ,`EU`. The default Opsgenie region is US.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: Optional. One or more roles that receive the configured alert. If you include this field, Atlas sends alerts only to users assigned the roles you specify in the array. If you omit this field, Atlas sends alerts to users assigned any role. This parameter is only valid if `type_name` is set to `ORG`, `GROUP`, or `USER`.
               Accepted values are:
               ...
               | `GROUP_OWNER`                   | `ORG_READ_ONLY`     |
               | `GROUP_READ_ONLY`               |                     |
        :param pulumi.Input[builtins.str] service_key: PagerDuty service key. Required for the PAGER_DUTY notifications type. If the key later becomes invalid, Atlas sends an email to the project owner and eventually removes the key.
        :param pulumi.Input[builtins.bool] sms_enabled: Flag indicating if text message notifications should be sent to this user's mobile phone. This flag is only valid if `type_name` is set to `ORG`, `GROUP`, or `USER`.
        :param pulumi.Input[builtins.str] team_id: Unique identifier of a team.
        :param pulumi.Input[builtins.str] team_name: Label for the team that receives this notification.
        :param pulumi.Input[builtins.str] username: Name of the Atlas user to which to send notifications. Only a user in the project that owns the alert configuration is allowed here. Required for the `USER` notifications type.
        :param pulumi.Input[builtins.str] victor_ops_api_key: VictorOps API key. Required for the `VICTOR_OPS` notifications type. If the key later becomes invalid, Atlas sends an email to the project owner and eventually removes the key.
        :param pulumi.Input[builtins.str] victor_ops_routing_key: VictorOps routing key. Optional for the `VICTOR_OPS` notifications type. If the key later becomes invalid, Atlas sends an email to the project owner and eventually removes the key.
        :param pulumi.Input[builtins.str] webhook_secret: Optional authentication secret for the `WEBHOOK` notifications type.
        :param pulumi.Input[builtins.str] webhook_url: Target URL  for the `WEBHOOK` notifications type.
        """
    ...
    def datadog_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Region that indicates which API URL to use. See the `datadogRegion` field in the `notifications` request parameter of [MongoDB API Alert Configuration documentation](https://www.mongodb.com/docs/api/doc/atlas-admin-api-v2/operation/operation-createalertconfiguration) for more details. The default Datadog region is US.
        """
    ...
    def datadog_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "datadog_region", value)

    @property
    @pulumi.getter(name="delayMin")
    def delay_min(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of minutes to wait after an alert condition is detected before sending out the first notification.
        """
    ...
    @delay_min.setter
    def delay_min(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def interval_min(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of minutes to wait between successive notifications for unacknowledged alerts that are not resolved. The minimum value is 5. **NOTE** `PAGER_DUTY`, `VICTOR_OPS`, and `OPS_GENIE` notifications do not return this value. The notification interval must be configured and managed within each external service.
        """
    ...
    @interval_min.setter
    def interval_min(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def mobile_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mobile number to which alert notifications are sent. Required for the SMS notifications type.
        """
    ...
    def mobile_number(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mobile_number", value)

    @property
    @pulumi.getter(name="notifierId")
    def notifier_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The notifier ID is a system-generated unique identifier assigned to each notification method. This is needed when updating third-party notifications without requiring explicit authentication credentials.
        """
    ...
    @notifier_id.setter
    def notifier_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "notifier_id", value)

    @property
    @pulumi.getter(name="opsGenieApiKey")
    def ops_genie_api_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Opsgenie API Key. Required for the `OPS_GENIE` notifications type. If the key later becomes invalid, Atlas sends an email to the project owner and eventually removes the token.
        """
    ...
    def ops_genie_api_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ops_genie_api_key", value)

    @property
    @pulumi.getter(name="opsGenieRegion")
    def ops_genie_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Region that indicates which API URL to use. Accepted regions are: `US` ,`EU`. The default Opsgenie region is US.
        """
    ...
    def ops_genie_region(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def victor_ops_api_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        VictorOps API key. Required for the `VICTOR_OPS` notifications type. If the key later becomes invalid, Atlas sends an email to the project owner and eventually removes the key.
        """
    ...
    def victor_ops_api_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "victor_ops_api_key", value)

    @property
    @pulumi.getter(name="victorOpsRoutingKey")
    def victor_ops_routing_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        VictorOps routing key. Optional for the `VICTOR_OPS` notifications type. If the key later becomes invalid, Atlas sends an email to the project owner and eventually removes the key.
        """
    ...
    def victor_ops_routing_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BackupCompliancePolicyOnDemandPolicyItemArgs:
    def __init__(__self__, *,
                 ...
                 retention_unit: pulumi.Input[builtins.str],
                 retention_value: pulumi.Input[builtins.int],
                 frequency_type: Optional[pulumi.Input[builtins.str]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] frequency_interval: Desired frequency of the new backup policy item specified by `frequency_type` (yearly in this case). The supported values for yearly policies are
        :param pulumi.Input[builtins.str] retention_unit: Scope of the backup policy item: `days`, `weeks`, `months`, or `years`.
        :param pulumi.Input[builtins.int] retention_value: Value to associate with `retention_unit`. Yearly policy must have retention of at least 1 year.
        :param pulumi.Input[builtins.str] frequency_type: Frequency associated with the backup policy item. For yearly policies, the frequency type is defined as `yearly`. Note that this is a read-only value and not required in plan files - its value is implied from the policy resource type.
        :param pulumi.Input[builtins.str] id: Unique identifier of the backup policy item.
        """
    ...
    def retention_unit(self) -> pulumi.Input[builtins.str]:
        """
        Scope of the backup policy item: `days`, `weeks`, `months`, or `years`.
        """
    ...
    def retention_unit(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "retention_unit", value)

    @property
    @pulumi.getter(name="retentionValue")
    def retention_value(self) -> pulumi.Input[builtins.int]:
        """
        Value to associate with `retention_unit`. Yearly policy must have retention of at least 1 year.
        """
    ...
    def retention_value(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "retention_value", value)

    @property
    @pulumi.getter(name="frequencyType")
    def frequency_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Frequency associated with the backup policy item. For yearly policies, the frequency type is defined as `yearly`. Note that this is a read-only value and not required in plan files - its value is implied from the policy resource type.
        """
    ...
    def frequency_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CloudBackupScheduleCopySettingArgsDict(TypedDict):
        ...
        """
        frequencies: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        replication_spec_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        should_copy_oplogs: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CloudBackupScheduleCopySettingArgs:
    def __init__(__self__, *,
                 ...
                 frequencies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 region_name: Optional[pulumi.Input[builtins.str]] = None,
                 replication_spec_id: Optional[pulumi.Input[builtins.str]] = None,
                 should_copy_oplogs: Optional[pulumi.Input[builtins.bool]] = None,
                 zone_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cloud_provider: Human-readable label that identifies the cloud provider that stores the snapshot copy. i.e. "AWS" "AZURE" "GCP"
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] frequencies: List that describes which types of snapshots to copy. i.e. "HOURLY" "DAILY" "WEEKLY" "MONTHLY" "ON_DEMAND"
        :param pulumi.Input[builtins.str] region_name: Target region to copy snapshots belonging to replicationSpecId to. Please supply the 'Atlas Region' which can be found under https://www.mongodb.com/docs/atlas/reference/cloud-providers/ 'regions' link
        :param pulumi.Input[builtins.str] replication_spec_id: Unique 24-hexadecimal digit string that identifies the replication object for a zone in a cluster. For global clusters, there can be multiple zones to choose from. For sharded clusters and replica set clusters, there is only one zone in the cluster. To find the Replication Spec Id, consult the replicationSpecs array returned from [Return One Multi-Cloud Cluster in One Project](https://www.mongodb.com/docs/api/doc/atlas-admin-api-v2/operation/operation-getcluster). **(DEPRECATED)** Use `zone_id` instead. To learn more, see the 1.18.0 upgrade guide.
        :param pulumi.Input[builtins.bool] should_copy_oplogs: Flag that indicates whether to copy the oplogs to the target region. You can use the oplogs to perform point-in-time restores.
        :param pulumi.Input[builtins.str] zone_id: Unique 24-hexadecimal digit string that identifies the zone in a cluster. For global clusters, there can be multiple zones to choose from. For sharded clusters and replica set clusters, there is only one zone in the cluster. To find appropriate value for `zone_id`, do a GET request to Return One Cluster from One Project and consult the replicationSpecs array Return One Cluster From One Project. Alternately, use `AdvancedCluster` data source or resource and reference `replication_specs.#.zone_id`.
        """
    ...
    @property
    @pulumi.getter
    def frequencies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List that describes which types of snapshots to copy. i.e. "HOURLY" "DAILY" "WEEKLY" "MONTHLY" "ON_DEMAND"
        """
    ...
    @frequencies.setter
    def frequencies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def replication_spec_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_spec_id", value)

    @property
    @pulumi.getter(name="shouldCopyOplogs")
    def should_copy_oplogs(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Flag that indicates whether to copy the oplogs to the target region. You can use the oplogs to perform point-in-time restores.
        """
    ...
    def should_copy_oplogs(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class CloudBackupScheduleExportArgsDict(TypedDict):
        export_bucket_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CloudBackupScheduleExportArgs:
    def __init__(__self__, *,
                 export_bucket_id: Optional[pulumi.Input[builtins.str]] = None,
                 frequency_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] export_bucket_id: Unique identifier of the CloudBackupSnapshotExportBucket export_bucket_id value.
        :param pulumi.Input[builtins.str] frequency_type: Frequency associated with the export snapshot item: `weekly`, `monthly`, `yearly`, `daily` (requires reaching out to Customer Support)
        """
    ...
    def export_bucket_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique identifier of the CloudBackupSnapshotExportBucket export_bucket_id value.
        """
    ...
    def export_bucket_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CloudBackupSchedulePolicyItemDailyArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] frequency_interval: Desired frequency of the new backup policy item specified by `frequency_type` (daily in this case). The only supported value for daily policies is `1` day.
        :param pulumi.Input[builtins.str] retention_unit: Scope of the backup policy item: `days`, `weeks`, `months`, or `years`.
        :param pulumi.Input[builtins.int] retention_value: Value to associate with `retention_unit`.  Note that for less frequent policy items, Atlas requires that you specify a retention period greater than or equal to the retention period specified for more frequent policy items. For example: If the hourly policy item specifies a retention of two days, the daily retention policy must specify two days or greater.
        :param pulumi.Input[builtins.str] frequency_type: Frequency associated with the backup policy item. For daily policies, the frequency type is defined as `daily`. Note that this is a read-only value and not required in plan files - its value is implied from the policy resource type.
        :param pulumi.Input[builtins.str] id: Unique identifier of the backup policy item.
        """
        pulumi.set(__self__, "frequency_interval", frequency_interval)
        pulumi.set(__self__, "retention_unit", retention_unit)
...
class CloudBackupSchedulePolicyItemHourlyArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] frequency_interval: Desired frequency of the new backup policy item specified by `frequency_type` (hourly in this case). The supported values for hourly policies are `1`, `2`, `4`, `6`, `8` or `12` hours. Note that `12` hours is the only accepted value for NVMe clusters.
        :param pulumi.Input[builtins.str] retention_unit: Scope of the backup policy item: `days`, `weeks`, `months`, or `years`.
        :param pulumi.Input[builtins.int] retention_value: Value to associate with `retention_unit`.
        :param pulumi.Input[builtins.str] frequency_type: Frequency associated with the backup policy item. For hourly policies, the frequency type is defined as `hourly`. Note that this is a read-only value and not required in plan files - its value is implied from the policy resource type.
        :param pulumi.Input[builtins.str] id: Unique identifier of the backup policy item.
        """
        pulumi.set(__self__, "frequency_interval", frequency_interval)
        pulumi.set(__self__, "retention_unit", retention_unit)
...
class CloudBackupSchedulePolicyItemMonthlyArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] frequency_interval: Desired frequency of the new backup policy item specified by `frequency_type` (monthly in this case). The supported values for weekly policies are
        :param pulumi.Input[builtins.str] retention_unit: Scope of the backup policy item: `days`, `weeks`, `months`, or `years`.
        :param pulumi.Input[builtins.int] retention_value: Value to associate with `retention_unit`. Monthly policy must have retention days of at least 31 days or 5 weeks or 1 month. Note that for less frequent policy items, Atlas requires that you specify a retention period greater than or equal to the retention period specified for more frequent policy items. For example: If the weekly policy item specifies a retention of two weeks, the montly retention policy must specify two weeks or greater.
        :param pulumi.Input[builtins.str] frequency_type: Frequency associated with the backup policy item. For monthly policies, the frequency type is defined as `monthly`. Note that this is a read-only value and not required in plan files - its value is implied from the policy resource type.
        :param pulumi.Input[builtins.str] id: Unique identifier of the backup policy item.
        """
        pulumi.set(__self__, "frequency_interval", frequency_interval)
        pulumi.set(__self__, "retention_unit", retention_unit)
...
class CloudBackupSchedulePolicyItemWeeklyArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] frequency_interval: Desired frequency of the new backup policy item specified by `frequency_type` (weekly in this case). The supported values for weekly policies are `1` through `7`, where `1` represents Monday and `7` represents Sunday.
        :param pulumi.Input[builtins.str] retention_unit: Scope of the backup policy item: `days`, `weeks`, `months`, or `years`.
        :param pulumi.Input[builtins.int] retention_value: Value to associate with `retention_unit`. Weekly policy must have retention of at least 7 days or 1 week. Note that for less frequent policy items, Atlas requires that you specify a retention period greater than or equal to the retention period specified for more frequent policy items. For example: If the daily policy item specifies a retention of two weeks, the weekly retention policy must specify two weeks or greater.
        :param pulumi.Input[builtins.str] frequency_type: Frequency associated with the backup policy item. For weekly policies, the frequency type is defined as `weekly`. Note that this is a read-only value and not required in plan files - its value is implied from the policy resource type.
        :param pulumi.Input[builtins.str] id: Unique identifier of the backup policy item.
        """
        pulumi.set(__self__, "frequency_interval", frequency_interval)
        pulumi.set(__self__, "retention_unit", retention_unit)
...
if not MYPY:
    class CloudBackupSnapshotExportJobComponentArgsDict(TypedDict):
        ...
        """
        replica_set_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CloudBackupSnapshotExportJobComponentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] export_id: _Returned for sharded clusters only._ Export job details for each replica set in the sharded cluster.
        :param pulumi.Input[builtins.str] replica_set_name: _Returned for sharded clusters only._ Unique identifier of the export job for the replica set.
        """
...
class CloudBackupSnapshotExportJobCustomDataArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: Required if you want to include custom data using `custom_data` in the metadata file uploaded to the bucket. Key to include in the metadata file that Atlas uploads to the bucket when the export job finishes.
        :param pulumi.Input[builtins.str] value: Required if you specify `key`.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class CloudBackupSnapshotMemberArgs:
    def __init__(__self__, *,
                 ...
                 replica_set_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cloud_provider: Cloud provider that stores this snapshot.
        :param pulumi.Input[builtins.str] id: Unique identifier for the sharded cluster snapshot.
        :param pulumi.Input[builtins.str] replica_set_name: Label given to a shard or config server from which Atlas took this snapshot.
        """
        if cloud_provider is not None:
            pulumi.set(__self__, "cloud_provider", cloud_provider)
        if id is not None:
...
if not MYPY:
    class CloudBackupSnapshotRestoreJobDeliveryTypeConfigArgsDict(TypedDict):
        automated: NotRequired[pulumi.Input[builtins.bool]]
        download: NotRequired[pulumi.Input[builtins.bool]]
        oplog_inc: NotRequired[pulumi.Input[builtins.int]]
        oplog_ts: NotRequired[pulumi.Input[builtins.int]]
        point_in_time: NotRequired[pulumi.Input[builtins.bool]]
        point_in_time_utc_seconds: NotRequired[pulumi.Input[builtins.int]]
        target_cluster_name: NotRequired[pulumi.Input[builtins.str]]
        """
        Name of the target Atlas cluster to which the restore job restores the snapshot. Only visible if deliveryType is automated.
        """
        target_project_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CloudBackupSnapshotRestoreJobDeliveryTypeConfigArgs:
    def __init__(__self__, *,
                 automated: Optional[pulumi.Input[builtins.bool]] = None,
                 download: Optional[pulumi.Input[builtins.bool]] = None,
                 oplog_inc: Optional[pulumi.Input[builtins.int]] = None,
                 oplog_ts: Optional[pulumi.Input[builtins.int]] = None,
                 point_in_time: Optional[pulumi.Input[builtins.bool]] = None,
                 point_in_time_utc_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 target_cluster_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_project_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] target_cluster_name: Name of the target Atlas cluster to which the restore job restores the snapshot. Only visible if deliveryType is automated.
        :param pulumi.Input[builtins.str] target_project_id: Name of the target Atlas project of the restore job. Only visible if deliveryType is automated.
        """
    ...
    @property
    @pulumi.getter
    def automated(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "automated")

    @automated.setter
    def automated(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "automated", value)

    @property
    @pulumi.getter
    def download(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "download")

    @download.setter
    def download(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "download", value)

    @property
    @pulumi.getter(name="oplogInc")
    def oplog_inc(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "oplog_inc")

    @oplog_inc.setter
    def oplog_inc(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "oplog_inc", value)

    @property
    @pulumi.getter(name="oplogTs")
    def oplog_ts(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "oplog_ts")

    @oplog_ts.setter
    def oplog_ts(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "oplog_ts", value)

    @property
    @pulumi.getter(name="pointInTime")
    def point_in_time(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "point_in_time")

    @point_in_time.setter
    def point_in_time(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "point_in_time", value)

    @property
    @pulumi.getter(name="pointInTimeUtcSeconds")
    def point_in_time_utc_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "point_in_time_utc_seconds")

    @point_in_time_utc_seconds.setter
    def point_in_time_utc_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "point_in_time_utc_seconds", value)

    @property
    @pulumi.getter(name="targetClusterName")
    def target_cluster_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the target Atlas cluster to which the restore job restores the snapshot. Only visible if deliveryType is automated.
        """
    ...
    def target_cluster_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CloudProviderAccessAuthorizationAwsArgsDict(TypedDict):
        iam_assumed_role_arn: pulumi.Input[builtins.str]
elif False:
...
class CloudProviderAccessAuthorizationAzureArgs:
    ...
    def atlas_azure_app_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "atlas_azure_app_id")

    @atlas_azure_app_id.setter
    def atlas_azure_app_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class CloudProviderAccessAuthorizationFeatureUsageArgsDict(TypedDict):
        feature_id: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        feature_type: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class CloudProviderAccessAuthorizationFeatureUsageArgs:
    def __init__(__self__, *,
                 feature_id: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    def feature_id(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "feature_id")

    @feature_id.setter
    def feature_id(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class CloudProviderAccessSetupAwsConfigArgsDict(TypedDict):
        atlas_assumed_role_external_id: NotRequired[pulumi.Input[builtins.str]]
        atlas_aws_account_arn: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class CloudProviderAccessSetupAwsConfigArgs:
    def __init__(__self__, *,
                 atlas_assumed_role_external_id: Optional[pulumi.Input[builtins.str]] = None,
                 atlas_aws_account_arn: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def atlas_assumed_role_external_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "atlas_assumed_role_external_id")

    @atlas_assumed_role_external_id.setter
    def atlas_assumed_role_external_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "atlas_assumed_role_external_id", value)

    @property
    @pulumi.getter(name="atlasAwsAccountArn")
    def atlas_aws_account_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "atlas_aws_account_arn")

    @atlas_aws_account_arn.setter
    def atlas_aws_account_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterOutageSimulationOutageFilterArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cloud_provider: The cloud provider of the region that undergoes the outage simulation. Following values are supported:
               * `AWS`
               * `GCP`
               * `AZURE`
        :param pulumi.Input[builtins.str] region_name: The Atlas name of the region to undergo an outage simulation.
        :param pulumi.Input[builtins.str] type: The type of cluster outage simulation. Following values are supported:
               * `REGION` - Simulates a cluster outage for a region
        """
        pulumi.set(__self__, "cloud_provider", cloud_provider)
        pulumi.set(__self__, "region_name", region_name)
...
if not MYPY:
    class ClusterReplicationSpecArgsDict(TypedDict):
        num_shards: pulumi.Input[builtins.int]
        """
...
class ClusterReplicationSpecArgs:
    def __init__(__self__, *,
                 ...
                 zone_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] num_shards: Selects whether the cluster is a replica set or a sharded cluster. If you use the replicationSpecs parameter, you must set num_shards.
        :param pulumi.Input[builtins.str] id: Unique identifer of the replication document for a zone in a Global Cluster. This value corresponds to the legacy sharding schema (no independent shard scaling) and is different from the Shard ID you may see in the Atlas UI.
    ...
    @property
    @pulumi.getter(name="numShards")
    def num_shards(self) -> pulumi.Input[builtins.int]:
        """
        Selects whether the cluster is a replica set or a sharded cluster. If you use the replicationSpecs parameter, you must set num_shards.
        """
        return pulumi.get(self, "num_shards")
    ...
    @num_shards.setter
    def num_shards(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "num_shards", value)
...
if not MYPY:
    class ClusterReplicationSpecRegionsConfigArgsDict(TypedDict):
        ...
        Physical location of your MongoDB cluster. The region you choose can affect network latency for clients accessing your databases.  Requires the **Atlas region name**, see the reference list for [AWS](https://docs.atlas.mongodb.com/reference/amazon-aws/), [GCP](https://docs.atlas.mongodb.com/reference/google-gcp/), [Azure](https://docs.atlas.mongodb.com/reference/microsoft-azure/).
        """
        analytics_nodes: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of analytics nodes for Atlas to deploy to the region. Analytics nodes are useful for handling analytic data such as reporting queries from BI Connector for Atlas. Analytics nodes are read-only, and can never become the primary. If you do not specify this option, no analytics nodes are deployed to the region.
        """
        electable_nodes: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        * Example: If you have three regions, their priorities would be 7, 6, and 5 respectively. If you added two more regions for supporting electable nodes, the priorities of those regions would be 4 and 3 respectively.
        """
        read_only_nodes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ClusterReplicationSpecRegionsConfigArgs:
    def __init__(__self__, *,
                 region_name: pulumi.Input[builtins.str],
                 analytics_nodes: Optional[pulumi.Input[builtins.int]] = None,
                 electable_nodes: Optional[pulumi.Input[builtins.int]] = None,
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 read_only_nodes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] region_name: Physical location of your MongoDB cluster. The region you choose can affect network latency for clients accessing your databases.  Requires the **Atlas region name**, see the reference list for [AWS](https://docs.atlas.mongodb.com/reference/amazon-aws/), [GCP](https://docs.atlas.mongodb.com/reference/google-gcp/), [Azure](https://docs.atlas.mongodb.com/reference/microsoft-azure/).
        :param pulumi.Input[builtins.int] analytics_nodes: The number of analytics nodes for Atlas to deploy to the region. Analytics nodes are useful for handling analytic data such as reporting queries from BI Connector for Atlas. Analytics nodes are read-only, and can never become the primary. If you do not specify this option, no analytics nodes are deployed to the region.
        :param pulumi.Input[builtins.int] electable_nodes: Number of electable nodes for Atlas to deploy to the region. Electable nodes can become the primary and can facilitate local reads.
               * The total number of electableNodes across all replication spec regions  must total 3, 5, or 7.
               * Specify 0 if you do not want any electable nodes in the region.
               * You cannot create electable nodes in a region if `priority` is 0.
        :param pulumi.Input[builtins.int] priority: Election priority of the region. For regions with only read-only nodes, set this value to 0.
               ...
               * The priority 7 region identifies the Preferred Region of the cluster. Atlas places the primary node in the Preferred Region. Priorities 1 through 7 are exclusive - no more than one region per cluster can be assigned a given priority.
               * Example: If you have three regions, their priorities would be 7, 6, and 5 respectively. If you added two more regions for supporting electable nodes, the priorities of those regions would be 4 and 3 respectively.
        :param pulumi.Input[builtins.int] read_only_nodes: Number of read-only nodes for Atlas to deploy to the region. Read-only nodes can never become the primary, but can facilitate local-reads. Specify 0 if you do not want any read-only nodes in the region.
        """
        pulumi.set(__self__, "region_name", region_name)
    ...
    def analytics_nodes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of analytics nodes for Atlas to deploy to the region. Analytics nodes are useful for handling analytic data such as reporting queries from BI Connector for Atlas. Analytics nodes are read-only, and can never become the primary. If you do not specify this option, no analytics nodes are deployed to the region.
        """
    ...
    def analytics_nodes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "analytics_nodes", value)

    @property
    @pulumi.getter(name="electableNodes")
    def electable_nodes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of electable nodes for Atlas to deploy to the region. Electable nodes can become the primary and can facilitate local reads.
        * The total number of electableNodes across all replication spec regions  must total 3, 5, or 7.
        * Specify 0 if you do not want any electable nodes in the region.
    ...
    def electable_nodes(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def read_only_nodes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of read-only nodes for Atlas to deploy to the region. Read-only nodes can never become the primary, but can facilitate local-reads. Specify 0 if you do not want any read-only nodes in the region.
        """
    ...
    def read_only_nodes(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ClusterSnapshotBackupPolicyArgsDict(TypedDict):
        ...
        next_snapshot: NotRequired[pulumi.Input[builtins.str]]
        policies: NotRequired[pulumi.Input[Sequence[pulumi.Input['ClusterSnapshotBackupPolicyPolicyArgsDict']]]]
        reference_hour_of_day: NotRequired[pulumi.Input[builtins.int]]
        reference_minute_of_hour: NotRequired[pulumi.Input[builtins.int]]
        restore_window_days: NotRequired[pulumi.Input[builtins.int]]
        update_snapshots: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ClusterSnapshotBackupPolicyArgs:
    def __init__(__self__, *,
                 ...
                 next_snapshot: Optional[pulumi.Input[builtins.str]] = None,
                 policies: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterSnapshotBackupPolicyPolicyArgs']]]] = None,
                 reference_hour_of_day: Optional[pulumi.Input[builtins.int]] = None,
                 reference_minute_of_hour: Optional[pulumi.Input[builtins.int]] = None,
                 restore_window_days: Optional[pulumi.Input[builtins.int]] = None,
                 update_snapshots: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] cluster_id: The cluster ID.
        """
    ...
    def next_snapshot(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "next_snapshot")

    @next_snapshot.setter
    def next_snapshot(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def reference_hour_of_day(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "reference_hour_of_day")

    @reference_hour_of_day.setter
    def reference_hour_of_day(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "reference_hour_of_day", value)

    @property
    @pulumi.getter(name="referenceMinuteOfHour")
    def reference_minute_of_hour(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "reference_minute_of_hour")

    @reference_minute_of_hour.setter
    def reference_minute_of_hour(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "reference_minute_of_hour", value)

    @property
    @pulumi.getter(name="restoreWindowDays")
    def restore_window_days(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "restore_window_days")

    @restore_window_days.setter
    def restore_window_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "restore_window_days", value)

    @property
    @pulumi.getter(name="updateSnapshots")
    def update_snapshots(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "update_snapshots")

    @update_snapshots.setter
    def update_snapshots(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ClusterSnapshotBackupPolicyPolicyPolicyItemArgsDict(TypedDict):
        frequency_interval: NotRequired[pulumi.Input[builtins.int]]
        frequency_type: NotRequired[pulumi.Input[builtins.str]]
        id: NotRequired[pulumi.Input[builtins.str]]
        """
        Unique identifer of the replication document for a zone in a Global Cluster. This value corresponds to the legacy sharding schema (no independent shard scaling) and is different from the Shard ID you may see in the Atlas UI.
        ...
        retention_value: NotRequired[pulumi.Input[builtins.int]]
elif False:
...
class ClusterSnapshotBackupPolicyPolicyPolicyItemArgs:
    def __init__(__self__, *,
                 ...
                 retention_value: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] id: Unique identifer of the replication document for a zone in a Global Cluster. This value corresponds to the legacy sharding schema (no independent shard scaling) and is different from the Shard ID you may see in the Atlas UI.
        """
    ...
    @property
    @pulumi.getter(name="frequencyInterval")
    def frequency_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "frequency_interval")

    @frequency_interval.setter
    def frequency_interval(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "frequency_interval", value)
    ...
    @property
    @pulumi.getter(name="retentionValue")
    def retention_value(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "retention_value")

    @retention_value.setter
    def retention_value(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "retention_value", value)
...
class CustomDbRoleActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: Name of the privilege action. For a complete list of actions available in the Atlas API, see [Custom Role Actions](https://docs.atlas.mongodb.com/reference/api/custom-role-actions)
               > **Note**: The privilege actions available to the Custom Roles API resource represent a subset of the privilege actions available in the Atlas Custom Roles UI.
...
if not MYPY:
    class CustomDbRoleActionResourceArgsDict(TypedDict):
        cluster: NotRequired[pulumi.Input[builtins.bool]]
...
class CustomDbRoleActionResourceArgs:
    def __init__(__self__, *,
                 cluster: Optional[pulumi.Input[builtins.bool]] = None,
                 collection_name: Optional[pulumi.Input[builtins.str]] = None,
                 database_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] database_name: Database on which the inherited role is granted.
    ...
    @property
    @pulumi.getter
    def cluster(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "cluster")

    @cluster.setter
    def cluster(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class CustomDbRoleInheritedRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_name: Database on which the inherited role is granted.
               ...
               > **NOTE** This value should be admin for all roles except read and readWrite.
        :param pulumi.Input[builtins.str] role_name: Name of the inherited role. This can either be another custom role or a built-in role.
        """
        pulumi.set(__self__, "database_name", database_name)
...
class DataLakePipelineIngestionScheduleArgs:
    def __init__(__self__, *,
                 ...
                 retention_value: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] id: Unique 24-hexadecimal digit string that identifies the Data Lake Pipeline.
        """
        if frequency_interval is not None:
            pulumi.set(__self__, "frequency_interval", frequency_interval)
        if frequency_type is not None:
...
class DataLakePipelineSinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DataLakePipelineSinkPartitionFieldArgs']]] partition_fields: Ordered fields used to physically organize data in the destination.
               * `partition_fields.#.field_name` - Human-readable label that identifies the field name used to partition data.
               * `partition_fields.#.order` - Sequence in which MongoDB Atlas slices the collection data to create partitions. The resource expresses this sequence starting with zero.
        :param pulumi.Input[builtins.str] provider: Target cloud provider for this Data Lake Pipeline.
        :param pulumi.Input[builtins.str] region: Target cloud provider region for this Data Lake Pipeline. [Supported cloud provider regions](https://www.mongodb.com/docs/datalake/limitations).
        :param pulumi.Input[builtins.str] type: Type of ingestion source of this Data Lake Pipeline.
        """
...
if not MYPY:
    class DataLakePipelineSnapshotArgsDict(TypedDict):
        copy_region: NotRequired[pulumi.Input[builtins.str]]
        created_at: NotRequired[pulumi.Input[builtins.str]]
        expires_at: NotRequired[pulumi.Input[builtins.str]]
        frequency_yype: NotRequired[pulumi.Input[builtins.str]]
        id: NotRequired[pulumi.Input[builtins.str]]
        """
        Unique 24-hexadecimal digit string that identifies the Data Lake Pipeline.
        """
        master_key: NotRequired[pulumi.Input[builtins.str]]
        mongod_version: NotRequired[pulumi.Input[builtins.str]]
...
class DataLakePipelineSnapshotArgs:
    def __init__(__self__, *,
                 copy_region: Optional[pulumi.Input[builtins.str]] = None,
                 created_at: Optional[pulumi.Input[builtins.str]] = None,
                 expires_at: Optional[pulumi.Input[builtins.str]] = None,
                 frequency_yype: Optional[pulumi.Input[builtins.str]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 master_key: Optional[pulumi.Input[builtins.str]] = None,
                 mongod_version: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def copy_region(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "copy_region")

    @copy_region.setter
    def copy_region(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def frequency_yype(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "frequency_yype")

    @frequency_yype.setter
    def frequency_yype(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def mongod_version(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "mongod_version")

    @mongod_version.setter
    def mongod_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DataLakePipelineSourceArgsDict(TypedDict):
        ...
        """
        policy_item_id: NotRequired[pulumi.Input[builtins.str]]
...
class DataLakePipelineSourceArgs:
    def __init__(__self__, *,
                 ...
                 collection_name: Optional[pulumi.Input[builtins.str]] = None,
                 database_name: Optional[pulumi.Input[builtins.str]] = None,
                 policy_item_id: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cluster_name: Human-readable name that identifies the cluster.
        :param pulumi.Input[builtins.str] collection_name: Human-readable name that identifies the collection.
        :param pulumi.Input[builtins.str] database_name: Human-readable name that identifies the database.
        :param pulumi.Input[builtins.str] project_id: The unique ID for the project to create a data lake pipeline.
        :param pulumi.Input[builtins.str] type: Type of ingestion source of this Data Lake Pipeline.
        """
        if cluster_name is not None:
            pulumi.set(__self__, "cluster_name", cluster_name)
    ...
    def policy_item_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "policy_item_id")

    @policy_item_id.setter
    def policy_item_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DatabaseUserRoleArgs:
    def __init__(__self__, *,
                 ...
                 collection_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] database_name: Database on which the user has the specified role. A role on the `admin` database can include privileges that apply to the other databases. This field should be set to `admin` for a custom MongoDB role.
        :param pulumi.Input[builtins.str] role_name: Name of the role to grant. See [Create a Database User](https://docs.atlas.mongodb.com/reference/api/database-users-create-a-user/) `roles.roleName` for valid values and restrictions.
        :param pulumi.Input[builtins.str] collection_name: Collection for which the role applies. You can specify a collection for the `read` and `readWrite` roles. If you do not specify a collection for `read` and `readWrite`, the role applies to all collections in the database (excluding some collections in the `system`. database).
        """
        pulumi.set(__self__, "database_name", database_name)
        pulumi.set(__self__, "role_name", role_name)
        if collection_name is not None:
...
class DatabaseUserScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Type of resource that the user has access to. See [Database User API](https://www.mongodb.com/docs/api/doc/atlas-admin-api-v2/operation/operation-createdatabaseuser) for the list of valid values.
        """
        if name is not None:
...
if not MYPY:
    class EncryptionAtRestAwsKmsConfigArgsDict(TypedDict):
        ...
        """
        customer_master_key_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        require_private_networking: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        valid: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class EncryptionAtRestAwsKmsConfigArgs:
    def __init__(__self__, *,
                 ...
                 customer_master_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 require_private_networking: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] access_key_id: Unique alphanumeric string that identifies an Identity and Access Management (IAM) access key with permissions required to access your Amazon Web Services (AWS) Customer Master Key (CMK).
        :param pulumi.Input[builtins.str] customer_master_key_id: Unique alphanumeric string that identifies the Amazon Web Services (AWS) Customer Master Key (CMK) you used to encrypt and decrypt the MongoDB master keys.
        ...
        :param pulumi.Input[builtins.str] region: Physical location where MongoDB Atlas deploys your AWS-hosted MongoDB cluster nodes. The region you choose can affect network latency for clients accessing your databases. When MongoDB Cloud deploys a dedicated cluster, it checks if a VPC or VPC connection exists for that provider and region. If not, MongoDB Atlas creates them as part of the deployment. MongoDB Atlas assigns the VPC a CIDR block. To limit a new VPC peering connection to one CIDR block and region, create the connection first. Deploy the cluster after the connection starts.
        :param pulumi.Input[builtins.bool] require_private_networking: Enable connection to your Amazon Web Services (AWS) Key Management Service (KMS) over private networking.
        :param pulumi.Input[builtins.str] role_id: Unique 24-hexadecimal digit string that identifies an Amazon Web Services (AWS) Identity and Access Management (IAM) role. This IAM role has the permissions required to manage your AWS customer master key.
        :param pulumi.Input[builtins.str] secret_access_key: Human-readable label of the Identity and Access Management (IAM) secret access key with permissions required to access your Amazon Web Services (AWS) customer master key.
        :param pulumi.Input[builtins.bool] valid: Flag that indicates whether the Amazon Web Services (AWS) Key Management Service (KMS) encryption key can encrypt and decrypt data.
        """
    ...
    def customer_master_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique alphanumeric string that identifies the Amazon Web Services (AWS) Customer Master Key (CMK) you used to encrypt and decrypt the MongoDB master keys.
        """
    ...
    def customer_master_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def require_private_networking(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable connection to your Amazon Web Services (AWS) Key Management Service (KMS) over private networking.
        """
    ...
    def require_private_networking(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class EncryptionAtRestAzureKeyVaultConfigArgsDict(TypedDict):
        azure_environment: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        key_vault_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EncryptionAtRestAzureKeyVaultConfigArgs:
    def __init__(__self__, *,
                 ...
                 key_vault_name: Optional[pulumi.Input[builtins.str]] = None,
                 require_private_networking: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 valid: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] azure_environment: Azure environment in which your account credentials reside.
        :param pulumi.Input[builtins.str] client_id: Unique 36-hexadecimal character string that identifies an Azure application associated with your Azure Active Directory tenant.
        :param pulumi.Input[builtins.bool] enabled: Flag that indicates whether someone enabled encryption at rest for the specified  project. To disable encryption at rest using customer key management and remove the configuration details, pass only this parameter with a value of `false`.
        :param pulumi.Input[builtins.str] key_identifier: Web address with a unique key that identifies for your Azure Key Vault.
        :param pulumi.Input[builtins.str] key_vault_name: Unique string that identifies the Azure Key Vault that contains your key.
        :param pulumi.Input[builtins.bool] require_private_networking: Enable connection to your Azure Key Vault over private networking.
        :param pulumi.Input[builtins.str] resource_group_name: Name of the Azure resource group that contains your Azure Key Vault.
        :param pulumi.Input[builtins.str] secret: Private data that you need secured and that belongs to the specified Azure Key Vault (AKV) tenant (**azureKeyVault.tenantID**). This data can include any type of sensitive data such as passwords, database connection strings, API keys, and the like. AKV stores this information as encrypted binary data.
        :param pulumi.Input[builtins.str] subscription_id: Unique 36-hexadecimal character string that identifies your Azure subscription.
        :param pulumi.Input[builtins.str] tenant_id: Unique 36-hexadecimal character string that identifies the Azure Active Directory tenant within your Azure subscription.
        :param pulumi.Input[builtins.bool] valid: Flag that indicates whether the Azure encryption key can encrypt and decrypt data.
        """
    ...
    def key_vault_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique string that identifies the Azure Key Vault that contains your key.
        """
    ...
    def key_vault_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class EncryptionAtRestGoogleCloudKmsConfigArgsDict(TypedDict):
        ...
        Flag that indicates whether someone enabled encryption at rest for the specified  project. To disable encryption at rest using customer key management and remove the configuration details, pass only this parameter with a value of `false`.
        """
        key_version_resource_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Resource path that displays the key version resource ID for your Google Cloud KMS.
        """
        service_account_key: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EncryptionAtRestGoogleCloudKmsConfigArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 key_version_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_account_key: Optional[pulumi.Input[builtins.str]] = None,
                 valid: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Flag that indicates whether someone enabled encryption at rest for the specified  project. To disable encryption at rest using customer key management and remove the configuration details, pass only this parameter with a value of `false`.
        :param pulumi.Input[builtins.str] key_version_resource_id: Resource path that displays the key version resource ID for your Google Cloud KMS.
        :param pulumi.Input[builtins.str] service_account_key: JavaScript Object Notation (JSON) object that contains the Google Cloud Key Management Service (KMS). Format the JSON as a string and not as an object.
        :param pulumi.Input[builtins.bool] valid: Flag that indicates whether the Google Cloud Key Management Service (KMS) encryption key can encrypt and decrypt data.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def key_version_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Resource path that displays the key version resource ID for your Google Cloud KMS.
        """
    ...
    def key_version_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class EventTriggerEventProcessorsAwsEventbridgeArgsDict(TypedDict):
        config_account_id: NotRequired[pulumi.Input[builtins.str]]
        config_region: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class EventTriggerEventProcessorsAwsEventbridgeArgs:
    def __init__(__self__, *,
                 config_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 config_region: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def config_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "config_account_id")

    @config_account_id.setter
    def config_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "config_account_id", value)

    @property
    @pulumi.getter(name="configRegion")
    def config_region(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "config_region")

    @config_region.setter
    def config_region(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FederatedDatabaseInstanceCloudProviderConfigAwsArgsDict(TypedDict):
        ...
        test_s3_bucket: pulumi.Input[builtins.str]
        external_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        iam_assumed_role_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        * `s3:GetObjectVersion`
        """
        iam_user_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FederatedDatabaseInstanceCloudProviderConfigAwsArgs:
    def __init__(__self__, *,
                 ...
                 test_s3_bucket: pulumi.Input[builtins.str],
                 external_id: Optional[pulumi.Input[builtins.str]] = None,
                 iam_assumed_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 iam_user_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] external_id: Unique identifier associated with the IAM Role that the Federated Database Instance assumes when accessing the data stores.
        :param pulumi.Input[builtins.str] iam_assumed_role_arn: Amazon Resource Name (ARN) of the IAM Role that the Federated Database Instance assumes when accessing S3 Bucket data stores. The IAM Role must support the following actions against each S3 bucket:
               * `s3:GetObject`
               * `s3:ListBucket`
               * `s3:GetObjectVersion`
        :param pulumi.Input[builtins.str] iam_user_arn: Amazon Resource Name (ARN) of the user that the Federated Database Instance assumes when accessing S3 Bucket data stores.
        """
        pulumi.set(__self__, "role_id", role_id)
    ...
    def test_s3_bucket(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "test_s3_bucket")

    @test_s3_bucket.setter
    def test_s3_bucket(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter(name="iamAssumedRoleArn")
    def iam_assumed_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Amazon Resource Name (ARN) of the IAM Role that the Federated Database Instance assumes when accessing S3 Bucket data stores. The IAM Role must support the following actions against each S3 bucket:
        * `s3:GetObject`
        * `s3:ListBucket`
    ...
    @iam_assumed_role_arn.setter
    def iam_assumed_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "iam_assumed_role_arn", value)

    @property
    @pulumi.getter(name="iamUserArn")
    def iam_user_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Amazon Resource Name (ARN) of the user that the Federated Database Instance assumes when accessing S3 Bucket data stores.
        """
    ...
    @iam_user_arn.setter
    def iam_user_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FederatedDatabaseInstanceStorageDatabaseArgsDict(TypedDict):
        ...
        max_wildcard_collections: NotRequired[pulumi.Input[builtins.int]]
        name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FederatedDatabaseInstanceStorageDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 max_wildcard_collections: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 views: Optional[pulumi.Input[Sequence[pulumi.Input['FederatedDatabaseInstanceStorageDatabaseViewArgs']]]] = None):
        """
        :param pulumi.Input[builtins.str] name: Name of the Atlas Federated Database Instance.
        """
    ...
    def max_wildcard_collections(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "max_wildcard_collections")

    @max_wildcard_collections.setter
    def max_wildcard_collections(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class FederatedDatabaseInstanceStorageDatabaseCollectionDataSourceArgsDict(TypedDict):
        ...
        collection_regex: NotRequired[pulumi.Input[builtins.str]]
        database: NotRequired[pulumi.Input[builtins.str]]
        database_regex: NotRequired[pulumi.Input[builtins.str]]
        dataset_name: NotRequired[pulumi.Input[builtins.str]]
        default_format: NotRequired[pulumi.Input[builtins.str]]
        path: NotRequired[pulumi.Input[builtins.str]]
        provenance_field_name: NotRequired[pulumi.Input[builtins.str]]
...
class FederatedDatabaseInstanceStorageDatabaseCollectionDataSourceArgs:
    def __init__(__self__, *,
                 ...
                 collection_regex: Optional[pulumi.Input[builtins.str]] = None,
                 database: Optional[pulumi.Input[builtins.str]] = None,
                 database_regex: Optional[pulumi.Input[builtins.str]] = None,
                 dataset_name: Optional[pulumi.Input[builtins.str]] = None,
                 default_format: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input[builtins.str]] = None,
                 provenance_field_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def collection_regex(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "collection_regex")

    @collection_regex.setter
    def collection_regex(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def database_regex(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "database_regex")

    @database_regex.setter
    def database_regex(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def default_format(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "default_format")

    @default_format.setter
    def default_format(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provenance_field_name(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "provenance_field_name")

    @provenance_field_name.setter
    def provenance_field_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FederatedDatabaseInstanceStorageStoreArgsDict(TypedDict):
        additional_storage_classes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        allow_insecure: NotRequired[pulumi.Input[builtins.bool]]
        bucket: NotRequired[pulumi.Input[builtins.str]]
        cluster_name: NotRequired[pulumi.Input[builtins.str]]
        default_format: NotRequired[pulumi.Input[builtins.str]]
        delimiter: NotRequired[pulumi.Input[builtins.str]]
        include_tags: NotRequired[pulumi.Input[builtins.bool]]
        name: NotRequired[pulumi.Input[builtins.str]]
        """
        Name of the Atlas Federated Database Instance.
        """
        ...
        """
        provider: NotRequired[pulumi.Input[builtins.str]]
        public: NotRequired[pulumi.Input[builtins.str]]
...
class FederatedDatabaseInstanceStorageStoreArgs:
    def __init__(__self__, *,
                 additional_storage_classes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 allow_insecure: Optional[pulumi.Input[builtins.bool]] = None,
                 bucket: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_name: Optional[pulumi.Input[builtins.str]] = None,
                 default_format: Optional[pulumi.Input[builtins.str]] = None,
                 delimiter: Optional[pulumi.Input[builtins.str]] = None,
                 include_tags: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 prefix: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 provider: Optional[pulumi.Input[builtins.str]] = None,
                 public: Optional[pulumi.Input[builtins.str]] = None,
                 read_preference: Optional[pulumi.Input['FederatedDatabaseInstanceStorageStoreReadPreferenceArgs']] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 urls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] name: Name of the Atlas Federated Database Instance.
        :param pulumi.Input[builtins.str] project_id: The unique ID for the project to create a Federated Database Instance.
        """
    ...
    def additional_storage_classes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "additional_storage_classes")

    @additional_storage_classes.setter
    def additional_storage_classes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def include_tags(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "include_tags")

    @include_tags.setter
    def include_tags(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def public(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "public")

    @public.setter
    def public(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FederatedDatabaseInstanceStorageStoreReadPreferenceArgsDict(TypedDict):
        max_staleness_seconds: NotRequired[pulumi.Input[builtins.int]]
        mode: NotRequired[pulumi.Input[builtins.str]]
...
class FederatedDatabaseInstanceStorageStoreReadPreferenceArgs:
    def __init__(__self__, *,
                 max_staleness_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 mode: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def max_staleness_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "max_staleness_seconds")

    @max_staleness_seconds.setter
    def max_staleness_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class FederatedSettingsOrgConfigUserConflictArgsDict(TypedDict):
        ...
        """
        federation_settings_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FederatedSettingsOrgConfigUserConflictArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] email_address: Email address of the the user that conflicts with selected domains.
        ...
        :param pulumi.Input[builtins.str] first_name: First name of the the user that conflicts with selected domains.
        :param pulumi.Input[builtins.str] last_name: Last name of the the user that conflicts with selected domains.
        :param pulumi.Input[builtins.str] user_id: Name of the Atlas user that conflicts with selected domains.
        """
        if email_address is not None:
            pulumi.set(__self__, "email_address", email_address)
...
class FederatedSettingsOrgRoleMappingRoleAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] group_id: Unique identifier of the project to which you want the role mapping to apply.
        :param pulumi.Input[builtins.str] org_id: Unique 24-hexadecimal digit string that identifies the organization that contains your projects.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: Specifies the Roles that are attached to the Role Mapping. Available role IDs can be found on [the User Roles
               Reference](https://www.mongodb.com/docs/atlas/reference/user-roles/).
        """
...
class FlexClusterBackupSettingsArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Flag that indicates whether backups are performed for this flex cluster. Backup uses [flex cluster backups](https://www.mongodb.com/docs/atlas/backup/cloud-backup/flex-cluster-backup/).
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class FlexClusterConnectionStringsArgs:
    def __init__(__self__, *,
                 ...
                 standard_srv: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] standard: Public connection string that you can use to connect to this cluster. This connection string uses the mongodb:// protocol.
        :param pulumi.Input[builtins.str] standard_srv: Public connection string that you can use to connect to this flex cluster. This connection string uses the `mongodb+srv://` protocol.
        """
        if standard is not None:
            pulumi.set(__self__, "standard", standard)
        if standard_srv is not None:
...
if not MYPY:
    class FlexClusterProviderSettingsArgsDict(TypedDict):
        backing_provider_name: pulumi.Input[builtins.str]
        """
...
class FlexClusterProviderSettingsArgs:
    def __init__(__self__, *,
                 ...
                 provider_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] backing_provider_name: Cloud service provider on which MongoDB Cloud provisioned the flex cluster.
        :param pulumi.Input[builtins.str] region_name: Human-readable label that identifies the geographic location of your MongoDB flex cluster. The region you choose can affect network latency for clients accessing your databases. For a complete list of region names, see [AWS](https://docs.atlas.mongodb.com/reference/amazon-aws/#std-label-amazon-aws), [GCP](https://docs.atlas.mongodb.com/reference/google-gcp/), and [Azure](https://docs.atlas.mongodb.com/reference/microsoft-azure/).
        :param pulumi.Input[builtins.float] disk_size_gb: Storage capacity available to the flex cluster expressed in gigabytes.
    ...
    @property
    @pulumi.getter(name="backingProviderName")
    def backing_provider_name(self) -> pulumi.Input[builtins.str]:
        """
        Cloud service provider on which MongoDB Cloud provisioned the flex cluster.
        """
        return pulumi.get(self, "backing_provider_name")
    ...
    @backing_provider_name.setter
    def backing_provider_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "backing_provider_name", value)
...
class GlobalClusterConfigCustomZoneMappingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] location: The ISO location code to which you want to map a zone in your Global Cluster. You can find a list of all supported location codes [here](https://cloud.mongodb.com/static/atlas/country_iso_codes.txt).
        :param pulumi.Input[builtins.str] zone: The name of the zone in your Global Cluster that you want to map to location.
        """
...
if not MYPY:
    class GlobalClusterConfigManagedNamespaceArgsDict(TypedDict):
        ...
        """
        custom_shard_key: pulumi.Input[builtins.str]
        """
        ...
        """
        is_custom_shard_key_hashed: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        is_shard_key_unique: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class GlobalClusterConfigManagedNamespaceArgs:
    def __init__(__self__, *,
                 ...
                 custom_shard_key: pulumi.Input[builtins.str],
                 db: pulumi.Input[builtins.str],
                 is_custom_shard_key_hashed: Optional[pulumi.Input[builtins.bool]] = None,
                 is_shard_key_unique: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] collection: The name of the collection associated with the managed namespace.
        :param pulumi.Input[builtins.str] custom_shard_key: The custom shard key for the collection. Global Clusters require a compound shard key consisting of a location field and a user-selected second key, the custom shard key.
        :param pulumi.Input[builtins.str] db: The name of the database containing the collection.
        :param pulumi.Input[builtins.bool] is_custom_shard_key_hashed: Specifies whether the custom shard key for the collection is [hashed](https://docs.mongodb.com/manual/reference/method/sh.shardCollection/#hashed-shard-keys). If omitted, defaults to `false`. If `false`, Atlas uses [ranged sharding](https://docs.mongodb.com/manual/core/ranged-sharding/). This is only available for Atlas clusters with MongoDB v4.4 and later.
        :param pulumi.Input[builtins.bool] is_shard_key_unique: Specifies whether the underlying index enforces a unique constraint. If omitted, defaults to false. You cannot specify true when using [hashed shard keys](https://docs.mongodb.com/manual/core/hashed-sharding/#std-label-sharding-hashed).
        """
        pulumi.set(__self__, "collection", collection)
    ...
    def custom_shard_key(self) -> pulumi.Input[builtins.str]:
        """
        The custom shard key for the collection. Global Clusters require a compound shard key consisting of a location field and a user-selected second key, the custom shard key.
        """
    ...
    def custom_shard_key(self, value: pulumi.Input[builtins.str]):
    ...
    def is_custom_shard_key_hashed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether the custom shard key for the collection is [hashed](https://docs.mongodb.com/manual/reference/method/sh.shardCollection/#hashed-shard-keys). If omitted, defaults to `false`. If `false`, Atlas uses [ranged sharding](https://docs.mongodb.com/manual/core/ranged-sharding/). This is only available for Atlas clusters with MongoDB v4.4 and later.
        """
    ...
    def is_custom_shard_key_hashed(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_custom_shard_key_hashed", value)

    @property
    @pulumi.getter(name="isShardKeyUnique")
    def is_shard_key_unique(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether the underlying index enforces a unique constraint. If omitted, defaults to false. You cannot specify true when using [hashed shard keys](https://docs.mongodb.com/manual/core/hashed-sharding/#std-label-sharding-hashed).
        """
    ...
    def is_shard_key_unique(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_shard_key_unique", value)


if not MYPY:
    class LdapConfigurationUserToDnMappingArgsDict(TypedDict):
        ldap_query: NotRequired[pulumi.Input[builtins.str]]
...
class LdapConfigurationUserToDnMappingArgs:
    def __init__(__self__, *,
                 ldap_query: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def ldap_query(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "ldap_query")

    @ldap_query.setter
    def ldap_query(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LdapVerifyValidationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] status: The current status of the LDAP over TLS/SSL configuration. One of the following values: `PENDING`, `SUCCESS`, and `FAILED`.
        """
        if status is not None:
            pulumi.set(__self__, "status", status)
...
if not MYPY:
    class OnlineArchiveCriteriaArgsDict(TypedDict):
        ...
        """
        date_field: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        date_format: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        expire_after_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class OnlineArchiveCriteriaArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str],
                 date_field: Optional[pulumi.Input[builtins.str]] = None,
                 date_format: Optional[pulumi.Input[builtins.str]] = None,
                 expire_after_days: Optional[pulumi.Input[builtins.int]] = None,
                 query: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Type of criteria (DATE, CUSTOM)
               
               The following fields are required for criteria type `DATE`
        :param pulumi.Input[builtins.str] date_field: Indexed database parameter that stores the date that determines when data moves to the online archive. MongoDB Cloud archives the data when the current date exceeds the date in this database parameter plus the number of days specified through the expireAfterDays parameter.
        :param pulumi.Input[builtins.str] date_format: Syntax used to write the date after which data moves to the online archive. Date can be expressed as ISO 8601 or Epoch timestamps. The Epoch timestamp can be expressed as nanoseconds, milliseconds, or seconds. You must set `type` to `DATE` if `collectionType` is `TIMESERIES`. Valid values:  ISODATE (default), EPOCH_SECONDS, EPOCH_MILLIS, EPOCH_NANOSECONDS.
        :param pulumi.Input[builtins.int] expire_after_days: Number of days after the value in the criteria.dateField when MongoDB Cloud archives data in the specified cluster.
               
               **_NOTE: if `DATE` is selected, the `partition_fields.field_name` must be completed with the `date_field` value_**
               
               The only field required for criteria type `CUSTOM`
        :param pulumi.Input[builtins.str] query: JSON query to use to select documents for archiving. Atlas uses the specified query with the db.collection.find(query) command. The empty document {} to return all documents is not supported.
        """
        pulumi.set(__self__, "type", type)
    ...
    def date_field(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Indexed database parameter that stores the date that determines when data moves to the online archive. MongoDB Cloud archives the data when the current date exceeds the date in this database parameter plus the number of days specified through the expireAfterDays parameter.
        """
    ...
    @date_field.setter
    def date_field(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def expire_after_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of days after the value in the criteria.dateField when MongoDB Cloud archives data in the specified cluster.
    ...
    def expire_after_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class OnlineArchiveDataExpirationRuleArgsDict(TypedDict):
        expire_after_days: pulumi.Input[builtins.int]
        """
...
class OnlineArchiveDataExpirationRuleArgs:
    def __init__(__self__, *,
                 expire_after_days: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] expire_after_days: Number of days used in the date criteria for nominating documents for deletion. Value must be between 7 and 9215.
        """
        pulumi.set(__self__, "expire_after_days", expire_after_days)

    @property
    @pulumi.getter(name="expireAfterDays")
    def expire_after_days(self) -> pulumi.Input[builtins.int]:
        """
        Number of days used in the date criteria for nominating documents for deletion. Value must be between 7 and 9215.
        """
        return pulumi.get(self, "expire_after_days")
    ...
    @expire_after_days.setter
    def expire_after_days(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "expire_after_days", value)
...
class OnlineArchiveDataProcessRegionArgs:
    def __init__(__self__, *,
                 ...
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cloud_provider: Human-readable label that identifies the Cloud service provider where you wish to store your archived data. `AZURE` may be selected only if Azure is the Cloud service provider for the cluster and no AWS online archive has been created for the cluster.
        :param pulumi.Input[builtins.str] region: Human-readable label that identifies the geographic location of the region where you wish to store your archived data. For allowed values, see [MongoDB Atlas API documentation](https://www.mongodb.com/docs/api/doc/atlas-admin-api-v2/operation/operation-createonlinearchive)
        """
        if cloud_provider is not None:
            pulumi.set(__self__, "cloud_provider", cloud_provider)
        if region is not None:
...
if not MYPY:
    class OnlineArchivePartitionFieldArgsDict(TypedDict):
        ...
        """
        field_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class OnlineArchivePartitionFieldArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] field_name: Human-readable label that identifies the parameter that MongoDB Cloud uses to partition data. To specify a nested parameter, use the dot notation.
        :param pulumi.Input[builtins.int] order: Sequence in which MongoDB Cloud slices the collection data to create partitions. The resource expresses this sequence starting with zero. The value of the `criteria.dateField` parameter defaults as the first item in the partition sequence.
        :param pulumi.Input[builtins.str] field_type: Data type of the parameter that that MongoDB Cloud uses to partition data. Partition parameters of type UUID must be of binary subtype 4. MongoDB Cloud skips partition parameters of type UUID with subtype 3. Valid values: `date`, `int`, `long`, `objectId`, `string`, `uuid`.
        """
        pulumi.set(__self__, "field_name", field_name)
        pulumi.set(__self__, "order", order)
...
if not MYPY:
    class OnlineArchiveScheduleArgsDict(TypedDict):
        ...
        """
        end_minute: NotRequired[pulumi.Input[builtins.int]]
        """
...
class OnlineArchiveScheduleArgs:
    def __init__(__self__, *,
                 ...
                 end_minute: Optional[pulumi.Input[builtins.int]] = None,
                 start_hour: Optional[pulumi.Input[builtins.int]] = None,
                 start_minute: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] type: Type of schedule (``DAILY`, `MONTHLY`, `WEEKLY`).
        :param pulumi.Input[builtins.int] day_of_month: Day of the month when the scheduled archive starts. This field should be provided only when schedule `type` is `MONTHLY`.
        :param pulumi.Input[builtins.int] day_of_week: Day of the week when the scheduled archive starts. The week starts with Monday (1) and ends with Sunday (7). This field should be provided only when schedule `type` is `WEEKLY`.
        :param pulumi.Input[builtins.int] end_hour: Hour of the day when the scheduled window to run one online archive ends.
        :param pulumi.Input[builtins.int] end_minute: Minute of the hour when the scheduled window to run one online archive ends.
        :param pulumi.Input[builtins.int] start_hour: Hour of the day when the when the scheduled window to run one online archive starts.
        :param pulumi.Input[builtins.int] start_minute: Minute of the hour when the scheduled window to run one online archive starts.
        """
        pulumi.set(__self__, "type", type)
    ...
    def end_minute(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Minute of the hour when the scheduled window to run one online archive ends.
        """
    ...
    @end_minute.setter
    def end_minute(self, value: Optional[pulumi.Input[builtins.int]]):
...
class PrivateLinkEndpointServiceEndpointArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] endpoint_name: Forwarding rule that corresponds to the endpoint you created in GCP.
        :param pulumi.Input[builtins.str] ip_address: Private IP address of the endpoint you created in GCP.
        :param pulumi.Input[builtins.str] status: Status of the endpoint. Atlas returns one of the [values shown above](https://docs.atlas.mongodb.com/reference/api/private-endpoints-endpoint-create-one/#std-label-ref-status-field).
        """
...
if not MYPY:
    class ProjectApiKeyProjectAssignmentArgsDict(TypedDict):
        ...
        """
        role_names: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ProjectApiKeyProjectAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 role_names: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] project_id: Project ID to assign to Access Key
    ...
    def role_names(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        List of Project roles that the Programmatic API key needs to have. Ensure you provide: at least one role and ensure all roles are valid for the Project. You must specify an array even if you are only associating a single role with the Programmatic API key. The [MongoDB Documentation](https://www.mongodb.com/docs/atlas/reference/user-roles/#project-roles) describes the valid roles that can be assigned.
        """
    ...
    @role_names.setter
    def role_names(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class ProjectIpAddressesServicesClusterArgsDict(TypedDict):
        cluster_name: NotRequired[pulumi.Input[builtins.str]]
        inbounds: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        outbounds: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
elif False:
...
class ProjectIpAddressesServicesClusterArgs:
    def __init__(__self__, *,
                 cluster_name: Optional[pulumi.Input[builtins.str]] = None,
                 inbounds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 outbounds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        if cluster_name is not None:
            pulumi.set(__self__, "cluster_name", cluster_name)
    ...
    @property
    @pulumi.getter
    def inbounds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "inbounds")

    @inbounds.setter
    def inbounds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "inbounds", value)

    @property
    @pulumi.getter
    def outbounds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "outbounds")

    @outbounds.setter
    def outbounds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ProjectLimitArgsDict(TypedDict):
        ...
        """
        current_usage: NotRequired[pulumi.Input[builtins.int]]
        default_limit: NotRequired[pulumi.Input[builtins.int]]
        maximum_limit: NotRequired[pulumi.Input[builtins.int]]
elif False:
...
class ProjectLimitArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 value: pulumi.Input[builtins.int],
                 current_usage: Optional[pulumi.Input[builtins.int]] = None,
                 default_limit: Optional[pulumi.Input[builtins.int]] = None,
                 maximum_limit: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] name: Human-readable label that identifies this project limit. See [Project Limit Documentation](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/Projects/operation/setProjectLimit) under `limitName` parameter to find all the limits that can be defined.
        :param pulumi.Input[builtins.int] value: Amount to set the limit to. Use the [Project Limit Documentation](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/Projects/operation/setProjectLimit) under `limitName` parameter to verify the override limits.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
    ...
    def current_usage(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "current_usage")

    @current_usage.setter
    def current_usage(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def maximum_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "maximum_limit")

    @maximum_limit.setter
    def maximum_limit(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ProjectTeamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] role_names: Each string in the array represents a project role you want to assign to the team. Every user associated with the team inherits these roles. You must specify an array even if you are only associating a single role with the team. The [MongoDB Documentation](https://www.mongodb.com/docs/atlas/reference/user-roles/#organization-roles) describes the roles a user can have.
               ...
               > **NOTE:** Project created by API Keys must belong to an existing organization.
        :param pulumi.Input[builtins.str] team_id: The unique identifier of the team you want to associate with the project. The team and project must share the same parent organization.
        """
        pulumi.set(__self__, "role_names", role_names)
        pulumi.set(__self__, "team_id", team_id)
...
if not MYPY:
    class ProviderAssumeRoleArgsDict(TypedDict):
        ...
        """
        policy_arns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        session_name: NotRequired[pulumi.Input[builtins.str]]
        """
        An identifier for the assumed role session.
        """
        source_identity: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        transitive_tag_keys: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ProviderAssumeRoleArgs:
    def __init__(__self__, *,
                 ...
                 source_identity: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 transitive_tag_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] duration: The duration, between 15 minutes and 12 hours, of the role session. Valid time units are ns, us (or µs), ms, s, h, or m.
        :param pulumi.Input[builtins.str] external_id: A unique identifier that might be required when you assume a role in another account.
        :param pulumi.Input[builtins.str] policy: IAM Policy JSON describing further restricting permissions for the IAM Role being assumed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] policy_arns: Amazon Resource Names (ARNs) of IAM Policies describing further restricting permissions for the IAM Role being assumed.
        :param pulumi.Input[builtins.str] role_arn: Amazon Resource Name (ARN) of an IAM Role to assume prior to making API calls.
        :param pulumi.Input[builtins.str] session_name: An identifier for the assumed role session.
        :param pulumi.Input[builtins.str] source_identity: Source identity specified by the principal assuming the role.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Assume role session tags.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transitive_tag_keys: Assume role session tag keys to pass to any subsequent sessions.
        """
    ...
    def source_identity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Source identity specified by the principal assuming the role.
        """
    ...
    def source_identity(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def transitive_tag_keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Assume role session tag keys to pass to any subsequent sessions.
        """
    ...
    def transitive_tag_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ResourcePolicyCreatedByUserArgs:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] id: Unique 24-hexadecimal character string that identifies a user.
        :param pulumi.Input[builtins.str] name: Human-readable label that describes a user.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if name is not None:
...
class ResourcePolicyPolicyArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] body: A string that defines the permissions for the policy. The syntax used is the Cedar Policy language.
        :param pulumi.Input[builtins.str] id: Unique 24-hexadecimal character string that identifies the policy.
        """
...
class SearchDeploymentSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] node_count: Number of search nodes in the cluster.
        """
        pulumi.set(__self__, "instance_size", instance_size)
        pulumi.set(__self__, "node_count", node_count)
...
if not MYPY:
    class SearchIndexSynonymArgsDict(TypedDict):
        analyzer: pulumi.Input[builtins.str]
        """
        ...
        """
        source_collection: pulumi.Input[builtins.str]
        """
...
class SearchIndexSynonymArgs:
    def __init__(__self__, *,
                 ...
                 source_collection: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] analyzer: [Analyzer](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/#std-label-analyzers-ref) to use when creating the index. Defaults to [lucene.standard](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/standard/#std-label-ref-standard-analyzer)
        :param pulumi.Input[builtins.str] name: The name of the search index you want to create.
        :param pulumi.Input[builtins.str] source_collection: (Required) Name of the source MongoDB collection for the synonyms. Documents in this collection must be in the format described in the [Synonyms Source Collection Documents](https://docs.atlas.mongodb.com/reference/atlas-search/synonyms/#std-label-synonyms-coll-spec).
        """
    ...
    @property
    @pulumi.getter
    def analyzer(self) -> pulumi.Input[builtins.str]:
        """
        [Analyzer](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/#std-label-analyzers-ref) to use when creating the index. Defaults to [lucene.standard](https://docs.atlas.mongodb.com/reference/atlas-search/analyzers/standard/#std-label-ref-standard-analyzer)
        """
    ...
    @analyzer.setter
    def analyzer(self, value: pulumi.Input[builtins.str]):
    ...
    def source_collection(self) -> pulumi.Input[builtins.str]:
        """
        (Required) Name of the source MongoDB collection for the synonyms. Documents in this collection must be in the format described in the [Synonyms Source Collection Documents](https://docs.atlas.mongodb.com/reference/atlas-search/synonyms/#std-label-synonyms-coll-spec).
        """
    ...
    def source_collection(self, value: pulumi.Input[builtins.str]):
...
class StreamConnectionAuthenticationArgs:
    def __init__(__self__, *,
                 ...
                 username: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] mechanism: Style of authentication. Can be one of `PLAIN`, `SCRAM-256`, or `SCRAM-512`.
        :param pulumi.Input[builtins.str] password: Password of the account to connect to the Kafka cluster.
        :param pulumi.Input[builtins.str] username: Username of the account to connect to the Kafka cluster.
        """
...
class StreamConnectionAwsArgs:
    def __init__(__self__, *,
                 role_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] role_arn: Amazon Resource Name (ARN) that identifies the Amazon Web Services (AWS) Identity and Access Management (IAM) role that MongoDB Cloud assumes when it accesses resources in your AWS account.
        """
        pulumi.set(__self__, "role_arn", role_arn)
...
class StreamConnectionDbRoleToExecuteArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] role: The name of the role to use. Value can be  `atlasAdmin`, `readWriteAnyDatabase`, or `readAnyDatabase` if `type` is set to `BUILT_IN`, or the name of a user-defined role if `type` is set to `CUSTOM`.
        :param pulumi.Input[builtins.str] type: Type of connection. Can be `AWSLambda`, `Cluster`, `Https`, `Kafka` or `Sample`.
        """
...
class StreamConnectionNetworkingAccessArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Selected networking type. Either `PUBLIC`, `VPC` or `PRIVATE_LINK`. Defaults to `PUBLIC`.
        :param pulumi.Input[builtins.str] connection_id: Id of the Private Link connection when type is `PRIVATE_LINK`.
        """
        pulumi.set(__self__, "type", type)
...
if not MYPY:
    class StreamConnectionSecurityArgsDict(TypedDict):
        broker_public_certificate: NotRequired[pulumi.Input[builtins.str]]
        """
...
class StreamConnectionSecurityArgs:
    def __init__(__self__, *,
                 broker_public_certificate: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def broker_public_certificate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A trusted, public x509 certificate for connecting to Kafka over SSL. String value of the certificate must be defined in the attribute.
        """
    ...
    def broker_public_certificate(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StreamInstanceDataProcessRegionArgs:
    def __init__(__self__, *,
                 ...
                 region: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] cloud_provider: Label that identifies the cloud service provider where MongoDB Cloud performs stream processing. The [MongoDB Atlas API](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/Streams/operation/createStreamInstance) describes the valid values.
        :param pulumi.Input[builtins.str] region: Name of the cloud provider region hosting Atlas Stream Processing. The [MongoDB Atlas API](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/Streams/operation/createStreamInstance) describes the valid values.
        """
        pulumi.set(__self__, "cloud_provider", cloud_provider)
        pulumi.set(__self__, "region", region)
...
class StreamInstanceStreamConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] tier: Selected tier for the Stream Instance. Configures Memory / VCPU allowances. The [MongoDB Atlas API](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/Streams/operation/createStreamInstance) describes the valid values.
        """
        if tier is not None:
...
if not MYPY:
    class StreamProcessorOptionsDlqArgsDict(TypedDict):
        coll: pulumi.Input[builtins.str]
        """
...
class StreamProcessorOptionsDlqArgs:
    def __init__(__self__, *,
                 ...
                 db: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] coll: Name of the collection to use for the DLQ.
        :param pulumi.Input[builtins.str] connection_name: Name of the connection to write DLQ messages to. Must be an Atlas connection.
        :param pulumi.Input[builtins.str] db: Name of the database to use for the DLQ.
        """
    ...
    @property
    @pulumi.getter
    def coll(self) -> pulumi.Input[builtins.str]:
        """
        Name of the collection to use for the DLQ.
        """
    ...
    @coll.setter
    def coll(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class X509AuthenticationDatabaseUserCertificateArgsDict(TypedDict):
        ...
        not_after: NotRequired[pulumi.Input[builtins.str]]
...
class GetAlertConfigurationOutputArgs:
    def __init__(__self__, *,
        ...
        """
        :param builtins.str value: Value to test with the specified operator. If `field_name` is set to TYPE_NAME, you can match on the following values:
               - `PRIMARY`
               - `SECONDARY`
               - `STANDALONE`
               - `CONFIG`
    ...
    @label.setter
    def label(self, value: Optional[builtins.str]):
        pulumi.set(self, "label", value)


if not MYPY:
    class GetAlertConfigurationsListOptionArgsDict(TypedDict):
        include_count: NotRequired[builtins.bool]
        items_per_page: NotRequired[builtins.int]
        page_num: NotRequired[builtins.int]
elif False:
...
class GetAlertConfigurationsListOptionArgs:
    def __init__(__self__, *,
                 include_count: Optional[builtins.bool] = None,
                 items_per_page: Optional[builtins.int] = None,
                 page_num: Optional[builtins.int] = None):
    ...
    def include_count(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "include_count")

    @include_count.setter
    def include_count(self, value: Optional[builtins.bool]):
        pulumi.set(self, "include_count", value)

    @property
    @pulumi.getter(name="itemsPerPage")
    def items_per_page(self) -> Optional[builtins.int]:
        return pulumi.get(self, "items_per_page")

    @items_per_page.setter
    def items_per_page(self, value: Optional[builtins.int]):
        pulumi.set(self, "items_per_page", value)

    @property
    @pulumi.getter(name="pageNum")
    def page_num(self) -> Optional[builtins.int]:
        return pulumi.get(self, "page_num")

    @page_num.setter
    def page_num(self, value: Optional[builtins.int]):
...
class GetCloudProviderAccessSetupAzureConfigArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: builtins.str):
        """
        :param builtins.str atlas_azure_app_id: Azure Active Directory Application ID of Atlas.
        :param builtins.str service_principal_id: UUID string that identifies the Azure Service Principal.
        :param builtins.str tenant_id: UUID String that identifies the Azure Active Directory Tenant ID.
        """
        pulumi.set(__self__, "atlas_azure_app_id", atlas_azure_app_id)
        pulumi.set(__self__, "service_principal_id", service_principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
    ...
    @atlas_azure_app_id.setter
    def atlas_azure_app_id(self, value: builtins.str):
        pulumi.set(self, "atlas_azure_app_id", value)
    ...
    @service_principal_id.setter
    def service_principal_id(self, value: builtins.str):
        pulumi.set(self, "service_principal_id", value)
...
class GetCustomDbRoleInheritedRoleArgs:
    def __init__(__self__, *,
                 ...
                 role_name: builtins.str):
        """
        :param builtins.str database_name: (Required) Database on which the inherited role is granted.
        :param builtins.str role_name: Name of the custom role.
        """
        pulumi.set(__self__, "database_name", database_name)
        pulumi.set(__self__, "role_name", role_name)
...
class GetFederatedDatabaseInstanceCloudProviderConfigAwsArgs:
    def __init__(__self__, *,
                 ...
                 test_s3_bucket: builtins.str):
        """
        :param builtins.str external_id: Unique identifier associated with the IAM Role that the Federated Database Instance assumes when accessing the data stores.
        :param builtins.str iam_assumed_role_arn: Amazon Resource Name (ARN) of the IAM Role that the Federated Database Instance assumes when accessing S3 Bucket data stores. The IAM Role must support the following actions against each S3 bucket:
               * `s3:GetObject`
               * `s3:ListBucket`
               * `s3:GetObjectVersion`
        :param builtins.str iam_user_arn: Amazon Resource Name (ARN) of the user that the Federated Database Instance assumes when accessing S3 Bucket data stores.
        :param builtins.str role_id: Unique identifier of the role that the data lake can use to access the data stores.
        """
        pulumi.set(__self__, "external_id", external_id)
        pulumi.set(__self__, "iam_assumed_role_arn", iam_assumed_role_arn)
        pulumi.set(__self__, "iam_user_arn", iam_user_arn)
    ...
    @iam_assumed_role_arn.setter
    def iam_assumed_role_arn(self, value: builtins.str):
        pulumi.set(self, "iam_assumed_role_arn", value)
    ...
    @iam_user_arn.setter
    def iam_user_arn(self, value: builtins.str):
        pulumi.set(self, "iam_user_arn", value)
    ...
    @role_id.setter
    def role_id(self, value: builtins.str):
        pulumi.set(self, "role_id", value)
    ...
    @test_s3_bucket.setter
    def test_s3_bucket(self, value: builtins.str):
        pulumi.set(self, "test_s3_bucket", value)
...
if not MYPY:
    class GetGlobalClusterConfigManagedNamespaceArgsDict(TypedDict):
        ...
        """
        is_custom_shard_key_hashed: builtins.bool
        """
        Specifies whether the custom shard key for the collection is [hashed](https://docs.mongodb.com/manual/reference/method/sh.shardCollection/#hashed-shard-keys). If omitted, defaults to `false`. If `false`, Atlas uses [ranged sharding](https://docs.mongodb.com/manual/core/ranged-sharding/). This is only available for Atlas clusters with MongoDB v4.4 and later.
        """
        is_shard_key_unique: builtins.bool
        """
        Specifies whether the underlying index enforces a unique constraint. If omitted, defaults to false. You cannot specify true when using [hashed shard keys](https://docs.mongodb.com/manual/core/hashed-sharding/#std-label-sharding-hashed).
        """
elif False:
...
class GetGlobalClusterConfigManagedNamespaceArgs:
    def __init__(__self__, *,
                 ...
                 is_shard_key_unique: builtins.bool):
        """
        :param builtins.str collection: (Required) The name of the collection associated with the managed namespace.
        :param builtins.str custom_shard_key: (Required)	The custom shard key for the collection. Global Clusters require a compound shard key consisting of a location field and a user-selected second key, the custom shard key.
        :param builtins.str db: (Required) The name of the database containing the collection.
        :param builtins.bool is_custom_shard_key_hashed: Specifies whether the custom shard key for the collection is [hashed](https://docs.mongodb.com/manual/reference/method/sh.shardCollection/#hashed-shard-keys). If omitted, defaults to `false`. If `false`, Atlas uses [ranged sharding](https://docs.mongodb.com/manual/core/ranged-sharding/). This is only available for Atlas clusters with MongoDB v4.4 and later.
        :param builtins.bool is_shard_key_unique: Specifies whether the underlying index enforces a unique constraint. If omitted, defaults to false. You cannot specify true when using [hashed shard keys](https://docs.mongodb.com/manual/core/hashed-sharding/#std-label-sharding-hashed).
        """
        pulumi.set(__self__, "collection", collection)
        pulumi.set(__self__, "custom_shard_key", custom_shard_key)
        pulumi.set(__self__, "db", db)
    ...
    @collection.setter
    def collection(self, value: builtins.str):
        pulumi.set(self, "collection", value)
    ...
    @custom_shard_key.setter
    def custom_shard_key(self, value: builtins.str):
        pulumi.set(self, "custom_shard_key", value)
    ...
    @db.setter
    def db(self, value: builtins.str):
        pulumi.set(self, "db", value)

    @property
    @pulumi.getter(name="isCustomShardKeyHashed")
    def is_custom_shard_key_hashed(self) -> builtins.bool:
        """
        Specifies whether the custom shard key for the collection is [hashed](https://docs.mongodb.com/manual/reference/method/sh.shardCollection/#hashed-shard-keys). If omitted, defaults to `false`. If `false`, Atlas uses [ranged sharding](https://docs.mongodb.com/manual/core/ranged-sharding/). This is only available for Atlas clusters with MongoDB v4.4 and later.
        """
        return pulumi.get(self, "is_custom_shard_key_hashed")
    ...
    @is_custom_shard_key_hashed.setter
    def is_custom_shard_key_hashed(self, value: builtins.bool):
        pulumi.set(self, "is_custom_shard_key_hashed", value)

    @property
    @pulumi.getter(name="isShardKeyUnique")
    def is_shard_key_unique(self) -> builtins.bool:
        """
        Specifies whether the underlying index enforces a unique constraint. If omitted, defaults to false. You cannot specify true when using [hashed shard keys](https://docs.mongodb.com/manual/core/hashed-sharding/#std-label-sharding-hashed).
        """
        return pulumi.get(self, "is_shard_key_unique")
    ...
    @is_shard_key_unique.setter
    def is_shard_key_unique(self, value: builtins.bool):
        pulumi.set(self, "is_shard_key_unique", value)
