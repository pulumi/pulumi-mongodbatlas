...
class DatabaseUserArgs:
    def __init__(__self__, *,
                 auth_database_name: pulumi.Input[builtins.str],
                 ...
                 x509_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DatabaseUser resource.
        :param pulumi.Input[builtins.str] auth_database_name: Database against which Atlas authenticates the user. A user must provide both a username and authentication database to log into MongoDB.
               Accepted values include:
        :param pulumi.Input[builtins.str] project_id: The unique ID for the project to create the database user.
        :param pulumi.Input[builtins.str] username: Username for authenticating to MongoDB. USER_ARN or ROLE_ARN if `aws_iam_type` is USER or ROLE.
        :param pulumi.Input[builtins.str] aws_iam_type: If this value is set, the new database user authenticates with AWS IAM credentials. If no value is given, Atlas uses the default value of `NONE`. The accepted types are:
        ...
        :param pulumi.Input[builtins.str] oidc_auth_type: Human-readable label that indicates whether the new database user authenticates with OIDC (OpenID Connect) federated authentication. If no value is given, Atlas uses the default value of `NONE`. The accepted types are:
        ...
        :param pulumi.Input[builtins.str] x509_type: X.509 method by which the provided username is authenticated. If no value is given, Atlas uses the default value of NONE. The accepted types are:
    ...
    def auth_database_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def auth_database_name(self, value: pulumi.Input[builtins.str]):
    ...
    def aws_iam_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ldap_auth_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ldap_auth_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ldap_auth_type", value)

    @property
    @pulumi.getter(name="oidcAuthType")
    def oidc_auth_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oidc_auth_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def x509_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @x509_type.setter
    def x509_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DatabaseUserState:
    ...
    @property
    @pulumi.getter(name="authDatabaseName")
    def auth_database_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Database against which Atlas authenticates the user. A user must provide both a username and authentication database to log into MongoDB.
        Accepted values include:
        """
    ...
    @auth_database_name.setter
    def auth_database_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auth_database_name", value)
...
class DatabaseUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatabaseUserScopeArgs', 'DatabaseUserScopeArgsDict']]]]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None,
            x509_type: Optional[pulumi.Input[builtins.str]] = None) -> 'DatabaseUser':
        """
    ...
    @property
    @pulumi.getter(name="authDatabaseName")
    def auth_database_name(self) -> pulumi.Output[builtins.str]:
        """
        Database against which Atlas authenticates the user. A user must provide both a username and authentication database to log into MongoDB.
        Accepted values include:
        """
    ...
    @property
    @pulumi.getter(name="awsIamType")
    def aws_iam_type(self) -> pulumi.Output[builtins.str]:
        """
        If this value is set, the new database user authenticates with AWS IAM credentials. If no value is given, Atlas uses the default value of `NONE`. The accepted types are:
        * `NONE` -	The user does not use AWS IAM credentials.
        * `USER` - New database user has AWS IAM user credentials.
    ...
    @property
    @pulumi.getter(name="ldapAuthType")
    def ldap_auth_type(self) -> pulumi.Output[builtins.str]:
        """
        Method by which the provided `username` is authenticated. If no value is given, Atlas uses the default value of `NONE`.
        * `NONE` -	Atlas authenticates this user through [SCRAM-SHA](https://docs.mongodb.com/manual/core/security-scram/), not LDAP.
        * `USER` - LDAP server authenticates this user through the user's LDAP user. `username` must also be a fully qualified distinguished name, as defined in [RFC-2253](https://tools.ietf.org/html/rfc2253).
    ...
    @property
    @pulumi.getter(name="oidcAuthType")
    def oidc_auth_type(self) -> pulumi.Output[builtins.str]:
        """
        Human-readable label that indicates whether the new database user authenticates with OIDC (OpenID Connect) federated authentication. If no value is given, Atlas uses the default value of `NONE`. The accepted types are:
        * `NONE` -	The user does not use OIDC federated authentication.
        * `IDP_GROUP` - OIDC Workforce federated authentication group. To learn more about OIDC federated authentication, see [Set up Workforce Identity Federation with OIDC](https://www.mongodb.com/docs/atlas/security-oidc/).
    ...
    @property
    @pulumi.getter(name="x509Type")
    def x509_type(self) -> pulumi.Output[builtins.str]:
        """
        X.509 method by which the provided username is authenticated. If no value is given, Atlas uses the default value of NONE. The accepted types are:
        * `NONE` -	The user does not use X.509 authentication.
        * `MANAGED` - The user is being created for use with Atlas-managed X.509.Externally authenticated users can only be created on the `$external` database.
