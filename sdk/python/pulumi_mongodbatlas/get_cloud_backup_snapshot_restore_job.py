...
class GetCloudBackupSnapshotRestoreJobResult:
    ...
    def delivery_urls(self) -> Sequence[builtins.str]:
        """
...
def get_cloud_backup_snapshot_restore_job(cluster_name: Optional[builtins.str] = None,
                                          project_id: Optional[builtins.str] = None,
                                          snapshot_restore_job_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_name: The name of the Atlas cluster for which you want to retrieve the restore job.
    :param builtins.str project_id: The unique identifier of the project for the Atlas cluster.
    :param builtins.str snapshot_restore_job_id: The unique identifier of the restore job to retrieve.
    """
    __args__ = dict()
...
def get_cloud_backup_snapshot_restore_job_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
