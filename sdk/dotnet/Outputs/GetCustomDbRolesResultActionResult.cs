...
namespace Pulumi.Mongodbatlas.Outputs
{
    ...
    public sealed class GetCustomDbRolesResultActionResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCustomDbRolesResultActionResourceResult> Resources;

        [OutputConstructor]
        private GetCustomDbRolesResultActionResult(
            string action,

            ImmutableArray<Outputs.GetCustomDbRolesResultActionResourceResult> resources)
        {
            Action = action;
            Resources = resources;
        }
