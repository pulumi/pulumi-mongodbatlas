...
namespace Pulumi.Mongodbatlas.Inputs
{
    ...
    public sealed class OrganizationServiceAccountArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("secrets")]
        private InputList<Inputs.OrganizationServiceAccountSecretArgs>? _secrets;

        /// <summary>
        /// A list of secrets associated with the specified Service Account. See Secrets.
        /// </summary>
        public InputList<Inputs.OrganizationServiceAccountSecretArgs> Secrets
        {
            get => _secrets ?? (_secrets = new InputList<Inputs.OrganizationServiceAccountSecretArgs>());
            set => _secrets = value;
        }

        public OrganizationServiceAccountArgs()
        {
        }
        public static new OrganizationServiceAccountArgs Empty => new OrganizationServiceAccountArgs();
    }
}
