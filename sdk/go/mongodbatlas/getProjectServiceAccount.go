...
func LookupProjectServiceAccountOutput(ctx *pulumi.Context, args LookupProjectServiceAccountOutputArgs, opts ...pulumi.InvokeOption) LookupProjectServiceAccountResultOutput {
	...
	return ctx.InvokeOutput("mongodbatlas:index/getProjectServiceAccount:getProjectServiceAccount", args, LookupProjectServiceAccountResultOutput{}, options).(LookupProjectServiceAccountResultOutput)
}
