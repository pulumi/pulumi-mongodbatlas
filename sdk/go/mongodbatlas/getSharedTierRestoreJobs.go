...
func (o LookupSharedTierRestoreJobsResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSharedTierRestoreJobsResult] {
	return pulumix.Output[LookupSharedTierRestoreJobsResult]{
