...
// `getOnlineArchives` Describes the list of all the online archives for a cluster
//
// ## Example Usage
//
// ```go
...
//			_, err := mongodbatlas.GetOnlineArchives(ctx, &mongodbatlas.LookupOnlineArchivesArgs{
//				ProjectId:   projectId,
